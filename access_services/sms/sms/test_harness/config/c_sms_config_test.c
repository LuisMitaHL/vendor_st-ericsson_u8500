...
**********************************************************************
**********************************************************************
This file is used when the SMS Test Harness is enabled.
It contains modifications to the SMS Server config to support
storage of messages.
**********************************************************************
**********************************************************************
**********************************************************************
...
const unsigned char SMS_CONTROL_DIR_MAX_SIZE = 20;
...
#ifdef SETTINGS_USED_IN_MAIN_C_SMS_CONFIG_C_FILE
...
#endif
#else
// This value has been derived for running Linux Test harness.
const unsigned short SMS_MAX_STORAGE_ME_SHORT_MESSAGES = 30;
#endif
...
const unsigned char SMS_STORAGE_INIT_TIMER_VALUE = 10;
...
static const char PREFERRED_STORAGE_FS[] = { '/', 'd', 'a', 't', 'a', '/', 'a', 'p', 'p', '-', 'p', 'r', 'i', 'v', 'a', 't', 'e', '\0' };       //folder name can be defined by customer - REQUIRED FOR AT ME STORAGE ONLY
#else
#ifdef SMS_SIM_TEST_PLATFORM
static const char PREFERRED_STORAGE_FS[] = { '.', '\0' };
#else
static const char PREFERRED_STORAGE_FS[] = { '/', 'd', 'e', 'v', '\0' };        //folder name can be defined by customer - REQUIRED FOR AT ME STORAGE ONLY
#endif
#endif
