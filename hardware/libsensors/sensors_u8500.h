...
char const *const PATH_MODE_MAG =
		"/sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/mode";
char const *const PATH_RATE_MAG =
		"/sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/sampling_frequency";
char const *const PATH_DATA_MAG =
		"/sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/magn_raw";
char const *const PATH_X_SCALE_MAG =
		"/sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/in_magn_x_scale";
char const *const PATH_Y_SCALE_MAG =
		"/sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/in_magn_y_scale";
char const *const PATH_Z_SCALE_MAG =
		"//sys/devices/nmk-i2c.2/i2c-2/2-001e/iio:device2/in_magn_z_scale";
...
/* pressure paths*/
char const *const PATH_MODE_PRS = "/sys/class/i2c-dev/i2c-2/device/2-005c/enable";
char const *const PATH_DATA_PRS = "/sys/class/i2c-dev/i2c-2/device/2-005c/press_data";
