...
public class M7X00SignTest {
    ...
    public void testDisplayHelp() {
        ...
        assertTrue("Help line doesn't match our intended format, it was: \'" + line + "'", line
            .matches("usage: sign-tool-m7x00 \\[OPTIONS\\]( [^ ]+)+"));
    ...
    public void testValidateInputNonExistingFile() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "xloader", unsignedFile.getAbsolutePath(),
                "outputfile"};
    ...
    public void testValidateInputEmptyFile() throws Throwable {
        ...
        String[] arguments = new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "xloader", unsignedFile.getAbsolutePath(), "output"};
        Sign sign = new Sign(null, null);
        try {
            assertEquals(sign.execute(new DummySignerFactory(), arguments, null), 1);
        } catch (Exception e) {
    ...
    public void testSignISSW() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "--buffer-size", "8192", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "issw",
    ...
    public void testSignAuthChallenge() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_AUTH, "-s", "auth_challenge", unsignedFile.getAbsolutePath(),
    ...
    public void testSignGenericSoftwareFormat() throws Throwable {
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "prcmu", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "mem_init", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "osloader", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "ape_normal", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "ldr", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "modem", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "fota", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "dnt", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
        ...
        testSignArgumentsList.add(new String[] {
            "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "ipl", unsignedFile.getAbsolutePath(),
            signedFile.getAbsolutePath()});
    ...
    public void testSignTrustedApplication() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "trusted", unsignedFile.getAbsolutePath(),
                signedFile.getAbsolutePath()};
        testSigning(unsignedFile, signedFile, arguments);
    }
    ...
    public void testSignAuthCert() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "auth_cert", unsignedFile.getAbsolutePath(),
                signedFile.getAbsolutePath()};
    ...
    public void testSignFlashArchive() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "--buffer-size", "1M", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "flash_archive",
                unsignedFile.getAbsolutePath(), signedFile.getAbsolutePath()};
    ...
    public void testReSignFlashArchive() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "--buffer-size", "8k", "-v", "-p", SIGN_PACKAGE_U5500_ROOT, "-s", "flash_archive",
                unsignedFile.getAbsolutePath(), signedFile.getAbsolutePath()};
        testSigning(unsignedFile, signedFile, arguments);
    }
    ...
    public void testSignCRKC() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-v", "-p", SIGN_PACKAGE_U5500_CRK, "-s", "crkc", unsignedFile.getAbsolutePath(),
                signedFile.getAbsolutePath()};
    ...
    public void testSignCRKCSHA256() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-r", "sha-256", "-v", "-p", SIGN_PACKAGE_U5500_CRK, "-s", "crkc",
                unsignedFile.getAbsolutePath(), signedFile.getAbsolutePath()};
    ...
    public void testSignCRKCInvalidHash() throws Throwable {
        ...
        String[] arguments =
            new String[] {
                "m7x00", "-r", "sha-665", "-v", "-p", SIGN_PACKAGE_U5500_CRK, "-s", "crkc",
                unsignedFile.getAbsolutePath(), signedFile.getAbsolutePath()};
        Sign sign = new Sign(null, null);
        try {
            assertEquals(sign.execute(new DummySignerFactory(), arguments, null), 1);
