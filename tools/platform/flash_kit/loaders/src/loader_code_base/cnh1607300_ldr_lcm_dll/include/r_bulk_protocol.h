...
#define OpenBulkSession(x,y)      Do_R15_Bulk_OpenSession(&GlobalCommunication,(x),(y))
#define CreateBulkVector(x,y,z,w) Do_R15_Bulk_CreateVector(&GlobalCommunication,(x),(y),(z),(w))
#define DestroyBulkVector(x,y)    Do_R15_Bulk_DestroyVector(&GlobalCommunication,(x),(y))
#define StartBulkSession(x,y)     Do_R15_Bulk_StartSession(&GlobalCommunication,(x),(y))
#define GetStatusBulkSession(x)   Do_R15_Bulk_GetStatusSession(x) //xvsvlpi
#define CloseBulkSession(x)       Do_R15_Bulk_CloseSession(&GlobalCommunication,(x))
#define GenerateBulkSessionID()   Do_R15_Bulk_GenerateBulkSessionID(&GlobalCommunication)
