...
/**
 * @brief Insert laoder type string from *source_p to **data_pp.
 *
 * Allocate memory at location pointed by data_pp and create loader type string
 * from the string supplied at source_p to the allocated location.
 *
 * @param [out] data_pp            Pointer pointing to the location where the
 *                                 output string should be inserted.
 ...
 *
 * Get the length of the buffer needed to store DirectoryEntriesCount serialized
 * directory entries that are located at the address pointed in source_p.
 *
 * @param [in]  source_p              Source.
 * @param [in]  DirectoryEntriesCount Entry counter.
 * @return      Length of the buffer needed to store DirectoryEntriesCount
 ...
 *
 * Store DirectoryEntriesCount serialized directory entries from source_p to
 * the location pointed by data_pp.
 *
 * @param [out] data_pp               Pointer to the Location where serialized
 *                                    directory entries will be stored.
 * @param [in]  source_p              Source.
 * @param [in]  DirectoryEntriesCount Number of directory entries to be
 *                                    serialized at data_pp.
 * @return      void.
 */
 ...
 *
 *
 * Get the length of the buffer needed to store DeviceEntriesCount serialized
 * device entries that are located at the address pointed in source_p.
 *
 * @param [in]  source_p           Source.
 * @param [in]  DeviceEntriesCount Entry counter.
 * @return      Length of the buffer needed to store DeviceEntriesCount
 ...
 *
 * Store DeviceEntriesCount serialized device entries from source_p to
 * the location pointed by data_pp.
 *
 * @param [out] data_pp            Pointer to the Location where serialized device
 *                                 entries will be stored.
 * @param [in]  source_p           Source.
 * @param [in]  DeviceEntriesCount Number of device entries to be serialized at
 *                                 data_pp.
 * @return      void.
 */
