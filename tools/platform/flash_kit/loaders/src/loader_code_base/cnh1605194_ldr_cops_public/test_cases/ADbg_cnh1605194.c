...
/**
 * @file ADbg_cnh1605194.c
 *
 * @brief Test cases for CNH1605194 module.
 *
 ...
 ******************************************************************************/
static void ADbg_CNH1605194_TestedFunction1(ADbg_Case_t *Case_p);
...
ADBG_CASE_DEFINE(Test_CNH1605194_TestedFunction1, 1, 1, ADbg_CNH1605194_TestedFunction1, Parameters1);


/*******************************************************************************
* The test case suite definition
******************************************************************************/
//ADBG_SUITE_DEFINE_BEGIN(TestCase_CNH1605194, 0, ModuleId)
ADBG_SUITE_DEFINE_BEGIN(TestCase_CNH1605194, 0, 1)

//ADBG_SUITE_ENTRY(TestCaseName)
ADBG_SUITE_ENTRY(Test_CNH1605194_TestedFunction1)
...
{
    ADbg_Module_t *Module_p = Do_ADbg_Module_Create(TestCase_CNH1605194, NULL, MainModule_p->Command_p, MainModule_p->Result_p);
 ...
 * CNH1605194_TestedFunction1.
 * Function used in: Test_CNH1605194_TestedFunction1.
 *
