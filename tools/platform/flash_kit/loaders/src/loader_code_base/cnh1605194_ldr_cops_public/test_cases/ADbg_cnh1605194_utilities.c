...
/**
 * @file ADbg_cnh1605194_utilities.c
 *
 * @brief Interface functions for CNH1605194 module.
 *
 * This file consist of interface functions for setting preconditions
 * for automatic testing functions from CNH1605194 module.
 */
...
#include "ADbg_cnh1605194_utilities.h"

/*******************************************************************************
 * The interface functions declarations
 ******************************************************************************/

static void ADbg_IntGroup1_CNH1605194_Group(ADbg_Module_t *Module_p);
/** Functions used for set the global variables. */
static void ADbg_Test_Function1_CNH1605194(ADbg_IntFunction_t *IntFunction_p);
...
ADBG_INTERFACE_GROUP_DEFINE(Test_IntGroup1_CNH1605194_Group, 1, 1, ADbg_IntGroup1_CNH1605194_Group);
...
ADBG_INTERFACE_FUNCTION_DEFINE(Test_Function1_CNH1605194, 1, 1, 1, ADbg_Test_Function1_CNH1605194, Param1, Param2);

/*******************************************************************************
 * The interface group suite definition
 ******************************************************************************/
//ADBG_INTERFACE_GROUP_SUITE_DEFINE_BEGIN(TestIntGroup_CNH1605194, 0, ModuleId)
ADBG_INTERFACE_GROUP_SUITE_DEFINE_BEGIN(IntGroup_CNH1605194, 0, 1)

//ADBG_INTERFACE_GROUP_SUITE_ENTRY(InterfaceGroupName)
ADBG_INTERFACE_GROUP_SUITE_ENTRY(Test_IntGroup1_CNH1605194_Group)
...
ADBG_INTERFACE_FUNCTION_SUITE_DEFINE_BEGIN(IntGroup1_CNH1605194, 0, 1, 1)

ADBG_INTERFACE_FUNCTION_SUITE_ENTRY(Test_Function1_CNH1605194)           //InterfaceFunctionName
...
{
    ADbg_Module_t *Module_p = Do_ADbg_Module_Create(NULL, IntGroup_CNH1605194, MainModule_p->Command_p, MainModule_p->Result_p);
...
static void ADbg_IntGroup1_CNH1605194_Group(ADbg_Module_t *Module_p)
{
    ADbg_IntGroup_t *IntGroup1_p = Do_ADbg_IntGroup_Create(IntGroup1_CNH1605194, Module_p->Command_p, Module_p->Result_p);
