...
/** Define full permission */
#define LOADER_SEC_LIB_FULL_PERMISSION  127

/** Define low permission */
#define LOADER_SEC_LIB_LOW_PERMISSION   0
 ...
 */
typedef struct _VerifyContext *VerifyContext_t;
