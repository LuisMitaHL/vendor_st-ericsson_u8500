...
#define AB8500_CORE_HCL_MAJOR_ID    0
#define AB8500_CORE_HCL_MINOR_ID    0
...
/*-----------------------------------------------------Initialisation -----------------------------------------------------------------------------*/
PUBLIC t_ab8500_core_error AB8500_CORE_GetVersion                     (OUT t_version *);
PUBLIC t_ab8500_core_error AB8500_CORE_SetDbgLevel                    (IN t_dbg_level);
PUBLIC t_ab8500_core_error AB8500_CORE_GetTurnOnCause                 (OUT t_ab8500_core_turnon_cause *);
