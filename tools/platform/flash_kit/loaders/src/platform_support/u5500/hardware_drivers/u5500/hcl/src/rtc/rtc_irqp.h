...
#define RTC_DISABLE             HCL_WRITE_BITS((g_rtc_system_context.p_rtc_reg)->RTCCR, RTC_CONTROL_DISABLE, MASK_RTCDISABLE)
...
#define READ_TCR_CLKDEL(m)      (m = (HCL_READ_BITS((((g_rtc_system_context.p_rtc_reg)->RTCCR) >> 16), MASK_CLKDEL)))
