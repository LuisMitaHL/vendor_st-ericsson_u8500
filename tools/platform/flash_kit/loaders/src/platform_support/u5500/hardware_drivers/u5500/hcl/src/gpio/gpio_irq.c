...
PUBLIC t_gpio_device_id GPIO_GetDeviceID(t_gpio_irq_src_id irq)
{
    ...
    else if ((irq >= GPIO_IRQ_SRC_224) && (irq <= GPIO_IRQ_SRC_227))
    {
...
{
    t_gpio_irq_src_id   max_value = GPIO_IRQ_SRC_227;
