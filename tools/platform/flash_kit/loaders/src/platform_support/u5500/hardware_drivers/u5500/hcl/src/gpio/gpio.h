...
#define GPIO_HCL_MINOR_ID   0
#define GPIO_TOTAL_COUNT    228
...
typedef enum
{
	GPIO_ALT_I2C0,				/* GPIO[101:100] 			     */	
	GPIO_ALT_I2C1,				/* GPIO[4:3] 				     */
	GPIO_ALT_I2C2,				/* GPIO[219:218]				 */
	GPIO_ALT_I2C3,				/* GPIO[145:144]    			 */
	GPIO_ALT_MM_CARD0,			/* GPIO[14:5,31:30]		         */
	GPIO_ALT_MM_CARD1,			/* GPIO[199:191]			     */
	GPIO_ALT_MM_CARD2,			/* GPIO[17:16,26:19]             */
	GPIO_ALT_MM_CARD3,        	/* GPIO[176:171]                 */
	GPIO_ALT_MM_CARD4,    		/* GPIO[194:185] alt B           */
	GPIO_ALT_MSP0,				/* GPIO[35:32]	    		     */
	GPIO_ALT_MSP1,				/* GPIO[99:96]   				 */
	GPIO_ALT_MSP2,				/* GPIO[223:220]    			 */
	GPIO_ALT_UART0,		    	/* GPIO[29:28]Alt A and GPIO[31:30] Alt C1 */
	GPIO_ALT_UART1,         	/* GPIO[203:200]                     */
	GPIO_ALT_UART2,         	/* GPIO[180:177]   	             */
	GPIO_ALT_UART3,				/* GPIO[168:165] alt B, GPIO[180:179] alt B */
	GPIO_ALT_LCD_PANEL,			/* GPIO[224:210] alt B   */
	GPIO_ALT_KEYPAD,			/* GPIO[143:128]*/
	GPIO_ALT_USB_OTG,			/* GPIO[75:64]				 */
	GPIO_ALT_NAND_FLASH,		/* GPIO[69:68,97:86,138:128]*/   /*DOUBT*/
	GPIO_ALT_NOR_FLASH,			/* GPIO[69:68,97:96,94:86,138:125] */ /*DOUBT*/
	GPIO_ALT_SPI0,				/* GPIO[209:204]                 */
	GPIO_ALT_SPI1,				/* GPIO[170:165]              		*/
	GPIO_ALT_SPI2,				/* GPIO[217:212]				*/
	GPIO_ALT_SPI3_1,			/* GPIO[190:185] 				*/
	GPIO_ALT_SPI3_2,			/* GPIO[176:171] altB 			*/	
	GPIO_ALT_STMAPE_1,          /* GPIO[195:191]  altC                 */
	GPIO_ALT_STMAPE_2	,		/* GPIO[145:142,140] altC				 */
	GPIO_ALT_IRDA,				/* GPIO[227, 225] altB 	*/
	GPIO_ALT_IRRC,				/* GPIO[226]*/
	GPIO_ALT_PWM				/* GPIO[148:146]*/	
} t_gpio_alt_function;
...
typedef enum 
{
	...
	GPIO_BLOCK_32_BITS_224_TO_227,  /* GPIO[207:192], Byte 29, 30, 31 & 32 */	
	...
	GPIO_BLOCK_16_BITS_72_TO_87,    /* GPIO[87:72], Byte 10 & 11 	*/
	GPIO_BLOCK_16_BITS_80_TO_95,    /* GPIO[95:80], Byte 11 & 12 	*/
	...
	GPIO_BLOCK_16_BITS_200_TO_215,   /* GPIO[215:200],Byte 26 & 27	*/
	GPIO_BLOCK_16_BITS_208_TO_223,   /* GPIO[223:208],Byte 27 & 28	*/
	GPIO_BLOCK_16_BITS_216_TO_227,   /* GPIO[227:216],Byte 28 & 29	*/
	GPIO_BLOCK_16_BITS_224_TO_227    /* GPIO[227:224],Byte 29 	*/
} t_gpio_block_id;
