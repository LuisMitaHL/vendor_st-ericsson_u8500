...
PRIVATE t_gpio_error gpio_enablealt(t_gpio_alt_function alt_func)
{
    ...
    switch (alt_func)
    {
        case GPIO_ALT_UART0: 
            ...
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa |= GPIO_UART0_MASK2;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb |= GPIO_UART0_MASK2;
            break;

        case GPIO_ALT_UART1:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_UART1_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_UART1_MASK;
            break;

        case GPIO_ALT_UART2:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_UART2_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_UART2_MASK;
            break;
		
		case GPIO_ALT_UART3:
			g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_UART3_MASK;
			g_gpio_system_context.p_gpio_register[5]->gpio_afsb |=  GPIO_UART3_MASK;
			break;

        case GPIO_ALT_LCD_PANEL:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_LCD_PANEL_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb |= GPIO_LCD_PANEL_MASK1;
			g_gpio_system_context.p_gpio_register[7]->gpio_afsa &= ~GPIO_LCD_PANEL_MASK2;
            g_gpio_system_context.p_gpio_register[7]->gpio_afsb |= GPIO_LCD_PANEL_MASK2;
            break;

        case GPIO_ALT_KEYPAD:
            g_gpio_system_context.p_gpio_register[4]->gpio_afsa |= GPIO_KEYPAD_MASK;
            g_gpio_system_context.p_gpio_register[4]->gpio_afsb &= ~GPIO_KEYPAD_MASK;
            break;

        case GPIO_ALT_USB_OTG:
            g_gpio_system_context.p_gpio_register[2]->gpio_afsa |= GPIO_USB_OTG_MASK;
            g_gpio_system_context.p_gpio_register[2]->gpio_afsb &= ~GPIO_USB_OTG_MASK;
            break;

        case GPIO_ALT_NAND_FLASH: /*DOUBT*/
    	...
    	case GPIO_ALT_SPI0:
    		g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_SPI0_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI0_MASK;
			break;
			
		case GPIO_ALT_SPI1:
    		g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_SPI1_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_SPI1_MASK;
	        break;
		
		case GPIO_ALT_SPI2:
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_SPI2_MASK;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI2_MASK;
			break;
		
		case GPIO_ALT_SPI3_1:
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_SPI3_MASK1;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI3_MASK1;
			break;
		
		case GPIO_ALT_SPI3_2:
			g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_SPI3_MASK2;
			g_gpio_system_context.p_gpio_register[5]->gpio_afsb |= GPIO_SPI3_MASK2;
			break;
	    
	   	case GPIO_ALT_STMAPE_1:
    		g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_STMAPE_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb |= GPIO_STMAPE_MASK1;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_STMAPE_MASK2;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsb |= GPIO_STMAPE_MASK2;
	        break;
	        
	   	case GPIO_ALT_STMAPE_2:
    		g_gpio_system_context.p_gpio_register[4]->gpio_afsa |= GPIO_STMAPE_MASK3;
            g_gpio_system_context.p_gpio_register[4]->gpio_afsb |= GPIO_STMAPE_MASK3;
	        break;
		
		case GPIO_ALT_IRRC:
			g_gpio_system_context.p_gpio_register[7]->gpio_afsa |= GPIO_IRRC_MASK;
			g_gpio_system_context.p_gpio_register[7]->gpio_afsb &= ~GPIO_IRRC_MASK;
			break;
...
PUBLIC t_gpio_error GPIO_EnableAltFunction(t_gpio_alt_function alt_func)
{
    ...
    {
        case GPIO_ALT_I2C0:
            g_gpio_system_context.p_gpio_register[3]->gpio_afsa |= GPIO_I2C0_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_afsb &= ~GPIO_I2C0_MASK;
            break;

        case GPIO_ALT_I2C1:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa |= GPIO_I2C1_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_I2C1_MASK;
            break;

        case GPIO_ALT_I2C2:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_I2C2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_I2C2_MASK;
            break;

        case GPIO_ALT_I2C3:
            g_gpio_system_context.p_gpio_register[7]->gpio_afsa |= GPIO_I2C3_MASK;
            g_gpio_system_context.p_gpio_register[7]->gpio_afsb &= ~GPIO_I2C3_MASK;
            break;

        case GPIO_ALT_MM_CARD0:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa |= GPIO_MMC0_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_MMC0_MASK;
            break;

        case GPIO_ALT_MM_CARD1:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_MMC1_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_MMC1_MASK1;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa |= GPIO_MMC1_MASK2;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_MMC1_MASK2;

            break;

        case GPIO_ALT_MM_CARD2:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa |= GPIO_MMC2_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_MMC2_MASK;
            break;

        case GPIO_ALT_MM_CARD3:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_MMC3_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_MMC3_MASK;
            break;

        case GPIO_ALT_MM_CARD4:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_MMC4_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb |= GPIO_MMC4_MASK1;
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_MMC4_MASK2;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb |= GPIO_MMC4_MASK2;
            break;
		
		case GPIO_ALT_MSP0:
			g_gpio_system_context.p_gpio_register[1]->gpio_afsa |= GPIO_MSP0_MASK;
			g_gpio_system_context.p_gpio_register[1]->gpio_afsb &= ~GPIO_MSP0_MASK;
			break;
		
		case GPIO_ALT_MSP1:
			g_gpio_system_context.p_gpio_register[3]->gpio_afsa |= GPIO_MSP1_MASK;
			g_gpio_system_context.p_gpio_register[3]->gpio_afsb &= ~GPIO_MSP1_MASK;
			break;
		...
		case GPIO_ALT_IRDA:
			g_gpio_system_context.p_gpio_register[7]->gpio_afsa &= ~GPIO_IRDA_MASK;
			g_gpio_system_context.p_gpio_register[7]->gpio_afsb |= GPIO_IRDA_MASK;
			break;
		
		case GPIO_ALT_PWM:
			g_gpio_system_context.p_gpio_register[4]->gpio_afsa |= GPIO_PWM_MASK;
			g_gpio_system_context.p_gpio_register[4]->gpio_afsb &= ~GPIO_PWM_MASK;
			break;
...
PRIVATE t_gpio_error gpio_disablealt(t_gpio_alt_function alt_func)
{
    ...
    switch (alt_func)
    {
        case GPIO_ALT_UART0:
            ...
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa &= ~GPIO_UART0_MASK2;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_UART0_MASK2;
            g_gpio_system_context.p_gpio_register[0]->gpio_dirc = GPIO_UART0_MASK2;
            g_gpio_system_context.p_gpio_register[0]->gpio_pdis &= ~GPIO_UART0_MASK2;
            break;

        case GPIO_ALT_UART1:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_UART1_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_UART1_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_UART1_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_UART1_MASK;
            break;

        case GPIO_ALT_UART2:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_UART2_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_UART2_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_UART2_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_UART2_MASK;
			break;

        case GPIO_ALT_LCD_PANEL:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_LCD_PANEL_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_LCD_PANEL_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_LCD_PANEL_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_LCD_PANEL_MASK1;

            g_gpio_system_context.p_gpio_register[7]->gpio_afsa &= ~GPIO_LCD_PANEL_MASK2;
            g_gpio_system_context.p_gpio_register[7]->gpio_afsb &= ~GPIO_LCD_PANEL_MASK2;
            g_gpio_system_context.p_gpio_register[7]->gpio_dirc = GPIO_LCD_PANEL_MASK2;
            g_gpio_system_context.p_gpio_register[7]->gpio_pdis &= ~GPIO_LCD_PANEL_MASK2;
            break;

        case GPIO_ALT_KEYPAD:
            g_gpio_system_context.p_gpio_register[4]->gpio_afsa &= ~GPIO_KEYPAD_MASK;
            g_gpio_system_context.p_gpio_register[4]->gpio_afsb &= ~GPIO_KEYPAD_MASK;
            g_gpio_system_context.p_gpio_register[4]->gpio_dirc = GPIO_KEYPAD_MASK;
            g_gpio_system_context.p_gpio_register[4]->gpio_pdis &= ~GPIO_KEYPAD_MASK;
			break;

        case GPIO_ALT_USB_OTG:
            g_gpio_system_context.p_gpio_register[2]->gpio_afsa &= ~GPIO_USB_OTG_MASK;
            g_gpio_system_context.p_gpio_register[2]->gpio_afsb &= ~GPIO_USB_OTG_MASK;
            g_gpio_system_context.p_gpio_register[2]->gpio_dirc = GPIO_USB_OTG_MASK;
            g_gpio_system_context.p_gpio_register[2]->gpio_pdis &= ~GPIO_USB_OTG_MASK;
            break;
        ...
        case GPIO_ALT_SPI0:
    		g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_SPI0_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI0_MASK;
           	g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_SPI0_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_SPI0_MASK;
            break;
			
		case GPIO_ALT_SPI1:
    		g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_SPI1_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_SPI1_MASK;
       		g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_SPI1_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_SPI1_MASK;
	        break;
		
		case GPIO_ALT_SPI2:
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_SPI2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI2_MASK;
       		g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_SPI2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_SPI2_MASK;
	        break;
	    
	    case GPIO_ALT_SPI3_1:
    		g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_SPI3_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_SPI3_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_SPI3_MASK1;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_SPI3_MASK1;
            break;
		
		case GPIO_ALT_SPI3_2:
			g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_SPI3_MASK2;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_SPI3_MASK2;
            g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_SPI3_MASK2;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_SPI3_MASK2;
            break;
...
PUBLIC t_gpio_error GPIO_DisableAltFunction(t_gpio_alt_function alt_func)
{
    ...
    switch (alt_func)
    {
        case GPIO_ALT_I2C0:
            g_gpio_system_context.p_gpio_register[3]->gpio_afsa &= ~GPIO_I2C0_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_afsb &= ~GPIO_I2C0_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_dirc = GPIO_I2C0_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_pdis &= ~GPIO_I2C0_MASK;
            break;

        case GPIO_ALT_I2C1:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa &= ~GPIO_I2C1_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_I2C1_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_dirc = GPIO_I2C1_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_pdis &= ~GPIO_I2C1_MASK;
            break;

        case GPIO_ALT_I2C2:
            g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_I2C2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_I2C2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_I2C2_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_I2C2_MASK;
            break;

        case GPIO_ALT_I2C3:
            g_gpio_system_context.p_gpio_register[7]->gpio_afsa &= ~GPIO_I2C3_MASK;
            g_gpio_system_context.p_gpio_register[7]->gpio_afsb &= ~GPIO_I2C3_MASK;
            g_gpio_system_context.p_gpio_register[7]->gpio_dirc = GPIO_I2C3_MASK;
            g_gpio_system_context.p_gpio_register[7]->gpio_pdis &= ~GPIO_I2C3_MASK;
            break;
        ...
        case GPIO_ALT_MM_CARD0:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa &= ~GPIO_MMC0_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_MMC0_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_dirc = GPIO_MMC0_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_pdis &= ~GPIO_MMC0_MASK;
			break;
			
        case GPIO_ALT_MM_CARD1:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_MMC1_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_MMC1_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_MMC1_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_MMC1_MASK1;
			
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_MMC1_MASK2;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_MMC1_MASK2;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_MMC1_MASK2;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_MMC1_MASK2;
        ...
        case GPIO_ALT_MM_CARD2:
            g_gpio_system_context.p_gpio_register[0]->gpio_afsa &= ~GPIO_MMC2_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_afsb &= ~GPIO_MMC2_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_dirc = GPIO_MMC2_MASK;
            g_gpio_system_context.p_gpio_register[0]->gpio_pdis &= ~GPIO_MMC2_MASK;
            break;

        case GPIO_ALT_MM_CARD3:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa |= GPIO_MMC3_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb |= GPIO_MMC3_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_MMC3_MASK;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_MMC3_MASK;
			break;

        case GPIO_ALT_MM_CARD4:
            g_gpio_system_context.p_gpio_register[5]->gpio_afsa &= ~GPIO_MMC4_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_afsb &= ~GPIO_MMC4_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_dirc = GPIO_MMC4_MASK1;
            g_gpio_system_context.p_gpio_register[5]->gpio_pdis &= ~GPIO_MMC4_MASK1;
		...
		case GPIO_ALT_MSP0:
            g_gpio_system_context.p_gpio_register[1]->gpio_afsa &= ~GPIO_MSP0_MASK;
            g_gpio_system_context.p_gpio_register[1]->gpio_afsb &= ~GPIO_MSP0_MASK;
            g_gpio_system_context.p_gpio_register[1]->gpio_dirc = GPIO_MSP0_MASK;
            g_gpio_system_context.p_gpio_register[1]->gpio_pdis &= ~GPIO_MSP0_MASK;
            break;

        case GPIO_ALT_MSP1:
            g_gpio_system_context.p_gpio_register[3]->gpio_afsa &= ~GPIO_MSP1_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_afsb &= ~GPIO_MSP1_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_dirc = GPIO_MSP1_MASK;
            g_gpio_system_context.p_gpio_register[3]->gpio_pdis &= ~GPIO_MSP1_MASK;
            break;
		...
		case GPIO_ALT_IRDA:
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_IRDA_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_IRDA_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_IRDA_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_IRDA_MASK;
			break;
			
		case GPIO_ALT_PWM:
			g_gpio_system_context.p_gpio_register[6]->gpio_afsa &= ~GPIO_PWM_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_afsb &= ~GPIO_PWM_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_dirc = GPIO_PWM_MASK;
            g_gpio_system_context.p_gpio_register[6]->gpio_pdis &= ~GPIO_PWM_MASK;
			break;
...
PRIVATE t_gpio_error gpio_readblock1(t_gpio_block_id block_id, t_uint32 *p_value, t_uint32 mask)
{
    ...
    switch (block_id)
    {
        ...
        case GPIO_BLOCK_16_BITS_216_TO_227:
        ...
        case GPIO_BLOCK_16_BITS_224_TO_227:
...
PUBLIC t_gpio_error GPIO_ReadBlock(t_gpio_block_id block_id, t_uint32 *p_value, t_uint32 mask)
{
    ...
    switch (block_id)
    {
        ...
        case GPIO_BLOCK_32_BITS_224_TO_227:
...
PRIVATE void gpio_getirqstatusblock1(t_gpio_multiple_device_id device_id, t_gpio_pin_irq_status *p_status)
{
    ...
    if ((t_uint32) device_id & (t_uint32) GPIO_DEVICE_ID_7)
    {
        ...
        for (count = (t_uint32) GPIO_PIN_224; count <= (t_uint32) GPIO_PIN_227; count++)
        {
            p_status->gpio[count] = (t_bool) ((status & (t_uint32) (1 << (count % GPIO_NO_OF_PINS))) ? TRUE : FALSE);
        }
    }
    ...
    {
        for (count = (t_uint32) GPIO_PIN_0; count <= (t_uint32) GPIO_PIN_227; count++)
        {
