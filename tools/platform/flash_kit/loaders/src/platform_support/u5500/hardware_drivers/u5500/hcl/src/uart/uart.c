...
*
* \brief   This File contains HAL Routines for UART (U5500)
* \author  ST-Ericsson
*/
/*****************************************************************************/
    ...
    if (NULL != uart_base_address)
    {
        switch (uart_device_id)
        {
            ...
            case UART_DEVICE_ID_3:
                /*Initialize the registers structure*/
                g_uart_system_context.p_uart3_register = (t_uart_register *) uart_base_address;
                
                /*Check for peripheral IDs*/
                if(!UART3_CHECK_PERIPH_ID_OK)    
                {
                    error_status = UART_UNSUPPORTED_HW;
                }
                ...
                /* Initialise Globals */
    #ifdef __UART_ENHANCED
                g_uart_system_context.uart3_nrx = 0;
                g_uart_system_context.uart3_ntx = 0;
                g_uart_system_context.uart3_need_to_call_config = TRUE;
                g_uart_system_context.uart3_rx_status = (t_uart_receive_status) UART_RECEIVE_OK;
                g_uart_system_context.uart3_trigger_tx = 0;
                g_uart_system_context.uart3_trigger_rx = 0;
    #endif /* __UART_ENHANCED */
                break;
...
PUBLIC t_uart_error UART_ManageSendBreak(IN t_uart_device_id uart_device_id, IN t_uart_set_or_clear command)
{
    ...
    switch (uart_device_id) /* Choose suitable UART base adress  */
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            break;
...
)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            ...
            {
                case UART_SET:
                    g_uart_system_context.p_uart3_register->uartx_cr |= UART_CONTROL_MASK_RTS;
                    break;
...
{
    t_uart_fifo_trigger  fifo_trigger = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
PRIVATE void uart_SetFlowControl(IN t_uart_config *p_config, IN t_uart_register *lp_uart_register)
{
    ...
    {
#if (defined(UART0_AUTO_SW_FLOW_CONTROL) || defined(UART1_AUTO_SW_FLOW_CONTROL) || defined(UART2_AUTO_SW_FLOW_CONTROL) || defined(UART3_AUTO_SW_FLOW_CONTROL))
...
#endif /* end UART0-3_AUTO_SW_FLOW_CONTROL */
...
PRIVATE t_uart_error uart_SetFifoTriggerLevel(IN t_uart_device_id uart_device_id, IN t_uart_fifo_trigger fifo_trigger)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
        {
              g_uart_system_context.p_uart3_register->uartx_ifls =
                    (
                        (t_uint32) (g_uart_system_context.p_uart3_register->uartx_ifls &~(MASK_BIT0 | MASK_BIT1 | MASK_BIT2)) |
                        ((t_uint32) fifo_trigger.trig3_tx & (t_uint32) (MASK_BIT0 | MASK_BIT1 | MASK_BIT2))
                    );  /* Program tx trigger */
                g_uart_system_context.p_uart3_register->uartx_ifls =
                    (
                        (t_uint32) (g_uart_system_context.p_uart3_register->uartx_ifls &~(MASK_BIT3 | MASK_BIT4 | MASK_BIT5)) |
                        ((t_uint32) (fifo_trigger.trig3_rx << UART_FIFO_TRIGGER_RX_SHIFT) & (t_uint32) (MASK_BIT3 | MASK_BIT4 | MASK_BIT5))
                    );  /* Program rx trigger */
                break;
        }
...
PUBLIC t_uart_error UART_SetDmaWatermarkLevel(IN t_uart_device_id uart_device_id, IN t_uart_dmawm_trigger uart_dmawm_trigger)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            {
                g_uart_system_context.p_uart3_register->uartx_dmawm =
                    (
                        (t_uint32) (g_uart_system_context.p_uart3_register->uartx_dmawm &~(MASK_BIT0 | MASK_BIT1 | MASK_BIT2)) |
                        ((t_uint32) (uart_dmawm_trigger.uart_tx_trigger) & (t_uint32) (MASK_BIT0 | MASK_BIT1 | MASK_BIT2))
                    );  /* Program tx trigger */
                g_uart_system_context.p_uart3_register->uartx_dmawm =
                    (
                        (t_uint32) (g_uart_system_context.p_uart3_register->uartx_dmawm &~(MASK_BIT3 | MASK_BIT4 | MASK_BIT5)) |
                        (( (t_uint32) (uart_dmawm_trigger.uart_rx_trigger) << UART_FIFO_TRIGGER_RX_SHIFT) & (t_uint32) (MASK_BIT3 | MASK_BIT4 | MASK_BIT5))
                    );  /* Program rx trigger */
            
	    	g_uart_system_context.uart3_config.tx_dmawm_trigger =  uart_dmawm_trigger.uart_tx_trigger; 
                g_uart_system_context.uart3_config.rx_dmawm_trigger =  uart_dmawm_trigger.uart_rx_trigger; 
		break;
            }
...
PUBLIC t_uart_error UART_ReConfigureTx(IN t_uart_device_id uart_device_id, IN t_uart_txrx_config uart_tx_config)
{
    ...
    switch (uart_device_id)                                     /* Choose suitable UART base adress */
    {
        ...
        {
            lp_uart_register = g_uart_system_context.p_uart3_register;
	    uart_config      = &(g_uart_system_context.uart3_config); 
            break;
        }
...
PRIVATE t_uart_error uart_elem_PowerOn(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            ...
            g_uart_system_context.uart3_is_power_off = FALSE;
            error_status = uart_elem_SetConfiguration(uart_device_id, &g_uart_system_context.uart3_config);
            g_uart_system_context.p_uart3_register->uartx_imsc |= g_uart_system_context.uart3_device_context.uart_imsc_reg;
            break;
...
PRIVATE t_uart_error uart_elem_PowerOff(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            if (TRUE == g_uart_system_context.uart3_is_power_off)
            {
                DBGPRINT(DBGL_ERROR, "Already in Power-OFF mode!");
                DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                return(UART_REQUEST_NOT_APPLICABLE);
            ...
            g_uart_system_context.uart3_is_power_off = TRUE;

            g_uart_system_context.uart3_device_context.uart_imsc_reg = lp_uart_register->uartx_imsc;
            break;
...
PRIVATE t_uart_error uart_elem_SetConfiguration(IN t_uart_device_id uart_device_id, IN t_uart_config *p_config)
{
    ...
    switch (uart_device_id)                                     /* Choose suitable UART base adress */
    {
        ...
        {
           lp_uart_register = g_uart_system_context.p_uart3_register;
           g_uart_system_context.uart3_config = *p_config;
           g_uart_system_context.uart3_transfer_flags = UART_TX_IT_MODE | UART_RX_IT_MODE;
           break; 
        }
...
PRIVATE t_uart_error uart_elem_SetTransferMode(IN t_uart_device_id uart_device_id, IN t_uint32 flags)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            p_transfer_flags = &g_uart_system_context.uart3_transfer_flags;
            break;
...
)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            *p_baud_rate     = g_uart_system_context.uart3_config.baud_rate;
            break;
...
)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            lp_Event = &g_uart_system_context.uart3_event;
			break;
...
PUBLIC t_bool UART_IsEventActive(IN t_uart_event *p_event)
{
    ...
    {
        if (0 != ((*p_event) & g_uart_system_context.uart3_event))
        {
            DBGEXIT2(UART_OK, "EVENT %x, EVENT OCCURED %s", *p_event, "TRUE");
            return(TRUE);
        }
...
PUBLIC void UART_AcknowledgeEvent(IN t_uart_event *p_event)
{
    ...
    {
       g_uart_system_context.uart3_event &= ~(*p_event & UART_IRQ_SRC_DEVICE_ALL_INTERRUPT);
    }
		                         ...
		                         IN t_uart_irq_src interrupt_mask, OUT t_uart_it_communication_status  *p_comm_status)
{
    ...
    else if (UART_DEVICE_ID_2 == uart_device_id)
    {
     ...
     else
     {
        ...
        {
            DBGPRINT(DBGL_HCL_DEV, "FRAMING ERROR");
            g_uart_system_context.uart3_rx_status = (t_uart_receive_status) UART_FRAMING_ERROR;
        ...
        {
            DBGPRINT(DBGL_HCL_DEV, "PARITY ERROR");
            g_uart_system_context.uart3_rx_status = (t_uart_receive_status) UART_PARITY_ERROR;
        ...
        {
            DBGPRINT(DBGL_HCL_DEV, "OVERRUN ERROR");
            g_uart_system_context.uart3_rx_status = (t_uart_receive_status) UART_OVERRUN_ERROR;
...
PRIVATE void uart_ProcessTxIt(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)                             /* Choose suitable UART base adress */
    {
        ...
        case UART_DEVICE_ID_3:
            {
                lp_uart_register = g_uart_system_context.p_uart3_register;
                p_comm_status = &g_uart_system_context.uart3_comm_status;
                ntx = g_uart_system_context.uart3_ntx;  /* Update context for UART_DEVICE_ID_1 */
                p_transmit_uart = g_uart_system_context.p_uart3_transmit_buffer;
                uart_number_of_char_to_be_tx = g_uart_system_context.uart3_number_of_char_to_be_tx;
                uart_fifo_trigger_tx = g_uart_system_context.uart3_trigger_tx;
                break;
            }
    ...
    {
        g_uart_system_context.uart2_ntx = ntx;      /* Update context for UART_DEVICE_ID_2 */
    }
    
    else
    {
       g_uart_system_context.uart3_ntx = ntx;      /* Update context for UART_DEVICE_ID_3 */
    }
...
PRIVATE t_uart_error uart_ProcessRxIt(IN t_uart_device_id uart_device_id)
{
        ...
        case UART_DEVICE_ID_3:
           {
               lp_uart_register = g_uart_system_context.p_uart3_register;
                p_comm_status = &g_uart_system_context.uart3_comm_status;
                nrx = g_uart_system_context.uart3_nrx;
                p_receive_uart = g_uart_system_context.p_uart3_receive_buffer;
                uart_number_of_char_to_be_rx = g_uart_system_context.uart3_number_of_char_to_be_rx;
                uart_fifo_trigger_rx = g_uart_system_context.uart3_trigger_rx;
                break; 
           }
    ...
    {
        g_uart_system_context.uart2_nrx = nrx;      /* Update context for UART_DEVICE_ID_2 */
    }
    
    else 
    {
        g_uart_system_context.uart3_nrx = nrx;      /*Update context for UART_DEVICE_ID_3*/
    }

//#if ((defined __PEPS_8500) || (defined __PEPS_8500_V1) || (defined __PEPS_8500_V2))  /*Need not required for U5500*/
		                    ...
		                    OUT volatile t_uart_error *error_status, IN t_uart_device_id uart_device_id)
{
    ...
    if (0 != (interrupt_mask & UART_IRQ_SRC_AUTOBAUD_DONE))
    {
        ...
        {
            g_uart_system_context.uart3_is_autobaud_done = TRUE;
            uart_config = &(g_uart_system_context.uart3_config);
        }
        ...
        case UART_DEVICE_ID_3:
            {
               *lp_uart_register = g_uart_system_context.p_uart3_register;
               *p_comm_status = &g_uart_system_context.uart3_comm_status;
               *uart_mode = g_uart_system_context.uart3_config.uart_mode;
               *flow_control = g_uart_system_context.uart3_config.flow_control;
               *transfer_flags = g_uart_system_context.uart3_transfer_flags;
               break;
            }
    ...
    if (UART_SW_FLOW_CONTROL == flow_control)
    {
        *temp_flag = TRUE;
        if (data_received == xoff1_char)
        {
            ...
            {
#ifndef UART3_AUTO_SW_FLOW_CONTROL
                DBGPRINT(DBGL_HCL_DEV, "Xoff RECEIVED for UART2 ");
                g_uart_system_context.uart3_is_xoff_recd = TRUE;
                g_uart_system_context.uart3_is_xon_recd = FALSE;
#endif /*  UART2_AUTO_SW_FLOW_CONTROL */           
            }
        }
        else if (data_received == xon1_char)
        {
            ...
            {
#ifndef UART3_AUTO_SW_FLOW_CONTROL
                DBGPRINT(DBGL_HCL_DEV, "Xon RECEIVED for UART3 ");
                g_uart_system_context.uart3_is_xon_recd = TRUE;
                g_uart_system_context.uart3_is_xoff_recd = FALSE;
#endif /*  UART3_AUTO_SW_FLOW_CONTROL */               
            }
        }
    }
}
...
)
{
    ...
    *p_receive_error = (t_uart_receive_status) UART_RECEIVE_OK;
    ...
    switch (uart_device_id)                     /* Choose suitable UART base adress  */
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            transfer_flags = g_uart_system_context.uart3_transfer_flags;
            perr_condition = g_uart_system_context.uart3_config.perr_condition;
            flow_control = g_uart_system_context.uart3_config.flow_control;
            xoff1_char = g_uart_system_context.uart3_config.xoff1_char;
            xon1_char = g_uart_system_context.uart3_config.xon1_char;
            comm_status = g_uart_system_context.uart3_comm_status;
            break;
    ...
    *p_char_number_read = count;
    ...
    {
        g_uart_system_context.uart3_rx_status = *p_receive_error;
    }
    if ((t_uart_receive_status) UART_RECEIVE_OK != *p_receive_error)
    {
...
PUBLIC t_uart_error UART_SendXoff(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            ...
            xoff1_char = g_uart_system_context.uart3_config.xoff1_char;
            uart_mode = g_uart_system_context.uart3_config.uart_mode;
            if (UART_SW_FLOW_CONTROL != g_uart_system_context.uart3_config.flow_control)
            {
                DBGPRINT(DBGL_ERROR, "No SW Flow Control Enabled in SendXoff");
                DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                return(UART_REQUEST_NOT_APPLICABLE);
...
)
{
    ...
    else if (UART_DEVICE_ID_3 == uart_device_id)
    {
#ifndef UART3_AUTO_SW_FLOW_CONTROL
        *p_xoff_char = g_uart_system_context.uart3_is_xoff_recd;
        *p_xon_char = g_uart_system_context.uart3_is_xon_recd;
#endif /* UART2_AUTO_SW_FLOW_CONTROL */
#ifdef UART2_AUTO_SW_FLOW_CONTROL
        if(UART_IRQ_SRC_XOFF == (UART_IRQ_SRC_XOFF & g_uart_system_context.p_uart3_register->uartx_ris))
        {
            *p_xoff_char = TRUE;
            *p_xon_char = FALSE;
        } /* end if */
...
PUBLIC t_uart_error UART_BytesReceived(IN t_uart_device_id uart_device_id, OUT t_uint32 *p_bytes)
{
    ...
    {
        *p_bytes = g_uart_system_context.uart3_nrx;
    }
    else
    {
        DBGEXIT0(UART_INVALID_PARAMETER);
...
PUBLIC t_uart_error UART_BytesTransmitted(IN t_uart_device_id uart_device_id, OUT t_uint32 *p_bytes)
{
    ...
    {
        *p_bytes = g_uart_system_context.uart3_ntx;
    }
    else
    {
        DBGEXIT0(UART_INVALID_PARAMETER);
...
PUBLIC t_uart_error UART_ReceiveCancel(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            if (UART_RECEIVE_ON_GOING == g_uart_system_context.uart3_comm_status.rx_comm_status)
            {
                g_uart_system_context.p_uart3_register->uartx_imsc &= ~(UART_IRQ_SRC_RX | UART_IRQ_SRC_RXTO);
                g_uart_system_context.uart3_comm_status.rx_comm_status = UART_RECEIVE_ENDED;
            }
			break;
...
PUBLIC t_uart_error UART_TransmitCancel(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            if (UART_TRANSMIT_ON_GOING == g_uart_system_context.uart3_comm_status.tx_comm_status)
            {
                g_uart_system_context.p_uart3_register->uartx_imsc &= ~(UART_IRQ_SRC_TX | UART_IRQ_SRC_TXFE);
                g_uart_system_context.uart3_comm_status.tx_comm_status = UART_WRITTINGS_ENDED;
            }
            break;
	case UART_DEVICE_ID_INVALID:    
        default:
...
PUBLIC t_uart_error UART_GetReceiveStatus(IN t_uart_device_id uart_device_id, OUT t_uart_receive_status *p_rx_status)
{
    ...
    switch (uart_device_id) /* Choose suitable UART base adress */
    {
        ...
        case UART_DEVICE_ID_3:
            *p_rx_status = g_uart_system_context.uart3_rx_status;
            break;
...
)
{
    ...
    switch (uart_device_id) /* Choose suitable UART base adress */
    {
        ...
        case UART_DEVICE_ID_3:
            lp_comm_status = &g_uart_system_context.uart3_comm_status;
            lp_uart_register = g_uart_system_context.p_uart3_register;
            break;
				                  ...
				                  IN  t_uint8 *p_data_char)
{
    switch (uart_device_id)         /* Choose suitable UART base adress */
    {
       ...
       case UART_DEVICE_ID_3:
          {
                if (TRUE == g_uart_system_context.uart3_need_to_call_config)
                {
                    DBGPRINT(DBGL_ERROR, " Need to call UART_SetConfig Error");
                    DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                    return(UART_REQUEST_NOT_APPLICABLE);
                ...
                *lp_uart_register = g_uart_system_context.p_uart3_register;
                ...
                if
                (
                    UART_SW_FLOW_CONTROL == g_uart_system_context.uart3_config.flow_control
                &&  TRUE == g_uart_system_context.uart3_is_xoff_recd
                )
                {
                    DBGPRINT(DBGL_ERROR, " SW Flowed Off /XOFF Character Recd/ in TransmitxChar ");
                    DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                ...
                *uart_mode = g_uart_system_context.uart3_config.uart_mode;
                g_uart_system_context.uart3_number_of_char_to_be_tx = num_of_char_to_be_tx; /* Keep data in static global: */
                g_uart_system_context.p_uart3_transmit_buffer = p_data_char;                /* Bytes number and pointer on first byte */
                *uart_fifo_size = UART3_FIFO_SIZE;
                g_uart_system_context.uart3_ntx = 0;                    /* Initialize current byte number */
                *transfer_flags = g_uart_system_context.uart3_transfer_flags;
                break;
            }
		                 ...
		                 IN t_uint8 *p_data_char, IN t_uint32 num_of_char_to_be_tx)
{
    ...
    {
         g_uart_system_context.uart3_comm_status.tx_comm_status = UART_TRANSMIT_ON_GOING;
         g_uart_system_context.uart3_ntx = g_uart_system_context.uart3_ntx + first_transmit;
         if (g_uart_system_context.uart3_number_of_char_to_be_tx == g_uart_system_context.uart3_ntx) /* If all writings covered by the fifo filling */
         {   /* ->transfer's end */
             g_uart_system_context.uart3_comm_status.tx_comm_status = UART_WRITTINGS_ENDED;
         }
         else
       ...
       case UART_DEVICE_ID_3:
            {
                ...
                uart_mode = g_uart_system_context.uart3_config.uart_mode;
                flow_control = g_uart_system_context.uart3_config.flow_control;
                if (UART_RECEIVE_ENDED != g_uart_system_context.uart3_comm_status.rx_comm_status)
                {
                    DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                    return(UART_REQUEST_NOT_APPLICABLE);
                }
                ...
                p_comm_status = &g_uart_system_context.uart3_comm_status;
                if (g_uart_system_context.uart3_transfer_flags & UART_RX_IT_MODE)
                {
                    g_uart_system_context.uart3_comm_status.rx_comm_status = UART_RECEIVE_ON_GOING;
                }

                g_uart_system_context.uart3_number_of_char_to_be_rx = num_of_char_to_be_recd;   
                g_uart_system_context.p_uart3_receive_buffer = p_data_char;    /* Bytes number and pointer on first byte */
                uart_fifo_size = UART3_FIFO_SIZE;
                g_uart_system_context.uart3_nrx = 0;            /* Initialize current byte number */
                transfer_flags = g_uart_system_context.uart3_transfer_flags;
                break;
            }
...
PRIVATE t_uart_error uart_enh_PowerOn(IN t_uart_device_id uart_device_id)
{
    ...
    switch (uart_device_id)
    {
       ...
       case UART_DEVICE_ID_3:
            ...
            if (FALSE == g_uart_system_context.uart3_is_power_off)
            {
                DBGEXIT0(UART_REQUEST_NOT_APPLICABLE);
                return(UART_REQUEST_NOT_APPLICABLE);
            }
            ...
            g_uart_system_context.uart3_is_power_off = FALSE;
            error_status = uart_enh_SetConfiguration(uart_device_id, &g_uart_system_context.uart3_config);
            break;
...
PRIVATE void uart_PreparePowerOff(IN t_uart_device_id uart_device_id, IN t_uart_register *lp_uart_register)
{
    switch(uart_device_id)
    {
        ...
        case  UART_DEVICE_ID_3:   
            ...
            if (FALSE == g_uart_system_context.uart3_is_autobaud_done)
            {   /* Stop the automatic format extraction process */
                lp_uart_register->uartx_abicr |= (UART_IRQ_SRC_ABD | UART_IRQ_SRC_ABE);
                lp_uart_register->uartx_abimsc &= ~(UART_IRQ_SRC_ABD | UART_IRQ_SRC_ABE);
                g_uart_system_context.uart3_is_autobaud_done = TRUE;
                g_uart_system_context.p_uart3_register->uartx_abcr = MASK_NULL16;
            }
	    return;
       ...
       case UART_DEVICE_ID_3:
          {
                lp_uart_register = g_uart_system_context.p_uart3_register;
                g_uart_system_context.uart3_config = *p_config;
                g_uart_system_context.uart3_need_to_call_config = FALSE;
                g_uart_system_context.uart3_comm_status.tx_comm_status = UART_TRANSMIT_ENDED;
                g_uart_system_context.uart3_comm_status.rx_comm_status = UART_RECEIVE_ENDED;
                g_uart_system_context.uart3_rx_status = (t_uart_receive_status) UART_RECEIVE_OK;
                g_uart_system_context.uart3_is_autobaud_done = TRUE;
                g_uart_system_context.uart3_event = 0;
                g_uart_system_context.uart3_transfer_flags = UART_TX_IT_MODE | UART_RX_IT_MODE;
                UpdateTxTrig(g_uart_system_context.uart3, 1);
                UpdateRxTrig(g_uart_system_context.uart3, 1);
                break;
          }
...
PRIVATE t_uart_error uart_enh_ConfigureAutoBaud(IN t_uart_device_id uart_device_id, IN t_uart_set_or_clear uart_action)
{
    ...
    switch (uart_action)
    {
        case UART_SET:
            ...
            {
                g_uart_system_context.uart3_is_autobaud_done = FALSE;
            }
...
)
{
    ...
    switch (uart_device_id)
    {
        ...
        case UART_DEVICE_ID_3:
            lp_uart_register = g_uart_system_context.p_uart3_register;
            *p_is_autobaud_done = g_uart_system_context.uart3_is_autobaud_done;
            *p_baud_rate = g_uart_system_context.uart3_config.baud_rate; 
            break;
    ...
    switch(uart_device_id)
    {
	 ...
	 case UART_DEVICE_ID_1:
  	 ...
  	 case UART_DEVICE_ID_2:
		 ...
		 case UART_DEVICE_ID_3:
                    p_trigger->trig3_tx = (t_uint32 )tx_trigger;
		    if(UART_TX_TRIG_THREE_FOURTH_EMPTY != tx_trigger)
		    {
                        UpdateTxTrig(g_uart_system_context.uart3, (((t_uint32 )tx_trigger)<<1) );
		    }
		    else
		    {
                        UpdateTxTrig(g_uart_system_context.uart3, UART_FIFO_THREE_FOURTH_TRIGGER_VAL);
		    }            
                    p_trigger->trig3_rx = (t_uint32 )rx_trigger;
		    if(UART_RX_TRIG_THREE_FOURTH_FULL != rx_trigger)
		    {
                        UpdateRxTrig(g_uart_system_context.uart3, (((t_uint32 )rx_trigger)<<1) );
		    }
		    else
		    {
                        UpdateRxTrig(g_uart_system_context.uart3, UART_FIFO_THREE_FOURTH_TRIGGER_VAL);
		    }
