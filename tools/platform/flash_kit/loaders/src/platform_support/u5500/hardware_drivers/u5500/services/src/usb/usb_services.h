...
*
* \brief This file holds the function declaration for the services for U5500
* \author  ST-Ericsson
*/
/*****************************************************************************/
#ifdef __cplusplus
...
#define SER_USB_PRCM_CLKOCR2 	PRCMU_REG_BASE_ADDR+ 0x58C
#define SER_USB_PRCM_CLKOCR2_ENA 0x01 
