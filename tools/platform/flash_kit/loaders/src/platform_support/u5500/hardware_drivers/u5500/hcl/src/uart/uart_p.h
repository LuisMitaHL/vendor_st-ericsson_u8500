...
*
* \brief   This File contains Private headers for UART for U5500
* \author  ST-Ericsson
*/
/*****************************************************************************/
#ifndef _UARTP_H_
...
#define UART3_CHECK_PERIPH_ID_OK      (    (UART3_P_ID0 == g_uart_system_context.p_uart3_register->uartx_periphid0)  \
                                       &&  (UART3_P_ID1 == g_uart_system_context.p_uart3_register->uartx_periphid1)  \
                                       &&  (UART3_P_ID2 == g_uart_system_context.p_uart3_register->uartx_periphid2)  \
                                       &&  (UART3_P_ID3 == g_uart_system_context.p_uart3_register->uartx_periphid3)  \
                                       &&  (UART3_CELL_ID0 == g_uart_system_context.p_uart3_register->uartx_cellid0) \
                                       &&  (UART3_CELL_ID1 == g_uart_system_context.p_uart3_register->uartx_cellid1) \
                                       &&  (UART3_CELL_ID2 == g_uart_system_context.p_uart3_register->uartx_cellid2) \
                                       &&  (UART3_CELL_ID3 == g_uart_system_context.p_uart3_register->uartx_cellid3) \
                                      )
...
/*----------------------------------Clock is 26.0MHz----------------------------*/
#define UART_CLK                          26000000UL        /* 26.0MHz (Change this to change Baud Rate settings) */
...
typedef struct
{
    ...
    t_uart_register                 *p_uart3_register;      /* POinter to UART_DEVICE_ID_3 registers structure */
    ...
    t_uart_config                   uart3_config;           /* UART_DEVICE_ID_3 configuration */
    ...
    t_uint32                        uart3_transfer_flags;   /* UART_DEVICE_ID_3 Transfer mode flag */
    ...
    t_bool                          uart3_is_power_off;     /* UART_DEVICE_ID_3 power management flag */
    ...
    t_uart_device_context           uart3_device_context;   /* UART_DEVICE_ID_3 Device context */
    ...
    t_bool                          uart3_is_xon_recd;
    t_bool                          uart3_is_xoff_recd;
    ...
    t_uart_it_communication_status  uart3_comm_status;
    ...
    t_bool                          uart3_need_to_call_config;
    ...
    t_uint32                         uart3_trigger_tx;
    t_uint32                         uart3_trigger_rx;
