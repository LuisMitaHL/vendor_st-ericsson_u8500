...
*
* \brief   This module provides the basic defintions
* \author  ST-Ericsson
*/
/*****************************************************************************/
...
/* To Initialize the Critical Section */
t_smp_safe_error CriticalSection_Init(t_comp_name,t_uint8);

/* To Enter the Critical Section */
void CriticalSection_Enter(t_comp_name,t_uint8);

/* To Exit the Critical Section */
void CriticalSection_Exit(t_comp_name,t_uint8);

        
#define HCL_CRITICAL_SECTION_INIT(comp,numofguards)\
        {\
        	CriticalSection_Init(comp,numofguards);\
        }

        
#define HCL_CRITICAL_SECTION_ENTER(comp,guardnum)\
        {\
        	CriticalSection_Enter(comp,guardnum);\
        }
        
#define HCL_CRITICAL_SECTION_EXIT(comp,guardnum)\
        {\
        	CriticalSection_Exit(comp,guardnum);\
        }
