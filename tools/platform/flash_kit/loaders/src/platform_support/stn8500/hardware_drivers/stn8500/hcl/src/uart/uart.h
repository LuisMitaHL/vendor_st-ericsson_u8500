...
*
* \brief   This File contains public headers for HAL Routines for UART (U8500)
* \author  ST-Ericsson
*/
/*****************************************************************************/
#ifndef _UART_H_
...
/* Defines for Version */
#define UART_HCL_VERSION_ID 2
#define UART_HCL_MAJOR_ID   2
#define UART_HCL_MINOR_ID   4
