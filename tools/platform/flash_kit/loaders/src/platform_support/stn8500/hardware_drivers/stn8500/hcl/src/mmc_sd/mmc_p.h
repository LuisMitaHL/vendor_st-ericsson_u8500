...
/*SIZE OF THE CID REGISTER */
#define EMMC_CID_SIZE 16
...
#define MMC_POWER_MASK_RESET    0x00000200
...
#define MMC_CLKDIVINIT  0x76                            /*(0x0000009E)*/
...
#define AUTH_KEY_PRG_REQ    0x0001  /* Authentication key programming request */
#define READ_WRITE_CNT_REQ  0x0002  /* Reading of the Write Counter value request */
#define AUTH_DATA_WRITE_REQ 0x0003  /* Authenticated data write request */
#define AUTH_DATA_READ_REQ  0x0004  /* Authenticated data read request */
#define RES_READ_REQ        0x0005  /* Result read request */

/* Response Message Types */
#define AUTH_KEY_PRG_RES    0x0100  /* Authentication key programming response */
#define READ_WRITE_CNT_RES  0x0200  /* Reading of the Write Counter value response */
#define AUTH_DATA_WRITE_RES 0x0300  /* Authenticated data write response */
#define AUTH_DATA_READ_RES  0x0400  /* Authenticated data read response */
...
#define ENABLE_RPMB     0x03B30300  /* Byte[2] is offset in ExtCDS, 0xB3 = 179 = PARTITION_CONFIG */
#define DISABLE_RPMB    0x03B30000  /* Byte[1] is value, 0x03 RPMB active, 0x00 User area active */

#define REQUEST_HI_BYTE 510
#define REQUEST_LO_BYTE 511

/* RPMB Data Packet */
typedef struct {
    t_uint8  stuff_bytes[RPMB_STUFF_SIZE];
    t_uint8  key_MAC[RPMB_KEY_MAC_SIZE];
    t_uint8  data[RPMB_DATA_SIZE];
    t_uint8  nonce[RPMB_NONCE_SIZE];
    t_uint8  write_counter[4];
    t_uint8  address[2];
    t_uint8  block_count[2];
    t_uint8  result[2];
    t_uint8  request_response[2];
} t_RPMB_data;
