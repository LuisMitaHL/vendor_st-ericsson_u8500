 ...
 *--------------------------------------------------------------------------*/
#define GIC_HCL_VERSION     2
#define GIC_HCL_MAJOR       2
#define GIC_HCL_MINOR       3
...
typedef enum
{
    ...
    GIC_I2C_0_LINE,                     /*	46   */
    GIC_CRYP_1_LINE,                    /*	47	 */
    GIC_MSP_1_RX_LINE,                  /*	48   */
    GIC_TIMER_1_LINE,	                /*	49   */
    
    GIC_RTT_0_1_LINE,                   /*	50   */
    GIC_UART_1_LINE,                    /*	51   */
    GIC_RESERVED_1_LINE,                /*	52   */
    GIC_SSP_0_LINE,                     /*	53   */
    GIC_I2C_1_LINE,                     /*	54   */
    GIC_USB_OTG_LINE,                   /*	55   */
    ...
    GIC_DMA_LINE,                       /*	57   */
    GIC_UART_2_LINE,                    /*	58   */
    GIC_RESERVED_2_LINE,                /*	59   */
    GIC_RESERVED_3_LINE,                /*	60   */
    GIC_HSI_RX_EXCP_LINE,               /*	61   */
    GIC_RESERVED_4_LINE,                /*	62   */
    GIC_MSP_0_LINE,                     /*	63   */
    GIC_HSI_RX_0_LINE,                  /*  64   */
    GIC_HSI_RX_1_LINE,                  /*  65   */
    GIC_HSI_RX_2_LINE,                  /*  66   */
    GIC_HSI_RX_3_LINE,                  /*  67   */
    GIC_HSI_RX_4_LINE,                  /*  68   */
    GIC_HSI_RX_5_LINE,                  /*  69   */
    GIC_HSI_RX_6_LINE,                  /*  70   */
    GIC_HSI_RX_7_LINE,                  /*  71   */
    GIC_INT4500_LINE,                   /*  72   */
...
/* Line 96-127 are reserved for Modem Interrupt Sources */
    ...
    GIC_RESERVED_LINE96,				/* 96 */
	GIC_RESERVED_LINE97,				/* 97 */
    ...
    GIC_MSP_2_LINE,                     /*  130   */
    GIC_SD_MMC_4_LINE,                  /*	131	  */
    GIC_SD_MMC_5_LINE,                  /*	132	  */
    GIC_SLIMBUS_0_LINE,                 /*	133   */
    
    GIC_RESERVED_LINE134,				/*	134   */
    
    GIC_DDR_LINE,  		                /*	135   */
    GIC_HSI_RX_D0_LINE,                 /*  136   */
    GIC_HSI_RX_D1_LINE,                 /*  137   */
    GIC_HSI_TX_D0_LINE,                 /*  138   */
    GIC_HSI_TX_D1_LINE,                 /*  139   */
    
	GIC_CA9_CTIIRQ0_LINE,				/* 140 */
	GIC_CA9_CTIIRQ1_LINE,				/* 141 */
    GIC_RESERVED_LINE142,               /* 142 */
...
#elif defined(ST_8500ED) || defined(ST_HREFED) || defined(__PEPS_8500) 
...
#elif defined(ST_8500V1) || defined(ST_HREFV1)|| defined(__PEPS_8500_V2)
...
#elif defined(ST_8500V2) || defined(ST_HREFV2)
