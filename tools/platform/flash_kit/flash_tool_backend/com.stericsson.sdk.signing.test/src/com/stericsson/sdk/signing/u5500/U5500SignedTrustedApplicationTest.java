...
import com.stericsson.sdk.signing.generic.GenericSignedTrustedApplication;
 ...
 * 
 */
public class U5500SignedTrustedApplicationTest extends TestCase {

    private static final String NON_EXISITNG_FILE_FILENAME = "fakefile.fake";

    private static final String DIRECTORY_FILE_FILENAME = "/";

    private static final String UNSIGNED_PAYLOAD_FILENAME = "/u5500/unsigned_trusted.bin";

    private static final String SIGNED_PAYLOAD_FILENAME = "signed_trusted.bin";
    ...
    public void testNonExistingFile() {
        ...
        try {
            ...
            GenericSignedTrustedApplication payload = new GenericSignedTrustedApplication(settings);
            payload.getClass();
    ...
    public void testCreatePayload() {
        ...
        try {
            ...
            GenericSignedTrustedApplication payload = new GenericSignedTrustedApplication(settings);
            assertTrue(file.length() > payload.getLength());
