...
/**
 * Creates and register a warm equipment.
 * 
 * @author esrimpa
 */
public class U8500WarmPlatform extends AbstractPlatform implements IEquipmentTaskListener {
     ...
     * Logger instance
     */
    private Logger logger = Logger.getLogger(U8500WarmPlatform.class);
    ...
    public void createEquipment(IPort port, IEquipmentProfile profile, boolean bootME) {
        ...
        U8500WarmEquipment equipment = new U8500WarmEquipment(port, profile);
    ...
    public void taskMessage(IEquipmentTask task, String message) {
        if (task.getEquipment() instanceof U8500WarmEquipment) {
