package com.stericsson.sdk.equipment.u8500.warm.internal;
...
import com.stericsson.sdk.equipment.u8500.warm.Activator;
...
/**
 * Creates and schedule tasks for this type of equipment.
 *
 * @author esrimpa
 */
public class U8500WarmEquipment extends AbstractUX500WarmEquipment {

    /**
     * Logger instance
     */
    private static Logger logger = Logger.getLogger(U8500WarmEquipment.class);
     ...
     *            Profile
     */
    public U8500WarmEquipment(IPort port, IEquipmentProfile profile) {
        super(port, profile);
        setProperty(U8500WarmPlatform.PLATFORM_PROPERTY, U8500WarmPlatform.PLATFORM_PROPERTY,
            U8500WarmPlatform.PLATFORM, false);
        setProperty(U8500WarmPlatform.PORT_PROPERTY, U8500WarmPlatform.PORT_PROPERTY, port.getPortName(), false);
    ...
    public String toString() {
        return U8500WarmPlatform.PLATFORM + "@" + getPort().getPortName();
    }
