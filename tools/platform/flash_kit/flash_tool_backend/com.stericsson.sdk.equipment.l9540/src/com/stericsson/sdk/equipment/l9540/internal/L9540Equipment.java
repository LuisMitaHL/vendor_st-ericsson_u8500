 ...
 * @author mbocek01
 */
public class L9540Equipment extends AbstractLoaderCommunicationEquipment implements ILoaderCommunicationListener,
    ServiceTrackerCustomizer {

    /** */
    private static Logger logger = Logger.getLogger(L9540Equipment.class);
     ...
     *            Profile
     */
    public L9540Equipment(IPort port, IEquipmentProfile profile) {
        super(port, profile);
        setProperty(L9540Platform.PLATFORM_PROPERTY, L9540Platform.PLATFORM_PROPERTY, L9540Platform.PLATFORM, false);
        setProperty(L9540Platform.PORT_PROPERTY, L9540Platform.PORT_PROPERTY, port.getPortName(), false);
    ...
    public String toString() {
        return L9540Platform.PLATFORM + "@" + getPort().getPortName();
    }
