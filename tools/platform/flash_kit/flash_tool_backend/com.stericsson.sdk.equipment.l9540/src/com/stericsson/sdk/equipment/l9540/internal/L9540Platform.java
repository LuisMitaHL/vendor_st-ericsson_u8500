package com.stericsson.sdk.equipment.l9540.internal;
...
import com.stericsson.sdk.equipment.l9540.Activator;

/**
 * @author mbocek01
 */
public class L9540Platform extends AbstractLCPlatform implements IEquipmentTaskListener {

    /** */
    public static final String PLATFORM = "l9540";

    /** */
    private Logger logger = Logger.getLogger(L9540Platform.class);
    ...
    public void createEquipment(IPort port, IEquipmentProfile profile, boolean bootME) {
        ...
        L9540Equipment equipment = new L9540Equipment(port, profile);
        ...
        try {
            ...
            logger.info("BOOT task on " + port.getPortName() + " port finished without error.");
    ...
    private void runTask(L9540Equipment equipment, IEquipmentTask task) throws Exception {
    ...
    /**
     * Creates a dummy l9540 equipment.
     */
    public void createDummyEquipment() {
        L9540Equipment equipment = new L9540Equipment(new AbstractPort("l9540Port") {
    ...
    public void taskMessage(IEquipmentTask task, String message) {
        if (task.getEquipment() instanceof L9540Equipment) {
