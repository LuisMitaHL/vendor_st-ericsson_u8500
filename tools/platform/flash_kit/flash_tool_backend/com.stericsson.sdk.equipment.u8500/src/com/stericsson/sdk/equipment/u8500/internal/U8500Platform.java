 ...
 * @author xtomlju
 */
public class U8500Platform extends AbstractLCPlatform implements IEquipmentTaskListener {

    /** */
    public static final String PLATFORM = "u8500";

    /** */
    private Logger logger = Logger.getLogger(U8500Platform.class);
    ...
    public void createEquipment(IPort port, IEquipmentProfile profile, boolean bootME) {
        ...
        U8500Equipment equipment = new U8500Equipment(port, profile);
    ...
    private void runTask(U8500Equipment equipment, IEquipmentTask task) throws Exception {
    ...
    /**
     * Creates a dummy U8500 equipment.
     */
    public void createDummyEquipment() {
        U8500Equipment equipment = new U8500Equipment(new AbstractPort("U8500Port") {
    ...
    public void taskMessage(IEquipmentTask task, String message) {
        if (task.getEquipment() instanceof U8500Equipment) {
