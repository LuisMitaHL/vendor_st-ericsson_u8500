 ...
 * 
 */
public class DummyEquipmentEraseGlobalDataSetTask extends AbstractEquipmentTask {
    ...
    static final String[] ARGUMENTS = new String[] {
        "PARAMETER_STORAGE_ERASE_GLOBAL_DATA_SET", "/flash0/GDFS", String.valueOf(lengthFile), "PC" + SOURCE_PATH};

    static final String[] ARGUMENTS_BULK = new String[] {
        "PARAMETER_STORAGE_ERASE_GLOBAL_DATA_SET", "/flash0/GDFS", String.valueOf(lengthFile), "ME" + SOURCE_PATH};

    /**
     * @param equipment
     *            the equipment to operate on
     */
    public DummyEquipmentEraseGlobalDataSetTask(DummyEquipment equipment) {
        super(equipment);
        ...
        resultMessage = "Erase Global Data Set finished successfully";
