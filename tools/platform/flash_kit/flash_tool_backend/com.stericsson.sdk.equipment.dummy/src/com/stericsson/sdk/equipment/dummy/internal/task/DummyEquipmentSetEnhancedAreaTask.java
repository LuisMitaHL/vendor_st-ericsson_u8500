 ...
 * 
 */
public class DummyEquipmentSetEnhancedAreaTask extends AbstractEquipmentTask {
     ...
     *            Equipment interface
     */
    public DummyEquipmentSetEnhancedAreaTask(DummyEquipment equipment) {
        super(equipment);
    ...
    public EquipmentTaskResult execute() {
        notifyTaskMessage("areaPath =" + areaPath + ", start=" + offset + ", length=" + length);
        notifyTaskStart();
        ...
        mobileEquipment.sendCommand(LCDefinitions.METHOD_NAME_FLASH_SET_ENHANCED_AREA, new Object[] {
