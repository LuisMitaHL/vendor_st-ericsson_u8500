 ...
 *
 */
public class GetEquipmentAvailableSecurityPropertiesExecutorTest extends TestCase {
    /**
     * 
     */
    @Test
    public void testGetEquipmentProperties() {
        GetAvailableSecurityPropertiesFromProfileExecutor executor = new GetAvailableSecurityPropertiesFromProfileExecutor();
        ...
        try {
            ac =
                CommandFactory.createCommand(CommandName.BACKEND_GET_AVAILABLE_SECURITY_PROPERTIES.name());
