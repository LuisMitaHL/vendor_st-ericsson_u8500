 ...
 * 
 */
public class DumpAreaExecutorTest extends TestCase {
    ...
    public void testDumpAreaExecutor() {
        ...
        try {
            ac =
                CommandFactory.createCommand(CommandName.FLASH_DUMP_AREA.name() + AbstractCommand.DELIMITER + "PortA"
                    + AbstractCommand.DELIMITER + "/flash0/" + AbstractCommand.DELIMITER + "0"
                    + AbstractCommand.DELIMITER + "0x1000" + AbstractCommand.DELIMITER + "\\temp"
                    + AbstractCommand.DELIMITER + "true" + AbstractCommand.DELIMITER + "true");
