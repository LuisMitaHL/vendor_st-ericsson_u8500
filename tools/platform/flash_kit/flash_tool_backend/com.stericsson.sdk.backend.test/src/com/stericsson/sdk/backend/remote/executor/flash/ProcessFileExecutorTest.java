 ...
 * 
 */
public class ProcessFileExecutorTest extends TestCase {
    ...
    public void testDumpAreaExecutor() {
        ...
        try {
            ac =
                CommandFactory.createCommand(CommandName.FLASH_PROCESS_FILE.name() + AbstractCommand.DELIMITER + "PortA"
                    + AbstractCommand.DELIMITER + "\\test");
