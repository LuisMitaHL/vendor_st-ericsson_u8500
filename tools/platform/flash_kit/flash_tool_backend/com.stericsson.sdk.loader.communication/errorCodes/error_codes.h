...
typedef enum {
  ...
  E_INCOMPATIBLE_START_ADDRESS = 762, /**<  Mismatch between manifest and flashlayout. */ 
  E_INVALID_SUBTOC_PARAMETERS = 763, /**<  Mismatch between TOC and flashlayout. */ 
  ...
  E_ERASING_BAM_AREA_FAILED = 773, /**<  Boot area is not empty. Erasing boot area on a logical level is not allowed. */ 
  ...
  E_CSPSA_RESULT_E_BAD_PARAMETER = 1382, /**<  Error because of bad input parameter. */ 
  ...
  E_HSI_BSC_RESULT_FAILED_BUSY = 2705, /**<  Current transfer not finished. */ 
  ...
  E_HSI_BSC_ERROR_RECEIVE = 2754, /**<  HSI_BSC_ERROR_RX_BUFFER_NOT_PROVIDED. */ 
  E_HSI_BSC_ERROR_TRANSMIT = 2755, /**<  HSI_BSC_ERROR_TX_BUFFER_NOT_PROVIDED. */ 
  E_BAM_INVALID_HANDLE = 2851, /**<  The handle supplied to BAM is invalid. */ 
  E_BAM_ALREADY_INITIALIZED = 2852, /**<  The instance if BAM has already been initialized. */ 
  E_BAM_INVALID_CONF = 2853, /**<  BAM configuration is invalid. */ 
  E_BAM_BAD_PARAM = 2854, /**<  One of the parameter passed to BAM makes no sense. */ 
  E_BAM_ENOMEM = 2855, /**<  BAM could not allocate enough memory to complete the operation. */ 
  E_BAM_ENOENT = 2856, /**<  BAM could not locate the requested image/partition. */ 
  E_BAM_EEXIST = 2857, /**<  An image with the same ID has already been written. */ 
  E_BAM_ENOSPACE = 2858, /**<  BAM could not complete the operation due to insufficient storage space. */ 
  E_BAM_ERANGE = 2859, /**<  A TOC entry specifies a location outside the area. */ 
  E_BAM_INVALID_TOC = 2860, /**<  The TOC passed to BAM was detected as corrupt. */ 
  E_BAM_INVALID_AREA = 2861, /**<  An area found in the TOC or passed to BAM is invalid. */ 
  E_BAM_NOT_INITIALIZED = 2862, /**<  The instance or update mode of BAM has not been initialized. */ 
  E_BAM_HW_ERR = 2863, /**<  BAM was unable to perform the operation due to failure in HW. */ 
  E_BAM_STATE_CORRUPT = 2864, /**<  The BAM state is corrupt. */ 
  E_BAM_NOT_ALLOWED = 2865, /**<  The operation is not allowed. */ 
  E_BAM_FS_ERROR = 2866, /**<  An Operation towards the FileSystem return an unexpected result. */ 
  E_BAM_BAD_FS_STATE = 2867, /**<  BAM state files in the FS is not in the expected state. */ 
  E_BAM_HASH_ERROR = 2868, /**<  The hash callback function failed unexpectedly. */ 
  E_BAM_UPDATE_IN_PROGRESS = 2869, /**<  An update is already in progress. */ 
  E_BAM_BUF_TOO_SMALL = 2870, /**<  The supplied buffer is to small.The image will not fit. */ 
  E_BAM_EXTERNAL_ERROR = 2871, /**<  An external error occured. */ 
  E_BAM_NOT_INSTANTIATED = 2872, /**<  The requested function is not compiled into the loadmodule that supplies the service. */ 
  E_BAM_UPDATE_NOT_POSSIBLE = 2873, /**<  The state in the flash prevents BAM from performing any updates. */ 
