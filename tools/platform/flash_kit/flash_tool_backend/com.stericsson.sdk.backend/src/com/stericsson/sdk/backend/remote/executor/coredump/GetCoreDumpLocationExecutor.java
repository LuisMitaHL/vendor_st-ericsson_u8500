...
/**
 * Executor for getting the current core dump location
 * 
 * @author eolabor
 * 
 */
public class GetCoreDumpLocationExecutor extends ServerCommandExecutor {

    static final Logger log = Logger.getLogger(GetCoreDumpLocationExecutor.class);
    ...
    public String execute() throws ExecutionException {
        ...
        if (backendService == null) {
            ...
            message = backendService.getCoreDumpLocation();
        }
        return message;
    }
}
