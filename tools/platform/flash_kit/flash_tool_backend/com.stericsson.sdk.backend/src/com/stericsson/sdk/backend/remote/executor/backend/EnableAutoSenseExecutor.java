...
/**
 * Executor for enabling auto sense
 * 
 * @author xolabju
 * 
 */
public class EnableAutoSenseExecutor extends ServerCommandExecutor {
    ...
    private IBackendService getBackendService() {
        ...
        try {
            references =
                Activator.getBundleContext().getAllServiceReferences(IBackendService.class.getName(), null);
