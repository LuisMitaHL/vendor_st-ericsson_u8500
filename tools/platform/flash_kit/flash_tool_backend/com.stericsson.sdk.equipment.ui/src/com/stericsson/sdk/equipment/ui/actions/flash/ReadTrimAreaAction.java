...
/**
 * Read Trim Area action
 *
 * @author xhelciz
 *
 */
public class ReadTrimAreaAction extends BackendAction {
    /**
     * Constructor
     *
     * @param pViewer
     ...
     */
    public ReadTrimAreaAction(IBackendViewer pViewer) {
        super(pViewer);
        setText("Read Trim Area...");
        setToolTipText("Read Trim area from selected equipment and save it to file");
    ...
    public void run() {
        ...
        if (equipment != null) {
            ...
            Job job = new ReadGlobalDataSetJob(fileName, equipment, "ta");
