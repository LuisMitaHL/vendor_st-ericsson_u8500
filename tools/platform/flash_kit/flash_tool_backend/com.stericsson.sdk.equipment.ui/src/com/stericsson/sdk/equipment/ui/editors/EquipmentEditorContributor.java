 ...
 */
public class EquipmentEditorContributor extends MultiPageEditorActionBarContributor {
     ...
     */
    public EquipmentEditorContributor() {
        super();
        createActions();
    }

    /**
     * Returns the action registed with the given text editor. {@inheritDoc}
     * 
    ...
    private void createActions() {
        sampleAction = new Action() {
            public void run() {
                MessageDialog.openInformation(null, "Flash Kit Equipment", "Sample Action Executed");
            }
        };
