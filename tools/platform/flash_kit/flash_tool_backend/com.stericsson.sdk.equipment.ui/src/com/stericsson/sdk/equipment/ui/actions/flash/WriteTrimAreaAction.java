...
/**
 * Write Trim area action
 *
 * @author xhelciz
 *
 */
public class WriteTrimAreaAction extends BackendAction {
    /**
     * Constructor
     *
     * @param pViewer
     ...
     */
    public WriteTrimAreaAction(IBackendViewer pViewer) {
        super(pViewer);
        setText("Write Trim Area...");
        setToolTipText("Read Trim Area data from a file and write it to selected equipment");
    ...
    public void run() {
        ...
        if (equipment != null) {
            ...
            Job job = new WriteGlobalDataSetJob(fileName, equipment, "ta");
