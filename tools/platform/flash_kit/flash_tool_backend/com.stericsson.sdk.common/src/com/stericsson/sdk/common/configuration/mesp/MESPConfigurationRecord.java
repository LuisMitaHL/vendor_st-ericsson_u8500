...
/**
 * MESP configuration record implementation
 * 
 * @author tomas
 */
public class MESPConfigurationRecord implements IConfigurationRecord {
     ...
     */
    private static void parseArrayValue(MESPConfigurationTokenizer tokenizer, MESPConfigurationRecord record,
     ...
     * {@inheritDoc}
     */
    public IConfigurationRecord deepCopy() {
     ...
     */
    public static IConfigurationRecord newRecord() {
    ...
    public List<String> getValuesNames() {
        List<String> valuesNames = new ArrayList<String>(recordValues.size());
        for (Value v : recordValues) {
            valuesNames.add(v.getName());
        }
        return valuesNames;
    }
