...
//
// $Header: S:/GN_49xxPE_MKS/49xxPE_API/rcs/GN_GPS_api.h 1.25 2012/04/04 12:46:20Z geraintf Rel $
// $Locker: $
//****************************************************************************
...
typedef struct  // GN_GPS_Config
{
   ...
   BL QZSS_Enabled;              ///<< \brief Enable tracking and use of QZSS (Quasi-Zenith Satellite System) satellites (PRNs 193..197) and data.
                                 ///          NB. This will be ignored if the GNSS chip is CG2900.

   BL SBAS_Enabled;              ///< Enable tracking and use of SBAS (Satellite Based Augmentation System) satellites (PRNs 120..138) and data.

   BL Static_Filt_Enabled;       ///< Enable Navigation Output Positron 'Static' Filter.

   U1 Reserved_0;                ///< Padding / Reserved for Future Use.
   ...
   U1 Reserved_1;                ///< Padding / Reserved for Future Use.
   U2 Reserved_2;                ///< Padding / Reserved for Future Use.
