...
//****************************************************************************
// GNSS IP Centre, ST-Ericsson (UK) Ltd.
...
//
// $Header: S:/GN_49xxPE_MKS/49xxPE_API/rcs/GN_EE_api.h 1.6 2012/03/02 15:39:42Z geraintf Rel $
// $Locker: $
//****************************************************************************
...
//*****************************************************************************
/// \brief
///     GN Extended Ephemeris GPS (or QZSS) satellite Ephemeris Elements.
/// \details
///     GN Extended Ephemeris GPS (or QZSS) satellite Ephemeris Elements scaled
///     as they are in the broadcast GPS (or QZSS) Navigation Message.
/// \note
...
}  s_GN_EE_GPS_Eph_El;        // Extended Ephemeris - GPS (or QZSS) Ephemeris Elements
...
/// \attention
///     The current Glonass Time is provided as an aid to help decide which
///     Extended Ephemeris should be provided.  This must be one with an
///     ephemeris reference time Tb on the nearest legal 15 minute boundary,
///     ie corresponding to either 15 minutes past, or 15 minutes to, the Glonass
///     UTC hour.  Glonass ephemerides have a +/- 15 minutes validity either side
///     of Tb.
/// \attention
///     This extended ephemeris data will stop being used if a valid broadcast
