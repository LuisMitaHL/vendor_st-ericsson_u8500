 ...
 *	   STA mode: bits 0..3 UAPSD enabled for BE,BK,VI,VO
 */
 ...
 *
 * @dev: network device
 * @bssid: the BSSID of the AP, STA address in case of AP_MODE
...
void cfg80211_disconnected(struct net_device *dev, u16 reason,
			   u8 *bssid, u8 *ie, size_t ie_len, gfp_t gfp);

/**
 * cfg80211_tx_stat_error - notify cfg80211
 *
 * @dev: network device
 * @gfp: allocation flags
 */
