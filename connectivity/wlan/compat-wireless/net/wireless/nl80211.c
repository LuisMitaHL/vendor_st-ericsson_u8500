...
static const struct nla_policy nl80211_policy[NL80211_ATTR_MAX+1] = {
	...
	[NL80211_ATTR_KEY_SEQ] = { .type = NLA_BINARY,
				       .len = WLAN_MAX_SEQ_LEN },
...
static const struct nla_policy nl80211_key_policy[NL80211_KEY_MAX + 1] = {
	...
	[NL80211_KEY_SEQ] = { .type = NLA_BINARY, .len = WLAN_MAX_SEQ_LEN },
...
static int nl80211_connect(struct sk_buff *skb, struct genl_info *info)
{
	...
	if (info->attrs[NL80211_ATTR_UAPSD]) {
		connect.uapsd =
			nla_get_u32(info->attrs[NL80211_ATTR_UAPSD]);
	}
				       ...
				       u32 threshold)
{
	...
	printk(KERN_INFO "nl80211_set_cqm_beacon_miss: %d\n", threshold);
				   ...
				   u32 threshold)
{
	...
	printk(KERN_INFO "nl80211_set_cqm_tx_fail: %d\n", threshold);
...
void nl80211_send_tx_stat_error(struct cfg80211_registered_device *rdev,
                                    struct net_device *netdev, gfp_t gfp)
{
	...
	hdr = nl80211hdr_put(msg, 0, 0, 0, NL80211_CMD_TX_STAT_ERR);
	if (!hdr) {
		nlmsg_free(msg);
		return;
	}
