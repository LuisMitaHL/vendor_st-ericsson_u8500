...
typedef enum UMI_EVENTS_E {
	...
	UMI_EVT_CC_STATE_SWITCHING,
	UMI_EVT_CC_STATE_COMPLETED,
	UMI_EVT_CC_STATE_ABORTED,
...
typedef enum UMI_DEVICE_OID_E {
	...
	UMI_DEVICE_OID_802_11_SET_ARP_KEEP_ALIVE_PERIOD = 0x0096
} UMI_DEVICE_OID;
...
typedef struct UMI_OID_802_11_CHANGE_CHANNEL_REQ_S {
	uint8 Channel;
	uint8 Band;
	uint16 DurationInKus;
} UMI_OID_802_11_CHANGE_CHANNEL_REQ;
...
typedef struct UMI_OID_802_11_ARP_KEEP_ALIVE_PERIOD_S {
...
} UMI_OID_802_11_ARP_KEEP_ALIVE_PERIOD;
