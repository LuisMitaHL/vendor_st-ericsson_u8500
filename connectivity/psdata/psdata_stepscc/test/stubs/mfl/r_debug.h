 ...
 *
 * \brief   Various macros meant to be used for debugging purposes
 *
 */
...
//#pragma message("COMPILING FOR WIN32")
  ...
  #define _ASSERT(exp) (void)( (exp) || (_TraceAssert(#exp, __FILE__, __LINE__), 0) )
    ...
    extern
      ...
      "C"
    #endif
    void AssertDump(const char* FileName, unsigned int Line);
    ...
    extern
      ...
      "C"
    #endif
    void AssertPrint(const char* FileName, unsigned int Line);
...
******************************************************************************/
  ...
  extern "C"
#endif
void BSYS_HexDump(const void* Data_p, int Length, boolean DumpWithOffset); 
