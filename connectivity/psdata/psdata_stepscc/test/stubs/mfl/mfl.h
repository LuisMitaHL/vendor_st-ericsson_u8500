 ...
 *         Supplies functionality to communicate with ST-Ericsson Modem
 * 
 */
 ...
 *
 */
modem_session_t* mfl_session_begin(void);
 ...
 *
 */
void* mfl_session_get_signal_with_timeout(modem_session_t* const modem_session_ptr, int	timeout_in_milliseconds);
 ...
 *
 */
void mfl_set_client_tag(RequestControlBlock_t* request_control_block_ptr,
