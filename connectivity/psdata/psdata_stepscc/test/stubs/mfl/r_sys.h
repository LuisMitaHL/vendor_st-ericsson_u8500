 ...
 *
 * \brief   Header file containing the prototypes for sys category
 *
 */
...
ClientTagStatus_t
Do_ClientTag_Get(const void* const SigStruct_p, 
...
ClientTagStatus_t
Do_ClientTag_Copy(void* const DestSignal_p,
 ...
 */
void 
Do_RequestControlBlock_Init(RequestControlBlock_t* const ReqCtrlBlk_p);  
 ...
 */
void
Do_SwBP_SignalInfo_Init(SwBP_SignalInfo_t* const SignalInfo_p,
 ...
 */
ClientTag_t
Do_SwBP_SignalInfo_GetClientTag(const SwBP_SignalInfo_t* const SignalInfo_p);
 ...
 */
PROCESS
Do_SwBP_SignalInfo_GetProcessId(const SwBP_SignalInfo_t* const SignalInfo_p);
 ...
 */
void 
Do_SwBP_Signal_Handle(const union SIGNAL** const Signal_pp);
