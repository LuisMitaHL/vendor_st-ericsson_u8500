 ...
 *
 * \brief   Redefining SwBP mechanisms for Linux environment
 * 
 */
 ...
 *
 */
void* mfl_signal_alloc(const size_t size, const SIGSELECT primitive);
 ...
 *
 */
void mfl_signal_send(void** signal_ptr_ptr, PROCESS process_id);
 ...
 *
 */
PROCESS mfl_signal_get_p_id(void** signal_ptr_ptr);
 ...
 *
 */
SR_Result_t mfl_resolve_process_id(const char* const name_ptr, PROCESS* process_id_ptr);
 ...
 *
 */
ClientTagStatus_t mfl_internal_client_tag_set(void* const sig_struct_ptr,
