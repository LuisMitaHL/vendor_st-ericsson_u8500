...
typedef enum {
    ...
    AUDIO_PARAM_VIB2_PATH_PWR,
    AUDIO_PARAM_VIB2_CTRL_INT,
    AUDIO_PARAM_ADC1_PWR,
    AUDIO_PARAM_ADC2_PWR,
    AUDIO_PARAM_ADC3_PWR,
    AUDIO_PARAM_DIG_MIC1_OUT1,
    AUDIO_PARAM_DIG_MIC2_OUT2,
    AUDIO_PARAM_DIG_MIC3_OUT3,
    AUDIO_PARAM_DIG_MIC5_OUT5,
    AUDIO_PARAM_DIG_MIC6_OUT6,
...
typedef enum dth_headset_analog_gains {
    ...
    DTH_HS_ANALOG_GAIN_MINUS_28_DB = 0xE,
    DTH_HS_ANALOG_GAIN_MINUS_32_DB = 0xF
} HS_ANALOG_GAINS_T ;
...
int DthAudio_02ParamSet(struct dth_element *elem, void *value)
{
    ...
    SYSLOG(LOG_DEBUG, "Set param %u", elem->user_data);
    ...
    SYSLOG(LOG_DEBUG, "Returned %d", LAST_ERR);
...
int DthAudio_mapParam(uint32_t vp_param, uint32_t* pp_value, int vp_isSet)
{
    ...
    AUDIO_PARAM(AUDIO_PARAM_VIB1,              ANALOG_OUTPUT_ENABLE_REG, VIBRATOR_1_CLASS_D_POWER_MASK,              enum vibrator1_power,               pp_value, vp_isSet)
    AUDIO_PARAM(AUDIO_PARAM_VIB2,              ANALOG_OUTPUT_ENABLE_REG, VIBRATOR_2_CLASS_D_POWER_MASK,              enum vibrator2_power,               pp_value, vp_isSet)

   /* Output configuration */
    AUDIO_PARAM(AUDIO_PARAM_CLASSD1_CONF,       CONFIGURATION_CLASS_D_DRIVERS_REG, VIB_1_CONTROLLED_INTERNAL_MASK,        enum vib1,                          pp_value, vp_isSet)
    ...
    AUDIO_PARAM(AUDIO_PARAM_CLASSD2_CONF,       CONFIGURATION_CLASS_D_DRIVERS_REG, VIB_2_CONTROLLED_INTERNAL_MASK,        enum vib2,                          pp_value, vp_isSet)
    AUDIO_PARAM(AUDIO_PARAM_VIB2N_PWM,         CONFIGURATION_NEGATIVE_OUTPUT_VIB_2_REG, VIB_2_NEGATIVE_DUTY_CYLE_MASK,   enum duty_cycle,                    pp_value, vp_isSet)
    AUDIO_PARAM(AUDIO_PARAM_VIB2P_PWM,         CONFIGURATION_POSITIVE_OUTPUT_VIB_2_REG, VIB_2_POSITIVE_DUTY_CYLE_MASK,   enum duty_cycle,                    pp_value, vp_isSet)
    ...
    AUDIO_PARAM(AUDIO_PARAM_VIB1_PATH_PWR,     DIGITAL_OUTPUT_ENABLE_REG, VIBRATOR_1_CLASS_D_PATH_POWER_MASK,        enum vibrator1_class_d_path_power,  pp_value, vp_isSet)
    ...
    AUDIO_PARAM(AUDIO_PARAM_VIB2_PATH_PWR,     DIGITAL_OUTPUT_ENABLE_REG, VIBRATOR_2_CLASS_D_PATH_POWER_MASK,        enum vibrator2_class_d_path_power,  pp_value, vp_isSet)
    AUDIO_PARAM(AUDIO_PARAM_VIB2_CTRL_INT,     CONFIGURATION_CLASS_D_DRIVERS_REG, VIB_2_CONTROLLED_INTERNAL_MASK,      enum vib2,                          pp_value, vp_isSet)
...
int DthAudio_setParam(uint32_t param, uint32_t value)
{
    ...
    if (TAT_LAST_OK()) {
        ...
        case AUDIO_PARAM_VIB2:

            if (VIBRATOR_2_CLASS_D_PATH_POWER_UP_E == value) {
                TAT_TRY(DthAudio_setParam(AUDIO_PARAM_VIB2_PATH_PWR, VIBRATOR_2_CLASS_D_PATH_POWER_UP_E));
            } else {
                TAT_TRY(DthAudio_setParam(AUDIO_PARAM_VIB2_PATH_PWR, VIBRATOR_2_CLASS_D_PATH_POWER_DOWN_E));
            }
            break;

        case AUDIO_PARAM_CLASSD1_CONF:

            TAT_TRY(DthAudio_setParam(AUDIO_PARAM_VIB1_CTRL_INT, value));
            break;

        case AUDIO_PARAM_CLASSD2_CONF:

            TAT_TRY(DthAudio_setParam(AUDIO_PARAM_VIB2_CTRL_INT, value));
            break;
...
int DthAudio_GpioConfig(int AddressDir, int AddressVal, int AddressPud, int Mask, uint8_t Direction, uint8_t Value, uint8_t Pud)
{
    ...
    SYSLOG(LOG_INFO, "Gpio configured ( @=%x, %x, %x): Nothing to do.", AddressDir,  AddressVal,  AddressPud);
