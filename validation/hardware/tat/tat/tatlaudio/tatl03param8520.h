...
typedef enum {
    ...
    AUDIO_PARAM_EAR_ANALOG_GAIN,
    AUDIO_PARAM_HFL_ANALOG_GAIN,
    AUDIO_PARAM_HFR_ANALOG_GAIN,
    AUDIO_PARAM_VIB_ANALOG_GAIN,
    ...
    AUDIO_BLOCK_USB,
    AUDIO_PARAM_USB_INTERFACE,
    AUDIO_PARAM_USB_MIC,
    AUDIO_PARAM_USB_GAIN_L,
    AUDIO_PARAM_USB_GAIN_R,
...
#define END_AUDIO_PARAM_MAP(param)                                             \
    default:                                                                   \
        SYSLOG(LOG_ERR, "unregistered audio parameter: " #param);              \
...
/* Register GPIO , VIDEOCTRL GPIO is GPIO 10 */
...
/* Register GPIO , MICCTRL GPIO is GPIO 34 */
#define TATAUDIO_GPIO_MICCTRL_DIR 0x1014
#define TATAUDIO_GPIO_MICCTRL_OUT 0x1024
#define TATAUDIO_GPIO_MICCTRL_PUD 0x1034

/* Masks and offsets of inside register */
#define TATAUDIO_GPIO_VIDEOCTRL_OFFSET_IN_REGISTER 0x02 /* bit 2*/
#define TATAUDIO_GPIO_MICCTRL_OFFSET_IN_REGISTER 0x02  /* bit 2*/
