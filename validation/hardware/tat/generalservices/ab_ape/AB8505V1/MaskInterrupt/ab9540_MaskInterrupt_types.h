...
//   
//  
#define MAIN_CHARGER_PLUG_MASK_MASK 0x8U
...
typedef enum main_charger_plug_mask_set {
    MAIN_CHARGER_PLUG_MASK_NO_ACTION_E,
    MAIN_CHARGER_PLUG_MASK_ENABLE_E
} MAIN_CHARGER_PLUG_MASK_SET_T ;
#define MAIN_CHARGER_PLUG_MASK_PARAM_MASK  0x8
...
//   
//  
#define MAIN_CHARGER_UN_PLUG_MASK_MASK 0x4U
...
typedef enum main_charger_un_plug_mask_set {
    MAIN_CHARGER_UN_PLUG_MASK_NO_ACTION_E,
    MAIN_CHARGER_UN_PLUG_MASK_ENABLE_E
} MAIN_CHARGER_UN_PLUG_MASK_SET_T ;
#define MAIN_CHARGER_UN_PLUG_MASK_PARAM_MASK  0x4
