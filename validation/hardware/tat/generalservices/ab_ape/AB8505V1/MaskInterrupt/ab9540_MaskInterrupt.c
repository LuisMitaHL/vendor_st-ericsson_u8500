 ...
 * RET  : Return the value of register 0xMaskedInterrupt2
 *
 * Notes : From register 0xE41, bits 3:3
 *
 **************************************************************************/
unsigned char set_main_charger_plug_mask( enum main_charger_plug_mask_set param )
  {
     ...
     */ 
    switch( param ){
        case MAIN_CHARGER_PLUG_MASK_ENABLE_E: 
           value = old_value | MAIN_CHARGER_PLUG_MASK_MASK; 
           break;
        case MAIN_CHARGER_PLUG_MASK_NO_ACTION_E: 
           value = old_value & ~ MAIN_CHARGER_PLUG_MASK_MASK;
           break;
    }
...
unsigned char get_main_charger_plug_mask()
  {
     ...
     * Main charger plug masked 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_2_REG) & MAIN_CHARGER_PLUG_MASK_MASK) >> 3;
    return value;
  }
 ...
 * RET  : Return the value of register 0xMaskedInterrupt2
 *
 * Notes : From register 0xE41, bits 2:2
 *
 **************************************************************************/
unsigned char set_main_charger_un_plug_mask( enum main_charger_un_plug_mask_set param )
  {
     ...
     */ 
    switch( param ){
        case MAIN_CHARGER_UN_PLUG_MASK_ENABLE_E: 
           value = old_value | MAIN_CHARGER_UN_PLUG_MASK_MASK; 
           break;
        case MAIN_CHARGER_UN_PLUG_MASK_NO_ACTION_E: 
           value = old_value & ~ MAIN_CHARGER_UN_PLUG_MASK_MASK;
           break;
    }
...
unsigned char get_main_charger_un_plug_mask()
  {
     ...
     * Main charger unplug masked 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_2_REG) & MAIN_CHARGER_UN_PLUG_MASK_MASK) >> 2;
    return value;
  }
