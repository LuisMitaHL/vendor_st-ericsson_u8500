/****************************************************************************
 * File : c:/Lisp/Production/ab8500/ab8500_Charger/Linux/ab8500_Charger_types.h
 * 
 *
...
#ifndef C__LISP_PRODUCTION_AB8500_AB8500_CHARGER_LINUX_AB8500_CHARGER_TYPES_H
#define C__LISP_PRODUCTION_AB8500_AB8500_CHARGER_LINUX_AB8500_CHARGER_TYPES_H
...
typedef enum volt_level {
    CHARGER_VOLT_LEVEL_3_POINT_50_V = 0x0,
    CHARGER_VOLT_LEVEL_3_POINT_53_V = 0x1,
    CHARGER_VOLT_LEVEL_3_POINT_55_V = 0x2,
    CHARGER_VOLT_LEVEL_3_POINT_58_V = 0x3,
    CHARGER_VOLT_LEVEL_3_POINT_60_V = 0x4,
    CHARGER_VOLT_LEVEL_3_POINT_63_V = 0x5,
    CHARGER_VOLT_LEVEL_3_POINT_65_V = 0x6,
    CHARGER_VOLT_LEVEL_3_POINT_68_V = 0x7,
    CHARGER_VOLT_LEVEL_3_POINT_70_V = 0x8,
    CHARGER_VOLT_LEVEL_3_POINT_73_V = 0x9,
    CHARGER_VOLT_LEVEL_3_POINT_75_V = 0xA,
    CHARGER_VOLT_LEVEL_3_POINT_78_V = 0xB,
    CHARGER_VOLT_LEVEL_3_POINT_80_V = 0xC,
    CHARGER_VOLT_LEVEL_3_POINT_83_V = 0xD,
    CHARGER_VOLT_LEVEL_3_POINT_85_V = 0xE,
    CHARGER_VOLT_LEVEL_3_POINT_88_V = 0xF,
    CHARGER_VOLT_LEVEL_3_POINT_90_V = 0x10,
    CHARGER_VOLT_LEVEL_3_POINT_93_V = 0x11,
    CHARGER_VOLT_LEVEL_3_POINT_95_V = 0x12,
    CHARGER_VOLT_LEVEL_3_POINT_98_V = 0x13,
    CHARGER_VOLT_LEVEL_4_POINT_0_V = 0x14,
    CHARGER_VOLT_LEVEL_4_POINT_3_V = 0x15,
    CHARGER_VOLT_LEVEL_4_POINT_5_V = 0x16,
    CHARGER_VOLT_LEVEL_4_POINT_6_V = 0x17,
    CHARGER_VOLT_LEVEL_4_POINT_7_V = 0x18,
    CHARGER_VOLT_LEVEL_4_POINT_8_V = 0x19,
    CHARGER_VOLT_LEVEL_4_POINT_9_V = 0x1A,
    CHARGER_VOLT_LEVEL_4_POINT_10_V = 0x1B,
    CHARGER_VOLT_LEVEL_4_POINT_11_V = 0x1C,
    CHARGER_VOLT_LEVEL_4_POINT_12_V = 0x1D,
    CHARGER_VOLT_LEVEL_4_POINT_13_V = 0x1E,
    CHARGER_VOLT_LEVEL_4_POINT_14_V = 0x1F,
    CHARGER_VOLT_LEVEL_4_POINT_15_V = 0x20,
    CHARGER_VOLT_LEVEL_4_POINT_16_V = 0x21,
    CHARGER_VOLT_LEVEL_4_POINT_17_V = 0x22,
    CHARGER_VOLT_LEVEL_4_POINT_18_V = 0x23,
    CHARGER_VOLT_LEVEL_4_POINT_19_V = 0x24,
    CHARGER_VOLT_LEVEL_4_POINT_20_V = 0x25,
    CHARGER_VOLT_LEVEL_4_POINT_21_V = 0x26,
    CHARGER_VOLT_LEVEL_4_POINT_22_V = 0x27,
    CHARGER_VOLT_LEVEL_4_POINT_23_V = 0x28,
    CHARGER_VOLT_LEVEL_4_POINT_24_V = 0x29,
    CHARGER_VOLT_LEVEL_4_POINT_25_V = 0x2A,
    CHARGER_VOLT_LEVEL_4_POINT_26_V = 0x2B,
    CHARGER_VOLT_LEVEL_4_POINT_27_V = 0x2C,
    CHARGER_VOLT_LEVEL_4_POINT_28_V = 0x2D,
    CHARGER_VOLT_LEVEL_4_POINT_29_V = 0x2E,
    CHARGER_VOLT_LEVEL_4_POINT_30_V = 0x2F,
    CHARGER_VOLT_LEVEL_4_POINT_31_V = 0x30,
    CHARGER_VOLT_LEVEL_4_POINT_32_V = 0x31,
    CHARGER_VOLT_LEVEL_4_POINT_33_V = 0x32,
    CHARGER_VOLT_LEVEL_4_POINT_34_V = 0x33,
    CHARGER_VOLT_LEVEL_4_POINT_35_V = 0x34,
    CHARGER_VOLT_LEVEL_4_POINT_36_V = 0x35,
    CHARGER_VOLT_LEVEL_4_POINT_37_V = 0x36,
    CHARGER_VOLT_LEVEL_4_POINT_38_V = 0x37,
    CHARGER_VOLT_LEVEL_4_POINT_39_V = 0x38,
    CHARGER_VOLT_LEVEL_4_POINT_40_V = 0x39,
    CHARGER_VOLT_LEVEL_4_POINT_41_V = 0x3A,
    CHARGER_VOLT_LEVEL_4_POINT_42_V = 0x3B,
    CHARGER_VOLT_LEVEL_4_POINT_43_V = 0x3C,
    CHARGER_VOLT_LEVEL_4_POINT_44_V = 0x3D,
    CHARGER_VOLT_LEVEL_4_POINT_45_V = 0x3E,
    CHARGER_VOLT_LEVEL_4_POINT_46_V = 0x3F,
    CHARGER_VOLT_LEVEL_4_POINT_47_V = 0x40,
    CHARGER_VOLT_LEVEL_4_POINT_48_V = 0x41,
    CHARGER_VOLT_LEVEL_4_POINT_49_V = 0x42,
    CHARGER_VOLT_LEVEL_4_POINT_50_V = 0x43,
    CHARGER_VOLT_LEVEL_4_POINT_51_V = 0x44,
    CHARGER_VOLT_LEVEL_4_POINT_52_V = 0x45,
    CHARGER_VOLT_LEVEL_4_POINT_53_V = 0x46,
    CHARGER_VOLT_LEVEL_4_POINT_54_V = 0x47,
    CHARGER_VOLT_LEVEL_4_POINT_55_V = 0x48,
    CHARGER_VOLT_LEVEL_4_POINT_56_V = 0x49,
    CHARGER_VOLT_LEVEL_4_POINT_57_V = 0x4A,
    CHARGER_VOLT_LEVEL_4_POINT_58_V = 0x4B,
    CHARGER_VOLT_LEVEL_4_POINT_59_V = 0x4C,
    CHARGER_VOLT_LEVEL_4_POINT_60_V = 0x4D
} VOLT_LEVEL_T ;
...
//  done)..
//  Register ChargerWatchDogTimer 0x0B51, Bits 0:0, typedef kick_watchdog_timer_enable
//   
//  
...
//  Register MainChargerControl 0x0B81, Bits 2:2, typedef max_current
//   
//  
...
//  Register MainChargerControl 0x0B81, Bits 0:1, typedef thermal_threshold
//   
//  
...
typedef enum vbus_voltage_stop {
    ...
    STOP_OVER_5_POINT_100_VOLT = 0x4,
