/****************************************************************************
 * File : c:/Lisp/Production/ab8500/ab8500_Regu2/Linux/ab8500_Regu2_types.h
 * 
 *
...
#ifndef C__LISP_PRODUCTION_AB8500_AB8500_REGU2_LINUX_AB8500_REGU2_TYPES_H
#define C__LISP_PRODUCTION_AB8500_AB8500_REGU2_LINUX_AB8500_REGU2_TYPES_H
...
//  Register ArmVoltageManagement 0x0401, Bits 6:6, typedef force_no_step
//   
//  
...
//  Register ArmVoltageManagement 0x0401, Bits 5:5, typedef vbbp_pulldonw_enable
//   
//  
...
//  Register ArmVoltageManagement 0x0401, Bits 4:4, typedef switch_enable
//   
//  
#define SWITCH_VARM_AND_VBBP_MASK 0x10
#define SWITCH_VARM_AND_VBBP_OFFSET 4
#define SWITCH_VARM_AND_VBBP_STOP_BIT 4
#define SWITCH_VARM_AND_VBBP_START_BIT 4
#define SWITCH_VARM_AND_VBBP_WIDTH 1


typedef enum switch_enable {
    SWITCH_DISABLE_E,
    SWITCH_ENABLE_E
} SWITCH_ENABLE_T ;

#define SWITCH_ENABLE_PARAM_MASK  0x10
...
//  11: force enable in LP mode.
//  Register ArmVoltageManagement 0x0401, Bits 2:3, typedef regulation
//   
//  
...
//  11: force enable in LP mode.
//  Register ArmVoltageManagement 0x0401, Bits 0:1, typedef regulation
//   
//  
...
//  11: force enable in LP mode.
//  Register VextSuppply3VoltageManagement 0x0408, Bits 4:5, typedef regulation
//   
//  
...
#define VEXT_SUPPPLY_3_VOLTAGE_MANAGEMENT_REG 0x408
...
//  11: force enable in LP mode.
//  Register VextSuppply2VoltageManagement 0x0408, Bits 2:3, typedef regulation
//   
//  
...
#define VEXT_SUPPPLY_2_VOLTAGE_MANAGEMENT_REG 0x408
...
typedef enum output_supply {
    OUTPUT_VOLTAGE_0_POINT_70_V = 0x0,
    OUTPUT_VOLTAGE_0_POINT_71_V = 0x1,
    OUTPUT_VOLTAGE_0_POINT_72_V = 0x2,
    OUTPUT_VOLTAGE_0_POINT_74_V = 0x3,
    OUTPUT_VOLTAGE_0_POINT_75_V = 0x4,
    OUTPUT_VOLTAGE_0_POINT_76_V = 0x5,
    OUTPUT_VOLTAGE_0_POINT_77_V = 0x6,
    OUTPUT_VOLTAGE_0_POINT_79_V = 0x7,
    OUTPUT_VOLTAGE_0_POINT_80_V = 0x8,
    OUTPUT_VOLTAGE_0_POINT_81_V = 0x9,
    OUTPUT_VOLTAGE_0_POINT_82_V = 0xA,
    OUTPUT_VOLTAGE_0_POINT_84_V = 0xB,
    OUTPUT_VOLTAGE_0_POINT_85_V = 0xC,
    OUTPUT_VOLTAGE_0_POINT_86_V = 0xD,
    OUTPUT_VOLTAGE_0_POINT_87_V = 0xE,
    OUTPUT_VOLTAGE_0_POINT_89_V = 0xF,
    OUTPUT_VOLTAGE_0_POINT_90_V = 0x10,
    OUTPUT_VOLTAGE_0_POINT_91_V = 0x11,
    OUTPUT_VOLTAGE_0_POINT_92_V = 0x12,
    OUTPUT_VOLTAGE_0_POINT_94_V = 0x13,
    OUTPUT_VOLTAGE_0_POINT_95_V = 0x14,
    OUTPUT_VOLTAGE_0_POINT_96_V = 0x15,
    OUTPUT_VOLTAGE_0_POINT_97_V = 0x16,
    OUTPUT_VOLTAGE_0_POINT_99_V = 0x17,
    OUTPUT_VOLTAGE_0_POINT_100_V = 0x18,
    OUTPUT_VOLTAGE_1_POINT_1_V = 0x19,
    OUTPUT_VOLTAGE_1_POINT_2_V = 0x1A,
    OUTPUT_VOLTAGE_1_POINT_4_V = 0x1B,
    OUTPUT_VOLTAGE_1_POINT_5_V = 0x1C,
    OUTPUT_VOLTAGE_1_POINT_6_V = 0x1D,
    OUTPUT_VOLTAGE_1_POINT_7_V = 0x1E,
    OUTPUT_VOLTAGE_1_POINT_9_V = 0x1F,
    OUTPUT_VOLTAGE_1_POINT_10_V = 0x20,
    OUTPUT_VOLTAGE_1_POINT_11_V = 0x21,
    OUTPUT_VOLTAGE_1_POINT_13_V = 0x22,
    OUTPUT_VOLTAGE_1_POINT_14_V = 0x23,
    OUTPUT_VOLTAGE_1_POINT_15_V = 0x24,
    OUTPUT_VOLTAGE_1_POINT_16_V = 0x25,
    OUTPUT_VOLTAGE_1_POINT_18_V = 0x26,
    OUTPUT_VOLTAGE_1_POINT_19_V = 0x27,
    OUTPUT_VOLTAGE_1_POINT_20_V = 0x28,
    OUTPUT_VOLTAGE_1_POINT_21_V = 0x29,
    OUTPUT_VOLTAGE_1_POINT_23_V = 0x2A,
    OUTPUT_VOLTAGE_1_POINT_24_V = 0x2B,
    OUTPUT_VOLTAGE_1_POINT_25_V = 0x2C,
    OUTPUT_VOLTAGE_1_POINT_26_V = 0x2D,
    OUTPUT_VOLTAGE_1_POINT_28_V = 0x2E,
    OUTPUT_VOLTAGE_1_POINT_29_V = 0x2F,
    OUTPUT_VOLTAGE_1_POINT_30_V = 0x30,
    OUTPUT_VOLTAGE_1_POINT_31_V = 0x31,
    OUTPUT_VOLTAGE_1_POINT_33_V = 0x32,
    OUTPUT_VOLTAGE_1_POINT_34_V = 0x33,
    OUTPUT_VOLTAGE_1_POINT_35_V = 0x34,
    OUTPUT_VOLTAGE_1_POINT_36_V = 0x35,
    OUTPUT_VOLTAGE_1_POINT_80_V = 0x39,
    OUTPUT_VOLTAGE_1_POINT_81_V = 0x3A,
    OUTPUT_VOLTAGE_1_POINT_83_V = 0x3B,
    OUTPUT_VOLTAGE_1_POINT_84_V = 0x3C,
    OUTPUT_VOLTAGE_1_POINT_85_V = 0x3D,
    OUTPUT_VOLTAGE_1_POINT_86_V = 0x3E,
    OUTPUT_VOLTAGE_1_POINT_88_V = 0x3F
} OUTPUT_SUPPLY_T ;
...
#define  VBBPFB_04V 4
#define  VBBPFB_05V 5
#define  VBBPFB_MINUS_05V 8
#define  VBBPFB_MINUS_04V 12
...
//  
//  Defined Vsmps1Sel1 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps1Sel1Output 0x0413, Bits 0:5, typedef output_supply
//   
//  
...
//  
//  Defined Vsmps1Sel2 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps1Sel2Output 0x0414, Bits 0:5, typedef output_supply
//   
//  
...
//  
//  Defined Vsmps1Sel3 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps1Sel3Output 0x0415, Bits 0:5, typedef output_supply
//   
//  
...
//  
//  Defined Vsmps2Sel1 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps2Sel1Output 0x0417, Bits 0:5, typedef output_supply
//   
//  
...
//  
//  Defined Vsmps2Sel2 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps2Sel2Output 0x0418, Bits 0:5, typedef output_supply
//   
//  
...
//  
//  Defined Vsmps2Sel3 output voltage from 0.7V to 1.3625V by 12.5mV step and from 1.8 to 
//  1.875 by 12.5 mV step.
//  Register Vsmps2Sel3Output 0x0419, Bits 0:5, typedef output_supply
//   
//  
...
typedef enum output_supply2 {
    OUTPUT_VOLTAGE2_0_POINT_70_V = 0x0,
    OUTPUT_VOLTAGE2_0_POINT_71_V = 0x1,
    OUTPUT_VOLTAGE2_0_POINT_72_V = 0x2,
    OUTPUT_VOLTAGE2_0_POINT_74_V = 0x3,
    OUTPUT_VOLTAGE2_0_POINT_75_V = 0x4,
    OUTPUT_VOLTAGE2_0_POINT_76_V = 0x5,
    OUTPUT_VOLTAGE2_0_POINT_77_V = 0x6,
    OUTPUT_VOLTAGE2_0_POINT_79_V = 0x7,
    OUTPUT_VOLTAGE2_0_POINT_80_V = 0x8,
    OUTPUT_VOLTAGE2_0_POINT_81_V = 0x9,
    OUTPUT_VOLTAGE2_0_POINT_82_V = 0xA,
    OUTPUT_VOLTAGE2_0_POINT_84_V = 0xB,
    OUTPUT_VOLTAGE2_0_POINT_85_V = 0xC,
    OUTPUT_VOLTAGE2_0_POINT_86_V = 0xD,
    OUTPUT_VOLTAGE2_0_POINT_87_V = 0xE,
    OUTPUT_VOLTAGE2_0_POINT_89_V = 0xF,
    OUTPUT_VOLTAGE2_0_POINT_90_V = 0x10,
    OUTPUT_VOLTAGE2_0_POINT_91_V = 0x11,
    OUTPUT_VOLTAGE2_0_POINT_92_V = 0x12,
    OUTPUT_VOLTAGE2_0_POINT_94_V = 0x13,
    OUTPUT_VOLTAGE2_0_POINT_95_V = 0x14,
    OUTPUT_VOLTAGE2_0_POINT_96_V = 0x15,
    OUTPUT_VOLTAGE2_0_POINT_97_V = 0x16,
    OUTPUT_VOLTAGE2_0_POINT_99_V = 0x17,
    OUTPUT_VOLTAGE2_0_POINT_100_V = 0x18,
    OUTPUT_VOLTAGE2_1_POINT_1_V = 0x19,
    OUTPUT_VOLTAGE2_1_POINT_2_V = 0x1A,
    OUTPUT_VOLTAGE2_1_POINT_4_V = 0x1B,
    OUTPUT_VOLTAGE2_1_POINT_5_V = 0x1C,
    OUTPUT_VOLTAGE2_1_POINT_6_V = 0x1D,
    OUTPUT_VOLTAGE2_1_POINT_7_V = 0x1E,
    OUTPUT_VOLTAGE2_1_POINT_9_V = 0x1F,
    OUTPUT_VOLTAGE2_1_POINT_10_V = 0x20,
    OUTPUT_VOLTAGE2_1_POINT_11_V = 0x21,
    OUTPUT_VOLTAGE2_1_POINT_13_V = 0x22,
    OUTPUT_VOLTAGE2_1_POINT_14_V = 0x23,
    OUTPUT_VOLTAGE2_1_POINT_15_V = 0x24,
    OUTPUT_VOLTAGE2_1_POINT_16_V = 0x25,
    OUTPUT_VOLTAGE2_1_POINT_18_V = 0x26,
    OUTPUT_VOLTAGE2_1_POINT_19_V = 0x27,
    OUTPUT_VOLTAGE2_1_POINT_20_V = 0x28,
    OUTPUT_VOLTAGE2_1_POINT_21_V = 0x29,
    OUTPUT_VOLTAGE2_1_POINT_23_V = 0x2A,
    OUTPUT_VOLTAGE2_1_POINT_24_V = 0x2B,
    OUTPUT_VOLTAGE2_1_POINT_25_V = 0x2C,
    OUTPUT_VOLTAGE2_1_POINT_26_V = 0x2D,
    OUTPUT_VOLTAGE2_1_POINT_28_V = 0x2E,
    OUTPUT_VOLTAGE2_1_POINT_29_V = 0x2F,
    OUTPUT_VOLTAGE2_1_POINT_30_V = 0x30,
    OUTPUT_VOLTAGE2_1_POINT_31_V = 0x31,
    OUTPUT_VOLTAGE2_1_POINT_33_V = 0x32,
    OUTPUT_VOLTAGE2_1_POINT_34_V = 0x33,
    OUTPUT_VOLTAGE2_1_POINT_35_V = 0x34,
    OUTPUT_VOLTAGE2_1_POINT_36_V = 0x35,
    OUTPUT_VOLTAGE2_1_POINT_38_V = 0x36,
    OUTPUT_VOLTAGE2_1_POINT_39_V = 0x37,
    OUTPUT_VOLTAGE2_1_POINT_40_V = 0x38,
    OUTPUT_VOLTAGE2_1_POINT_41_V = 0x39,
    OUTPUT_VOLTAGE2_1_POINT_43_V = 0x3A,
    OUTPUT_VOLTAGE2_1_POINT_44_V = 0x3B,
    OUTPUT_VOLTAGE2_1_POINT_45_V = 0x3C,
    OUTPUT_VOLTAGE2_1_POINT_46_V = 0x3D,
    OUTPUT_VOLTAGE2_1_POINT_48_V = 0x3E,
    OUTPUT_VOLTAGE2_1_POINT_49_V = 0x3F,
    OUTPUT_VOLTAGE2_1_POINT_50_V = 0x40,
    OUTPUT_VOLTAGE2_1_POINT_51_V = 0x41,
    OUTPUT_VOLTAGE2_1_POINT_53_V = 0x42,
    OUTPUT_VOLTAGE2_1_POINT_54_V = 0x43,
    OUTPUT_VOLTAGE2_1_POINT_55_V = 0x44,
    OUTPUT_VOLTAGE2_1_POINT_56_V = 0x45,
    OUTPUT_VOLTAGE2_1_POINT_58_V = 0x46,
    OUTPUT_VOLTAGE2_1_POINT_59_V = 0x47,
    OUTPUT_VOLTAGE2_1_POINT_60_V = 0x48,
    OUTPUT_VOLTAGE2_1_POINT_61_V = 0x49,
    OUTPUT_VOLTAGE2_1_POINT_63_V = 0x4A,
    OUTPUT_VOLTAGE2_1_POINT_64_V = 0x4B,
    OUTPUT_VOLTAGE2_1_POINT_65_V = 0x4C,
    OUTPUT_VOLTAGE2_1_POINT_66_V = 0x4D,
    OUTPUT_VOLTAGE2_1_POINT_68_V = 0x4E,
    OUTPUT_VOLTAGE2_1_POINT_69_V = 0x4F,
    OUTPUT_VOLTAGE2_1_POINT_70_V = 0x50,
    OUTPUT_VOLTAGE2_1_POINT_71_V = 0x51,
    OUTPUT_VOLTAGE2_1_POINT_73_V = 0x52,
    OUTPUT_VOLTAGE2_1_POINT_74_V = 0x53,
    OUTPUT_VOLTAGE2_1_POINT_75_V = 0x54,
    OUTPUT_VOLTAGE2_1_POINT_76_V = 0x55,
    OUTPUT_VOLTAGE2_1_POINT_78_V = 0x56,
    OUTPUT_VOLTAGE2_1_POINT_79_V = 0x57,
    OUTPUT_VOLTAGE2_1_POINT_80_V = 0x58,
    OUTPUT_VOLTAGE2_1_POINT_81_V = 0x59,
    OUTPUT_VOLTAGE2_1_POINT_83_V = 0x5A,
    OUTPUT_VOLTAGE2_1_POINT_84_V = 0x5B,
    OUTPUT_VOLTAGE2_1_POINT_85_V = 0x5C,
    OUTPUT_VOLTAGE2_1_POINT_86_V = 0x5D,
    OUTPUT_VOLTAGE2_1_POINT_88_V = 0x5E
} OUTPUT_SUPPLY_2_T ;



//  
//  Defined Vsmps3 output voltage from 0.7V to 1.875V by 12.5mV steps.
//  Register Vsmps3Sel1Output 0x041B, Bits 0:6, typedef output_supply2
//   
//  
...
#define OUTPUT_SUPPLY_2_PARAM_MASK  0x7F

//  
//  Defined Vsmps3 output voltage from 0.7V to 1.875V by 12.5mV steps.
//  Register Vsmps3Sel2Output 0x041C, Bits 0:6, typedef output_supply2
//   
//  
...
//  
//  Defined Vsmps3 output voltage from 0.7V to 1.875V by 12.5mV steps.
//  Register Vsmps3Sel3Output 0x041D, Bits 0:6, typedef output_supply2
//   
//  
...
#define  VAUX_1100MV 0
#define  VAUX_1200MV 1
#define  VAUX_1300MV 2
#define  VAUX_1400MV 3
#define  VAUX_1500MV 4
#define  VAUX_1800MV 5
#define  VAUX_1850MV 6
#define  VAUX_1900MV 7
#define  VAUX_2500MV 8
#define  VAUX_2650MV 9
#define  VAUX_2700MV 10
#define  VAUX_2750MV 11
#define  VAUX_2800MV 12
#define  VAUX_2900MV 13
#define  VAUX_3000MV 14
#define  VAUX_3300MV 15
...
//  
//  Vaux2 output supply value management.
//  Register Vaux3Sel1Output 0x0421, Bits 0:3, typedef vaux_output
//   
//  
#define VAUX_3_SEL_OUTPUT_MASK 0xF
#define VAUX_3_SEL_OUTPUT_OFFSET 3
#define VAUX_3_SEL_OUTPUT_STOP_BIT 3
#define VAUX_3_SEL_OUTPUT_START_BIT 0
#define VAUX_3_SEL_OUTPUT_WIDTH 4

#define VAUX_3_SEL_1_OUTPUT_REG 0x421
#define VAUX_3_SEL_OUTPUT_PARAM_MASK  0xF
...
//  
//  0: Modem doesn't valid system clock request from SysClkReq1input 
