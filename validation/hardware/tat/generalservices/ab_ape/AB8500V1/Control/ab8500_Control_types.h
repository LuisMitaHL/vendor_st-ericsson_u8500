...
//  steps..
//  Register SystemContolStatus 0x0102, Bits 0:6, typedef press_time
//   
//  
...
//  Vsmps1Sel(i)[5:0] bits when STW4500 is reset 
...
//  ExtSup13LPnClkSel and ExtSupply13LP bits when STW4500 is reset 
//  1: Allow to valid reset of 'VextSupply3Regu[1:0]', 
//  'VextSupply3RequestCtrl[1:'ExtSup13LPnClkSel' and 'ExtSupply13LP' bits when STW4500 
//  is reset.
...
//  ExtSup12LPnClkSel and ExtSupply12LP bits when STW4500 is reset 
//  1: Allow to valid reset of 'VextSupply2Regu[1:0]', 
//  'VextSupply2RequestCtrl[1:'ExtSup12LPnClkSel' and 'ExtSupply12LP' bits when STW4500 
//  is reset.
...
//  
//  0: Vaux3Regu, Vaux3RequestCtrl and Vaux3Sel bits stay at their programmed value when 
//  STw4500 is resetted 
//  1: Vaux3Regu, Vaux3RequestCtrl and Vaux3Sel bits are reset to their default values 
//  when STw4500 is resetted.
...
//  1: when Watchdog expires STW4500 is turned off and then turned On running start up 
//  sequence..
...
typedef enum main_watchdog_timer {
    WATCH_DOG_TIMER_1_SECOND = 0x0,
    WATCH_DOG_TIMER_2_SECOND = 0x1,
    WATCH_DOG_TIMER_3_SECOND = 0x2,
    WATCH_DOG_TIMER_4_SECOND = 0x3,
    WATCH_DOG_TIMER_5_SECOND = 0x4,
    WATCH_DOG_TIMER_6_SECOND = 0x5,
    WATCH_DOG_TIMER_7_SECOND = 0x6,
    WATCH_DOG_TIMER_8_SECOND = 0x7,
    WATCH_DOG_TIMER_9_SECOND = 0x8,
    WATCH_DOG_TIMER_10_SECOND = 0x9,
    WATCH_DOG_TIMER_11_SECOND = 0xA,
    WATCH_DOG_TIMER_12_SECOND = 0xB,
    WATCH_DOG_TIMER_13_SECOND = 0xC,
    WATCH_DOG_TIMER_14_SECOND = 0xD,
    WATCH_DOG_TIMER_15_SECOND = 0xE,
    WATCH_DOG_TIMER_16_SECOND = 0xF,
    WATCH_DOG_TIMER_17_SECOND = 0x10,
    WATCH_DOG_TIMER_18_SECOND = 0x11,
    WATCH_DOG_TIMER_19_SECOND = 0x12,
    WATCH_DOG_TIMER_20_SECOND = 0x13,
    WATCH_DOG_TIMER_21_SECOND = 0x14,
    WATCH_DOG_TIMER_22_SECOND = 0x15,
    WATCH_DOG_TIMER_23_SECOND = 0x16,
    WATCH_DOG_TIMER_24_SECOND = 0x17,
    WATCH_DOG_TIMER_25_SECOND = 0x18,
    WATCH_DOG_TIMER_26_SECOND = 0x19,
    WATCH_DOG_TIMER_27_SECOND = 0x1A,
    WATCH_DOG_TIMER_28_SECOND = 0x1B,
    WATCH_DOG_TIMER_29_SECOND = 0x1C,
    WATCH_DOG_TIMER_30_SECOND = 0x1D,
    WATCH_DOG_TIMER_31_SECOND = 0x1E,
    WATCH_DOG_TIMER_32_SECOND = 0x1F,
    WATCH_DOG_TIMER_33_SECOND = 0x20,
    WATCH_DOG_TIMER_34_SECOND = 0x21,
    WATCH_DOG_TIMER_35_SECOND = 0x22,
    WATCH_DOG_TIMER_36_SECOND = 0x23,
    WATCH_DOG_TIMER_37_SECOND = 0x24,
    WATCH_DOG_TIMER_38_SECOND = 0x25,
    WATCH_DOG_TIMER_39_SECOND = 0x26,
    WATCH_DOG_TIMER_40_SECOND = 0x27,
    WATCH_DOG_TIMER_41_SECOND = 0x28,
    WATCH_DOG_TIMER_42_SECOND = 0x29,
    WATCH_DOG_TIMER_43_SECOND = 0x2A,
    WATCH_DOG_TIMER_44_SECOND = 0x2B,
    WATCH_DOG_TIMER_45_SECOND = 0x2C,
    WATCH_DOG_TIMER_46_SECOND = 0x2D,
    WATCH_DOG_TIMER_47_SECOND = 0x2E,
    WATCH_DOG_TIMER_48_SECOND = 0x2F,
    WATCH_DOG_TIMER_49_SECOND = 0x30,
    WATCH_DOG_TIMER_50_SECOND = 0x31,
    WATCH_DOG_TIMER_51_SECOND = 0x32,
    WATCH_DOG_TIMER_52_SECOND = 0x33,
    WATCH_DOG_TIMER_53_SECOND = 0x34,
    WATCH_DOG_TIMER_54_SECOND = 0x35,
    WATCH_DOG_TIMER_55_SECOND = 0x36,
    WATCH_DOG_TIMER_56_SECOND = 0x37,
    WATCH_DOG_TIMER_57_SECOND = 0x38,
    WATCH_DOG_TIMER_58_SECOND = 0x39,
    WATCH_DOG_TIMER_59_SECOND = 0x3A,
    WATCH_DOG_TIMER_60_SECOND = 0x3B,
    WATCH_DOG_TIMER_61_SECOND = 0x3C,
    WATCH_DOG_TIMER_62_SECOND = 0x3D,
    WATCH_DOG_TIMER_63_SECOND = 0x3E,
    WATCH_DOG_TIMER_64_SECOND = 0x3F,
    WATCH_DOG_TIMER_65_SECOND = 0x40,
    WATCH_DOG_TIMER_66_SECOND = 0x41,
    WATCH_DOG_TIMER_67_SECOND = 0x42,
    WATCH_DOG_TIMER_68_SECOND = 0x43,
    WATCH_DOG_TIMER_69_SECOND = 0x44,
    WATCH_DOG_TIMER_70_SECOND = 0x45,
    WATCH_DOG_TIMER_71_SECOND = 0x46,
    WATCH_DOG_TIMER_72_SECOND = 0x47,
    WATCH_DOG_TIMER_73_SECOND = 0x48,
    WATCH_DOG_TIMER_74_SECOND = 0x49,
    WATCH_DOG_TIMER_75_SECOND = 0x4A,
    WATCH_DOG_TIMER_76_SECOND = 0x4B,
    WATCH_DOG_TIMER_77_SECOND = 0x4C,
    WATCH_DOG_TIMER_78_SECOND = 0x4D,
    WATCH_DOG_TIMER_79_SECOND = 0x4E,
    WATCH_DOG_TIMER_80_SECOND = 0x4F,
    WATCH_DOG_TIMER_81_SECOND = 0x50,
    WATCH_DOG_TIMER_82_SECOND = 0x51,
    WATCH_DOG_TIMER_83_SECOND = 0x52,
    WATCH_DOG_TIMER_84_SECOND = 0x53,
    WATCH_DOG_TIMER_85_SECOND = 0x54,
    WATCH_DOG_TIMER_86_SECOND = 0x55,
    WATCH_DOG_TIMER_87_SECOND = 0x56,
    WATCH_DOG_TIMER_88_SECOND = 0x57,
    WATCH_DOG_TIMER_89_SECOND = 0x58,
    WATCH_DOG_TIMER_90_SECOND = 0x59,
    WATCH_DOG_TIMER_91_SECOND = 0x5A,
    WATCH_DOG_TIMER_92_SECOND = 0x5B,
    WATCH_DOG_TIMER_93_SECOND = 0x5C,
    WATCH_DOG_TIMER_94_SECOND = 0x5D,
    WATCH_DOG_TIMER_95_SECOND = 0x5E,
    WATCH_DOG_TIMER_96_SECOND = 0x5F,
    WATCH_DOG_TIMER_97_SECOND = 0x60,
    WATCH_DOG_TIMER_98_SECOND = 0x61,
    WATCH_DOG_TIMER_99_SECOND = 0x62,
    WATCH_DOG_TIMER_100_SECOND = 0x63,
    WATCH_DOG_TIMER_101_SECOND = 0x64,
    WATCH_DOG_TIMER_102_SECOND = 0x65,
    WATCH_DOG_TIMER_103_SECOND = 0x66,
    WATCH_DOG_TIMER_104_SECOND = 0x67,
    WATCH_DOG_TIMER_105_SECOND = 0x68,
    WATCH_DOG_TIMER_106_SECOND = 0x69,
    WATCH_DOG_TIMER_107_SECOND = 0x6A,
    WATCH_DOG_TIMER_108_SECOND = 0x6B,
    WATCH_DOG_TIMER_109_SECOND = 0x6C,
    WATCH_DOG_TIMER_110_SECOND = 0x6D,
    WATCH_DOG_TIMER_111_SECOND = 0x6E,
    WATCH_DOG_TIMER_112_SECOND = 0x6F,
    WATCH_DOG_TIMER_113_SECOND = 0x70,
    WATCH_DOG_TIMER_114_SECOND = 0x71,
    WATCH_DOG_TIMER_115_SECOND = 0x72,
    WATCH_DOG_TIMER_116_SECOND = 0x73,
    WATCH_DOG_TIMER_117_SECOND = 0x74,
    WATCH_DOG_TIMER_118_SECOND = 0x75,
    WATCH_DOG_TIMER_119_SECOND = 0x76,
    WATCH_DOG_TIMER_120_SECOND = 0x77,
    WATCH_DOG_TIMER_121_SECOND = 0x78,
    WATCH_DOG_TIMER_122_SECOND = 0x79,
    WATCH_DOG_TIMER_123_SECOND = 0x7A,
    WATCH_DOG_TIMER_124_SECOND = 0x7B,
    WATCH_DOG_TIMER_125_SECOND = 0x7C,
    WATCH_DOG_TIMER_126_SECOND = 0x7D,
    WATCH_DOG_TIMER_127_SECOND = 0x7E,
    WATCH_DOG_TIMER_128_SECOND = 0x7F
} MAIN_WATCHDOG_TIMER_T ;

//  
//  Defined LowBat threshold from 2.3v to 3.85v 25mv steps.
//  Register MainWatchDogTimer 0x0203, Bits 1:6, typedef low_bat_threshold
//   
//  
...
//  Register MainWatchDogTimer 0x0203, Bits 0:0, typedef low_battery_enable
//   
//  
...
//  Register SmpsClockPhase 0x0207, Bits 3:5, typedef smps_ckock_phase
//   
//  
...
#define SMPS_CLOCK_PHASE_REG 0x207
#define VAPE_CLOCK_SEL_PARAM_MASK  0x38
#define SMPS_CKOCK_PHASE_PARAM_MASK  0x38

//  
//  Smps clock phase management versus IntClk clock.
//  Register SmpsClockPhase 0x0207, Bits 0:2, typedef smps_ckock_phase
//   
//  
...
//  
//  Smps clock phase management versus IntClk clock.
//  Register SmpsClockPhase 0x0208, Bits 3:5, typedef smps_ckock_phase
//   
//  
...
//  
//  Smps clock phase management versus IntClk clock.
//  Register SmpsClockPhase 0x0208, Bits 0:2, typedef smps_ckock_phase
//   
//  
...
//  
//  Smps clock phase management versus IntClk clock.
//  Register SmpsClockPhase 0x0209, Bits 3:5, typedef smps_ckock_phase
//   
//  
#define VSMPS_2_CLOCK_SEL_MASK 0x38
#define VSMPS_2_CLOCK_SEL_OFFSET 5
#define VSMPS_2_CLOCK_SEL_STOP_BIT 5
#define VSMPS_2_CLOCK_SEL_START_BIT 3
#define VSMPS_2_CLOCK_SEL_WIDTH 3

#define VSMPS_2_CLOCK_SEL_PARAM_MASK  0x38

//  
//  Smps clock phase management versus IntClk clock.
//  Register SmpsClockPhase 0x0209, Bits 0:2, typedef smps_ckock_phase
//   
//  
#define VSMPS_3_CLOCK_SEL_MASK 0x7
#define VSMPS_3_CLOCK_SEL_OFFSET 2
#define VSMPS_3_CLOCK_SEL_STOP_BIT 2
#define VSMPS_3_CLOCK_SEL_START_BIT 0
#define VSMPS_3_CLOCK_SEL_WIDTH 3

#define VSMPS_3_CLOCK_SEL_PARAM_MASK  0x7
...
//  Register ClockValid2 0x020D, Bits 1:1, typedef ultra_low_power_request1_valid
//   
//  
...
typedef enum ultra_low_power_request1_valid {
    ULTRA_LOW_POWER_UP_E,
    ULTRA_LOW_POWER_DOWN_E
} ULTRA_LOW_POWER_REQUEST_1_VALID_T ;
...
//  Register SwatCtrl 0x0230, Bits 5:5, typedef swat_bit5_set
//   
//  
#define SWAT_BIT_5_SET_MASK 0x20
#define SWAT_BIT_5_SET_OFFSET 5
#define SWAT_BIT_5_SET_STOP_BIT 5
#define SWAT_BIT_5_SET_START_BIT 5
...
#define SWAT_BIT_5_SET_PARAM_MASK  0x20
