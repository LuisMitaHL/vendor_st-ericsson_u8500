/****************************************************************************
 * File : c:/Lisp/Production/ab8500/ab8500_TVOut/Linux/ab8500_TVOut.c
 * 
 *
...
unsigned char set_tvout_standard( enum tvout_standard param )
  {
    ...
    old_value = SPIRead(TVOUT_CONFIGURATION_0_REG);

    /* 
     * TVOut standard selection 
     */ 
    SPIWrite(TVOUT_CONFIGURATION_0_REG, value);
...
unsigned char get_tvout_standard()
  {
     ...
     * TVOut standard selection 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_0_REG) & TVOUT_STANDARD_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_tvout_synchro_mode()
  {
     ...
     * TVOut synchro mode selection 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_0_REG) & TVOUT_SYNCHRO_MODE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char set_soft_reset( enum soft_reset param )
  {
    ...
    old_value = SPIRead(TVOUT_CONFIGURATION_6_REG);
    ...
    SPIWrite(TVOUT_CONFIGURATION_6_REG, value);
...
unsigned char get_soft_reset()
  {
     ...
     * except for the first nine user registers 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & SOFT_RESET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_jump_enable()
  {
     ...
     * 1x1: must not be used. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & JUMP_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_dec_ninc_enable()
  {
     ...
     * 1x1: must not be used. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & DEC_NINC_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_free_jump_enable()
  {
     ...
     * 1x1: must not be used. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & FREE_JUMP_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_cfc()
  {
     ...
     * Colour frequency control via CFC line. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & CFC_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_max_dyn_enable()
  {
     ...
     * processing. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_6_REG) & MAX_DYN_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_phase_reset_mode( enum phase_reset_mode param )
  {
    ...
    old_value = SPIRead(TVOUT_CONFIGURATION_8_REG);
    ...
    SPIWrite(TVOUT_CONFIGURATION_8_REG, value);
...
unsigned char get_phase_reset_mode()
  {
     ...
     * cfc's LSB. 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_8_REG) & PHASE_RESET_MODE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_val422_mux()
  {
     ...
     * Should be programmed to 1 only after each reset 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_8_REG) & VAL_422_MUX_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_blanking_all_enable()
  {
     ...
     * Enable/Disable blanking of all video lines 
     */ 
    value = (SPIRead(TVOUT_CONFIGURATION_8_REG) & BLANKING_ALL_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
 ...
 *
 **************************************************************************/
unsigned char set_t_v_load_r_c( enum tv_load_r_c_set param )
  {
    unsigned char value = 0;
    unsigned char old_value;

    old_value = SPIRead(TV_OUT_CONTROL_REG);
    ...
    SPIWrite(TV_OUT_CONTROL_REG, value);
 ...
 *
 **************************************************************************/
unsigned char get_t_v_load_r_c()
  {
    unsigned char value;
     ...
     * TV capacitive load 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_REG) & TV_LOAD_RC_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_plug_tv_time()
  {
    ...
    /* 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_REG) & PLUG_TV_TIME_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_plug_tv_detect_enable()
  {
     ...
     * Enable/Disable plug/unplug TV detection 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_REG) & PLUG_TV_DETECT_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
    ...
    switch(  param )
      {
        case TVOUT_DAC_DISABLE_E:
           ...
           break;
        case TVOUT_DAC_ENABLE_E:
            value =  value | TVOUT_DAC_ENABLE ;
           break;
        case TVOUT_TEST_MODE_E:
            value =  value | TVOUT_TEST_MODE ;
           break;
      }
...
unsigned char get_tvout_dac_ctrl()
  {
     ...
     * [1x]: Test mode 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_REG) & TVOUT_DAC_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_tv_dual_data_mode( enum clock_mode param )
  {
    ...
    old_value = SPIRead(TV_OUT_CONTROL_2_REG);
    ...
    SPIWrite(TV_OUT_CONTROL_2_REG, value);
...
unsigned char get_tv_dual_data_mode()
  {
     ...
     * 1: in DDR mode LSB data is on clock falling edge 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_2_REG) & CLOCK_MODE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_tv_double_data_rate()
  {
     ...
     * 1: DENC is set in DDR input data flow 
     */ 
    value = (SPIRead(TV_OUT_CONTROL_2_REG) & DOUBLE_DATA_RATE_PARAM_MASK);
    return value;
  }
