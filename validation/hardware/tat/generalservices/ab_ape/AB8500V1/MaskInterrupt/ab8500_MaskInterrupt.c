/****************************************************************************
 * File : c:/Lisp/Production/ab8500/ab8500_MaskInterrupt/Linux/ab8500_MaskInterrupt.c
 * 
 *
...
unsigned char set_masked_interrupt1( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_1_REG);

    /* 
     * IntSource1 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_1_REG, param);
    return value;
...
unsigned char set_main_charger_allowed_masked_interrupt( enum main_charger_allowed_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_1_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_1_REG, value);
...
unsigned char get_main_charger_allowed_masked_interrupt()
  {
     ...
     * Main charger connected is not an allowed Interupt mask 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & MAIN_CHARGER_ALLOWED_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_un_plug_tv_masked_interrupt()
  {
     ...
     * masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & UN_PLUG_TV_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_plug_tv_masked_interrupt()
  {
     ...
     * Tvset (75 Ohms) connection on CVBS ball detected masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & PLUG_TV_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_thermal_warning_masked_interrupt()
  {
     ...
     * Thermal warning masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & THERMAL_WARNING_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_falling_pon_key2_masked_interrupt()
  {
     ...
     * Falling edge on PonKey2 ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & FALLING_PON_KEY_2_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_rising_pon_key2_masked_interrupt()
  {
     ...
     * Rising edge on PonKey2 ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & RISING_PON_KEY_2_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_falling_pon_key1_masked_interrupt()
  {
     ...
     * Falling edge on PonKey1 ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & FALLING_PON_KEY_1_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_rising_pon_key1_masked_interrupt()
  {
     ...
     * Rising edge on PonKey1 ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_1_REG) & RISING_PON_KEY_1_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt2( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_2_REG);

    /* 
     * IntSource2 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_2_REG, param);
    return value;
...
unsigned char set_battery_over_voltage_mask( enum battery_over_voltage_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_2_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_2_REG, value);
...
unsigned char get_battery_over_voltage_mask()
  {
     ...
     * TVbatA ball goes upper over voltage threshold masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & BATTERY_OVER_VOLTAGE_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_main_charger_un_plug_mask()
  {
     ...
     * Main charger unplug masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & MAIN_CHARGER_UN_PLUG_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_main_charger_plug_mask()
  {
     ...
     * Main charger plug masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & MAIN_CHARGER_PLUG_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
/***************************************************************************
 *
 * Function : set_usb_id_falling_edge_mask
 *
 * IN   : param, a value to write to the regiter MaskedInterrupt2
 * OUT  : 
 *
 * RET  : Return the value of register MaskedInterrupt2
 *
 * Notes : From register 0x0E41, bits 4:4
 *
 **************************************************************************/
unsigned char set_usb_id_falling_edge_mask( enum usb_id_falling_edge_mask_set param )
  {
    unsigned char value = 0;
    unsigned char old_value;
    ...
    switch( param )
      {
        case USB_ID_FALLING_EDGE_MASK_SET_E: 
           value = old_value | USB_ID_FALLING_EDGE_MASK_SET_PARAM_MASK; 
           break;
        case USB_ID_FALLING_EDGE_MASK_RESET_SET_E: 
           value = old_value & ~ USB_ID_FALLING_EDGE_MASK_SET_PARAM_MASK;
           break;
      }
...
/***************************************************************************
 *
 * Function : get_usb_id_falling_edge_mask
 *
 * RET  : Return the value of register MaskedInterrupt2
 *
 * Notes : From register 0x0E41, bits 4:4
 *
 **************************************************************************/
unsigned char get_usb_id_falling_edge_mask()
  {
    unsigned char value;
     ...
     * Falling edge on ID ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & USB_ID_FALLING_EDGE_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
/***************************************************************************
 *
 * Function : set_usb_id_rising_edge_mask
 *
 * IN   : param, a value to write to the regiter MaskedInterrupt2
 * OUT  : 
 *
 * RET  : Return the value of register MaskedInterrupt2
 *
 * Notes : From register 0x0E41, bits 5:5
 *
 **************************************************************************/
unsigned char set_usb_id_rising_edge_mask( enum usb_id_rising_edge_mask_set param )
  {
    unsigned char value = 0;
    unsigned char old_value;
    ...
    switch( param )
      {
        case USB_ID_RISING_EDGE_MASK_SET_E: 
           value = old_value | USB_ID_RISING_EDGE_MASK_SET_PARAM_MASK; 
           break;
        case USB_ID_RISING_EDGE_MASK_RESET_SET_E: 
           value = old_value & ~ USB_ID_RISING_EDGE_MASK_SET_PARAM_MASK;
           break;
      }
...
/***************************************************************************
 *
 * Function : get_usb_id_rising_edge_mask
 *
 * RET  : Return the value of register MaskedInterrupt2
 *
 * Notes : From register 0x0E41, bits 5:5
 *
 **************************************************************************/
unsigned char get_usb_id_rising_edge_mask()
  {
    unsigned char value;
     ...
     * Rising edge on ID ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & USB_ID_RISING_EDGE_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vbus_falling_edge_mask()
  {
     ...
     * Falling edge on Vbus ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & VBUS_FALLING_EDGE_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vbus_rising_edge_mask()
  {
     ...
     * Rising edge on Vbus ball masked 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_2_REG) & VBUS_RISING_EDGE_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt3( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_3_REG);

    /* 
     * IntSource3 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_3_REG, param);
    return value;
...
unsigned char set_usb_charger_dropout_mask( unsigned char param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_3_REG);
    ...
    value =  old_value & ~USB_DROP_OUT_MASK_SET_PARAM_MASK;
     ...
     value |= param;  
    SPIWrite(MASKED_INTERRUPT_3_REG, value);
...
unsigned char get_usb_charger_dropout_mask()
  {
     ...
     * drop 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & USB_DROP_OUT_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_rtc60s_mask()
  {
     ...
     * RTC timer reaches a 60s period 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & PERIOD_6_0S_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_rtc_alarm_mask()
  {
     ...
     * RTC timer reaches alarm time 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & REACH_ALARM_TIME_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_battery_removal_mask()
  {
     ...
     * Battery removal 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & BATTERY_REMOVAL_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_watchdog_charger_expiration_mask()
  {
     ...
     * Watchdog charger expiration detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & WATCHDOG_CHARGER_EXPIRATION_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_overvoltage_on_vbus_mask()
  {
     ...
     * Overvoltage on Vbus ball detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & OVERVOLTAGE_ON_VBUS_L_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char set_main_charger_over_current_mask( enum cain_charger_over_current_mask_set param )
  {
    ...
    switch( param )
      {
        case CAIN_CHARGER_OVER_CURRENT_MASK_SET_E: 
           value = old_value | CAIN_CHARGER_OVER_CURRENT_MASK_SET_PARAM_MASK; 
           break;
        case CAIN_CHARGER_OVER_CURRENT_MASK_RESET_SET_E: 
           value = old_value & ~ CAIN_CHARGER_OVER_CURRENT_MASK_SET_PARAM_MASK;
           break;
      }
...
unsigned char get_main_charger_over_current_mask()
  {
     ...
     * Icharge > Icharge max programmed detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_3_REG) & CAIN_CHARGER_OVER_CURRENT_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt4( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_4_REG);

    /* 
     * IntSource4 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_4_REG, param);
    return value;
...
unsigned char set_accumulation_conversion_mask( enum accumulation_conversion_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_4_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_4_REG, value);
...
unsigned char get_accumulation_conversion_mask()
  {
     ...
     * Accumulation of N sample conversion is detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & ACCUMULATION_CONVERSION_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_audio_mask()
  {
     ...
     * Audio interrupt form audio digital part detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & AUDIO_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_coulomb_ended_mask()
  {
     ...
     * Coulomb Counter has ended data convertion 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & COULOMB_COUNTER_ENDED_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_coulomb_calibration_endedd_mask()
  {
     ...
     * Coulomb Counter has ended its calibration 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & COULOMB_CALIBRATION_ENDEDD_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_low_battery_mask()
  {
     ...
     * threshold 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & LOW_BATTERY_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_high_battery_mask()
  {
     ...
     * threshold 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & HIGH_BATTERY_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_rtc_battery_high_mask()
  {
     ...
     * BackUpBat ball voltage goes above RtcBackupChg register 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_4_REG) & RTC_BATTERY_HIGH_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt5( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_5_REG);

    /* 
     * IntSource5 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_5_REG, param);
    return value;
...
unsigned char set_adc_hardware_control_mask( enum adc_hardware_control_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_5_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_5_REG, value);
...
unsigned char get_adc_hardware_control_mask()
  {
     ...
     * GP ADC conversion requested thru Hardware control 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ADC_HARDWARE_CONTROL_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_accessory1_low_voltage_mask()
  {
     ...
     * AccDetect1 ball voltage level goes below AccDetect1Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_1_LOW_VOLTAGE_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_accessory1_high_voltage_mask()
  {
     ...
     * AccDetect1 ball voltage level goes above AccDetect1Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_1_HIGH_VOLTAGE_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_accessory22_low_voltage_mask()
  {
     ...
     * AccDetect2 ball voltage level goes below AccDetect22Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_22_LOW_VOLTAGE_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_accessory22_high_voltage_mask()
  {
     ...
     * AccDetect2 ball voltage level goes above AccDetect22Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_22_HIGH_VOLTAGE_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_accessory21_low_voltage_mask()
  {
     ...
     * AccDetect2 ball voltage level goes below AccDetect21Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_21_LOW_VOLTAGE_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_accessory21_high_voltage_mask()
  {
     ...
     * AccDetect2 ball voltage level goes above AccDetect21Th 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ACCESSORY_21_HIGH_VOLTAGE_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_adc_software_control_mask()
  {
     ...
     * ended (data are available) 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_5_REG) & ADC_SOFTWARE_CONTROL_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt7( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_7_REG);

    /* 
     * IntSource7 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_7_REG, param);
    return value;
...
unsigned char set_gpio13_rising_mask( enum gpio13_rising_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_7_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_7_REG, value);
...
unsigned char get_gpio13_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO13 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_13_RISING_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_gpio12_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO12 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_12_RISING_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
 ...
 * RET  : Return the value of register MaskedInterrupt7
 *
 * Notes : From register 0x0E46, bits 8:5
 *
 **************************************************************************/
...
unsigned char get_gpio11_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO11 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_11_RISING_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_gpio10_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO10 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_10_RISING_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_gpio9_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO9 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_9_RISING_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_gpio8_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO8 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_8_RISING_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_gpio7_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO7 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_7_RISING_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_gpio6_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO6 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_7_REG) & GPIO_6_RISING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_masked_interrupt8( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_8_REG);

    /* 
     * IntSource8 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_8_REG, param);
    return value;
...
unsigned char set_gpio41_rising_mask( enum gpio41_rising_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_8_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_8_REG, value);
...
unsigned char get_gpio41_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO41 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_41_RISING_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_gpio40_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO40 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_40_RISING_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_gpio39_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO39 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_39_RISING_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_gpio38_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO38 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_38_RISING_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_gpio37_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO37 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_37_RISING_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_gpio36_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO36 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_36_RISING_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_gpio25_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO25 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_25_RISING_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_gpio24_rising_mask()
  {
     ...
     * Rising edge Interrupt masked on GPIO24 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_8_REG) & GPIO_24_RISING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_masked_interrupt9( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_9_REG);

    /* 
     * IntSource9 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_9_REG, param);
    return value;
...
unsigned char set_gpio13_falling_mask( enum gpio13_falling_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_9_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_9_REG, value);
...
unsigned char get_gpio13_falling_mask()
  {
     ...
     * Falling edge detected on GPIO13 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_13_FALLING_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_gpio12_falling_mask()
  {
     ...
     * Falling edge detected on GPIO12 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_12_FALLING_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_gpio11_falling_mask()
  {
     ...
     * Falling edge detected on GPIO11 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_11_FALLING_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_gpio10_falling_mask()
  {
     ...
     * Falling edge detected on GPIO10 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_10_FALLING_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_gpio9_falling_mask()
  {
     ...
     * Falling edge detected on GPIO9 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_9_FALLING_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_gpio8_falling_mask()
  {
     ...
     * Falling edge detected on GPIO8 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_8_FALLING_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_gpio7_falling_mask()
  {
     ...
     * Falling edge detected on GPIO7 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_7_FALLING_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_gpio6_falling_mask()
  {
     ...
     * Falling edge detected on GPIO6 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_9_REG) & GPIO_6_FALLING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_masked_interrupt10( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_10_REG);

    /* 
     * IntSource10 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_10_REG, param);
    return value;
...
unsigned char set_gpio41_falling_mask( enum gpio41_falling_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_10_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_10_REG, value);
...
unsigned char get_gpio41_falling_mask()
  {
     ...
     * Falling edge detected on GPIO41 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_41_FALLING_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_gpio40_falling_mask()
  {
     ...
     * Falling edge detected on GPIO40 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_40_FALLING_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_gpio39_falling_mask()
  {
     ...
     * Falling edge detected on GPIO39 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_39_FALLING_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_gpio38_falling_mask()
  {
     ...
     * Falling edge detected on GPIO38 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_38_FALLING_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_gpio37_falling_mask()
  {
     ...
     * Falling edge detected on GPIO37 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_37_FALLING_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_gpio36_falling_mask()
  {
     ...
     * Falling edge detected on GPIO36 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_36_FALLING_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_gpio25_falling_mask()
  {
     ...
     * Falling edge detected on GPIO25 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_25_FALLING_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_gpio24_falling_mask()
  {
     ...
     * Falling edge detected on GPIO24 ball 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_10_REG) & GPIO_24_FALLING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_masked_interrupt19( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_19_REG);

    /* 
     * IntSource19 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_19_REG, param);
    return value;
...
unsigned char set_battery_temperature_high_mask( enum battery_temperature_high_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_19_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_19_REG, value);
...
unsigned char get_battery_temperature_high_mask()
  {
     ...
     * 1: Btemp > BtempHigh 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_19_REG) & BATTERY_TEMPERATURE_HIGH_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_battery_temperature_medium_high_mask()
  {
     ...
     * 1: BtempHigh > Btemp > BtempMedium 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_19_REG) & BATTERY_TEMPERATURE_MEDIUM_HIGH_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_battery_temperature_low_medium_mask()
  {
     ...
     * 1: BtempMedium > Btemp > BtempLow 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_19_REG) & BATTERY_TEMPERATURE_LOW_MEDIUM_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_battery_temperature_low_mask()
  {
     ...
     * 1: BtempLow > Btemp 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_19_REG) & BATTERY_TEMPERATURE_LOW_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_masked_interrupt20( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_20_REG);

    /* 
     * IntSource20 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_20_REG, param);
    return value;
...
/***************************************************************************
 *
 * Function : set_dplus_comparator_rising_mask
 *
 ...
 *
 **************************************************************************/
unsigned char set_dplus_comparator_rising_mask( enum dplus_rising_mask_set param )
  {
    unsigned char value = 0;
    unsigned char old_value;

    old_value = SPIRead(MASKED_INTERRUPT_22_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_22_REG, value);
...
/***************************************************************************
 *
 * Function : get_dplus_comparator_rising_mask
 *
 * RET  : Return the value of register MaskedInterrupt22
 *
 * Notes : From register 0x0E53, bits 0:0
 *
 **************************************************************************/
unsigned char get_dplus_comparator_rising_mask()
  {
    unsigned char value;
     ...
     * Rising edge detected on DP ball comparator 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & DPLUS_RISING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char set_usb_charger_plug_mask( enum usb_charger_plug_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_20_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_20_REG, value);
...
unsigned char get_usb_charger_plug_mask()
  {
     ...
     * USB charger plug detection 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & USB_CHARGER_PLUG_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
/***************************************************************************
 *
 * Function : set_id_wake_up_rising_mask
 *
 * IN   : param, a value to write to the regiter MaskedInterrupt20
 * OUT  : 
 *
 ...
 *
 **************************************************************************/
unsigned char set_id_wake_up_rising_mask( enum id_wake_up_rising_mask_set param )
  {
    unsigned char value = 0;
    unsigned char old_value;
...
/***************************************************************************
 *
 * Function : get_id_wake_up_rising_mask
 *
 * RET  : Return the value of register MaskedInterrupt20
 *
 * Notes : From register 0x0E53, bits 2:2
 *
 **************************************************************************/
unsigned char get_id_wake_up_rising_mask()
  {
    unsigned char value;
     ...
     * Rising edge detected on WakeUp 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & ID_WAKE_UP_RISING_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_id_detection_greater37k_mask()
  {
     ...
     * ID resistance greater than 37k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & ID_DETECTION_GREATER_3_7K_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_id_detection_greater69k_mask()
  {
     ...
     * ID resistance greater than 69k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & ID_DETECTION_GREATER_6_9K_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_id_detection_greater150k_mask()
  {
     ...
     * ID resistance greater than 125k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & ID_DETECTION_GREATER_12_5K_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_id_detection_greater220k_mask()
  {
     ...
     * ID resistance greater than 220k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_20_REG) & ID_DETECTION_GREATER_22_0K_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_masked_interrupt21( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_21_REG);

    /* 
     * IntSource21 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_21_REG, param);
    return value;
...
unsigned char set_id_wake_up_falling_mask( enum id_wake_up_falling_mask_set param )
  {
    ...
    old_value = SPIRead(MASKED_INTERRUPT_21_REG);
    ...
    SPIWrite(MASKED_INTERRUPT_21_REG, value);
...
unsigned char get_id_wake_up_falling_mask()
  {
     ...
     * Falling edge detected on WakeU 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & ID_WAKE_UP_FALLING_MASK_SET_PARAM_MASK);
    return value;
  }
...
unsigned char get_id_detection37k_mask()
  {
     ...
     * ID resistance lower than 37k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & ID_DETECTION_3_7K_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_id_detection69k_mask()
  {
     ...
     * ID resistance lower than 69k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & ID_DETECTION_6_9K_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_id_detection150k_mask()
  {
     ...
     * ID resistance lower than 125k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & ID_DETECTION_12_5K_MASK_SET_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_id_detection220k_mask()
  {
     ...
     * ID resistance lower than 220k detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & ID_DETECTION_22_0K_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_usb_charger_mask()
  {
     ...
     * USB charger detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_21_REG) & USB_CHARGER_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char set_masked_interrupt22( unsigned char param )
  {
    ...
    value = SPIRead(MASKED_INTERRUPT_22_REG);

    /* 
     * IntSource22 Status 
     */ 
    SPIWrite(MASKED_INTERRUPT_22_REG, param);
    return value;
...
unsigned char get_usb_charger_unplug()
  {
     ...
     * USB charger unplug detected 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & USB_CHARGERUNPLUG_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_main_charger_thermal_above_mask()
  {
     ...
     * protection threshold (charge stopped) 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & MAIN_CHARGER_THERMAL_ABOVE_MASK_SET_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_main_charger_thermal_below_mask()
  {
     ...
     * protection threshold (charge stopped) 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & MAIN_CHARGER_THERMAL_BELOW_MASK_SET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_usb_charger_thermal_above_mask()
  {
     ...
     * protection threshold (charge stopped) 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & USB_CHARGER_THERMAL_ABOVE_MASK_SET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_usb_charger_thermal_below_mask()
  {
     ...
     * protection threshold (charge stopped) 
     */ 
    value = (SPIRead(MASKED_INTERRUPT_22_REG) & USB_CHARGER_THERMAL_BELOW_MASK_SET_PARAM_MASK);
    return value;
  }
