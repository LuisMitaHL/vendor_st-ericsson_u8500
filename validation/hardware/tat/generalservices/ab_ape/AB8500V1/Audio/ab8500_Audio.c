...
unsigned char set_digital_power_up( enum digital_power_up param )
  {
    ...
    old_value = SPIRead(POWER_UP_CONTROL_REG);
    ...
    SPIWrite(POWER_UP_CONTROL_REG, value);
...
unsigned char get_digital_power_up()
  {
     ...
     * Device power Up 
     */ 
    value = (SPIRead(POWER_UP_CONTROL_REG) & DIGITAL_POWER_UP_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_analog_power_up()
  {
     ...
     * Analog parts power Up 
     */ 
    value = (SPIRead(POWER_UP_CONTROL_REG) & ANALOG_POWER_UP_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char set_audio_software_reset( enum audio_software_reset param )
  {
    ...
    old_value = SPIRead(SOFTWARE_RESET_REG);
    ...
    SPIWrite(SOFTWARE_RESET_REG, value);
...
unsigned char get_audio_software_reset()
  {
     ...
     * Audio sofware reset 
     */ 
    value = (SPIRead(SOFTWARE_RESET_REG) & AUDIO_SOFTWARE_RESET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_ad12_digital_audio_paths_enable( enum ad12_enable param )
  {
    ...
    old_value = SPIRead(DIGITAL_CHANNELS_ENABLE_REG);
    ...
    SPIWrite(DIGITAL_CHANNELS_ENABLE_REG, value);
...
unsigned char get_ad12_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital AD audio paths enable 1/2 
     */ 
    value = (SPIRead(DIGITAL_CHANNELS_ENABLE_REG) & AD_12_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_ad34_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital AD audio paths enable 3/4 
     */ 
    value = (SPIRead(DIGITAL_CHANNELS_ENABLE_REG) & AD_34_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
/***************************************************************************
 *
 * Function : set_ad57_digital_audio_paths_enable
 *
 * IN   : param, a value to write to the regiter DigitalChannelsEnable
 * OUT  : 
 *
...
unsigned char set_ad57_digital_audio_paths_enable( enum ad57_enable param )
  {
    ...
    switch( param )
      {
        case AD_57_DISABLE_E: 
           value = old_value & ~ AD_57_ENABLE_PARAM_MASK;
           break;
        case AD_57_ENABLE_E: 
           value = old_value | AD_57_ENABLE_PARAM_MASK; 
           break;
...
/***************************************************************************
 *
 * Function : get_ad57_digital_audio_paths_enable
 *
 * RET  : Return the value of register DigitalChannelsEnable
 *
 * Notes : From register 0x0D02, bits 3:3
...
unsigned char get_ad57_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital AD audio paths enable 5/8 
     */ 
    value = (SPIRead(DIGITAL_CHANNELS_ENABLE_REG) & AD_57_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
/***************************************************************************
 *
 * Function : set_ad68_digital_audio_paths_enable
 *
 * IN   : param, a value to write to the regiter DigitalChannelsEnable
 * OUT  : 
 *
 * RET  : Return the value of register DigitalChannelsEnable
 *
 * Notes : From register 0x0D02, bits 2:2
 *
 **************************************************************************/
unsigned char set_ad68_digital_audio_paths_enable( enum ad68_enable param )
  {
    ...
    switch( param )
      {
        case AD_68_DISABLE_E: 
           value = old_value & ~ AD_68_ENABLE_PARAM_MASK;
           break;
        case AD_68_ENABLE_E: 
           value = old_value | AD_68_ENABLE_PARAM_MASK; 
           break;
...
/***************************************************************************
 *
 * Function : get_ad68_digital_audio_paths_enable
 *
 * RET  : Return the value of register DigitalChannelsEnable
 *
 * Notes : From register 0x0D02, bits 2:2
...
unsigned char get_ad68_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital AD audio paths enable 6/8 
     */ 
    value = (SPIRead(DIGITAL_CHANNELS_ENABLE_REG) & AD_68_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char set_da1_digital_audio_paths_enable( enum da1_enable param )
  {
    ...
    old_value = SPIRead(DIGITAL_DA_AUDIO_PATHS_REG);
    ...
    SPIWrite(DIGITAL_DA_AUDIO_PATHS_REG, value);
...
unsigned char get_da1_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA audio paths enable 1 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_1_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_da2_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA audio paths enable 2 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_2_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da3_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA Audio Paths enable 3 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_3_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_da4_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA Audio Paths enable 4 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_4_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_da5_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA Audio Paths enable 5 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_5_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_da6_digital_audio_paths_enable()
  {
     ...
     * Enable/Disable Digital DA audio paths enable 6 
     */ 
    value = (SPIRead(DIGITAL_DA_AUDIO_PATHS_REG) & DA_6_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char set_low_power_headset( enum audio_low_power_mode param )
  {
    ...
    old_value = SPIRead(ANALOG_D_MIC_CONTROLS_REG);
    ...
    SPIWrite(ANALOG_D_MIC_CONTROLS_REG, value);
...
unsigned char get_low_power_headset()
  {
     ...
     * Low Power Headset 
     */ 
    value = (SPIRead(ANALOG_D_MIC_CONTROLS_REG) & AUDIO_LOW_POWER_MODE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_low_power_dac_headset()
  {
     ...
     * Low Power DAC headset 
     */ 
    value = (SPIRead(ANALOG_D_MIC_CONTROLS_REG) & LOW_POWER_DAC_HEADSET_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_low_power_ear()
  {
     ...
     * Low Power Ear 
     */ 
    value = (SPIRead(ANALOG_D_MIC_CONTROLS_REG) & LOW_POWER_EAR_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_ear_selection()
  {
     ...
     * Ear Selection Common Mode 
     */ 
    value = (SPIRead(ANALOG_D_MIC_CONTROLS_REG) & EAR_SELECTION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_headset_offset_cancelation()
  {
     ...
     * Offset cancellation for headset driver. 
     */ 
    value = (SPIRead(ANALOG_D_MIC_CONTROLS_REG) & HEADSET_OFFSET_CANCELATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char set_micro1_power( enum micro1_power param )
  {
    ...
    old_value = SPIRead(LINE_IN_CONF_REG);
    ...
    SPIWrite(LINE_IN_CONF_REG, value);
...
unsigned char get_micro1_power()
  {
     ...
     * Micro 1a anhd 1b Enable (power up) 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & MICRO_1_POWER_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_micro2_power()
  {
     ...
     * Micro 2a anhd 2b Enable (power up) 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & MICRO_2_POWER_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_line_in_left_power()
  {
     ...
     * Line-in left input power state 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & LINE_IN_LEFT_POWER_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_line_in_right_power()
  {
     ...
     * Line-in right input power state 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & LINE_IN_RIGHT_POWER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_analog_micro1_mute()
  {
     ...
     * Analog micropnone MIC1A/B is active 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & ANALOG_MICRO_1_MUTE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_analog_micro2_mute()
  {
     ...
     * Analog micropnone MIC2 is active 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & ANALOG_MICRO_2_MUTE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_analog_line_in_left_mute()
  {
     ...
     * Analog line in Left is unmuted 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & ANALOG_LINE_IN_LEFT_MUTE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_analog_line_in_right_mute()
  {
     ...
     * Analog line in Right is active 
     */ 
    value = (SPIRead(LINE_IN_CONF_REG) & ANALOG_LINE_IN_RIGHT_MUTE_PARAM_MASK);
    return value;
  }
...
unsigned char set_digital_micro1_mute( enum digital1_micro_mute param )
  {
    ...
    old_value = SPIRead(DIGITAL_INPUTS_ENABLE_REG);
    ...
    SPIWrite(DIGITAL_INPUTS_ENABLE_REG, value);
...
unsigned char get_digital_micro1_mute()
  {
     ...
     * 0: Digital Micro 1 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_1_MICRO_MUTE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_digital_micro2_mute()
  {
     ...
     * 0: Digital Micro 2 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_2_MICRO_MUTE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_digital_micro3_mute()
  {
     ...
     * 0: Digital Micro 3 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_3_MICRO_MUTE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_digital_micro4_mute()
  {
     ...
     * 0: Digital Micro 4 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_4_MICRO_MUTE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_digital_micro5_mute()
  {
     ...
     * 0: Digital Micro 5 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_5_MICRO_MUTE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_digital_micro6_mute()
  {
     ...
     * 0: Digital Micro 6 input is muted 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & DIGITAL_6_MICRO_MUTE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_fade_speed()
  {
     ...
     * digital gain controls 
     */ 
    value = (SPIRead(DIGITAL_INPUTS_ENABLE_REG) & FADE_SPEED_PARAM_MASK);
    return value;
  }
...
unsigned char set_adc1_connected_to_mic( enum adc1_connected_to_mic_a param )
  {
    ...
    old_value = SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG);
    ...
    SPIWrite(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG, value);
...
unsigned char get_adc1_connected_to_mic()
  {
     ...
     * 1: connected to MIC1B, 0 : connected to MIC1A 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & ADC1_CONNECTED_TO_MIC_A_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_adc2_connected_to_mic()
  {
     ...
     * 0: connected to MIC2B, 1 : connected to LINR 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & ADC2_CONNECTED_TO_MIC_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_hsl_dac_driver_power()
  {
     ...
     * HeadSetLelf Dac driver is power up 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & HSL_DAC_DRIVER_POWER_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_hsr_dac_driver_power()
  {
     ...
     * HeadSetRight Dac driver is power up 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & HSR_DAC_DRIVER_POWER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_adc1_power()
  {
     ...
     * 1: ADC1 is power up 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & ADC_1_POWER_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_adc3_power()
  {
     ...
     * 1: ADC2 is power up if ENLINL 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & ADC_3_POWER_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_adc2_power()
  {
     ...
     * 1: ADC3 is power up if ENLINR 
     */ 
    value = (SPIRead(ANALOG_DIGITAL_CONVERTERS_ENABLE_REG) & ADC_2_POWER_PARAM_MASK);
    return value;
  }
...
unsigned char set_internal_pull_down_enabled( enum internal_pull_down_enabled param )
  {
    ...
    old_value = SPIRead(ANALOG_OUTPUT_ENABLE_REG);
...
/*-CAP_2335_001*/
    ...
    SPIWrite(ANALOG_OUTPUT_ENABLE_REG, value);
...
unsigned char get_internal_pull_down_enabled()
  {
     ...
     * 1: Internal pull down on VSS is disabled 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & INTERNAL_PULL_DOWN_ENABLED_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_ear_class_ab_power()
  {
     ...
     * 1: The EAR Class-AB driver is powered up 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & EAR_CLASS_AB_POWER_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_headset_left_power()
  {
     ...
     * 1: The Headset Left is powered up 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & HEADSET_LEFT_POWER_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_headset_right_power()
  {
     ...
     * 1: The Headset Right is powered up 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & HEADSET_RIGHT_POWER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_hf_class_d_left_power()
  {
     ...
     * 1: The HFL Class-D driver is powered up 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & HF_LEFT_CLASS_D_POWER_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_hf_class_d_rigth_power()
  {
     ...
     * 1: The HFR Class-D driver is powered up 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & HF_RIGHT_CLASS_D_POWER_PARAM_MASK) >> 2;
    return value;
  }
 ...
 * RET  : Return the value of register AnalogOutputEnable
 *
 * Notes : From register 0x0D08, bits 0:0  CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vibrator2_class_d_power()
  {
     ...
     */ 
/* +CAP_2335_001*/     
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & VIBRATOR_2_POWER_PARAM_MASK) >> VIBRATOR_2_CLASS_D_POWER_OFFSET;
/* -CAP_2335_001*/      
 ...
 * RET  : Return the value of register AnalogOutputEnable
 *
 * Notes : From register 0x0D08, bits 1:1  CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vibrator1_class_d_power()
  {
     ...
     */ 
/* +CAP_2335_001*/     
    value = (SPIRead(ANALOG_OUTPUT_ENABLE_REG) & VIBRATOR_1_POWER_PARAM_MASK) >> VIBRATOR_1_CLASS_D_POWER_OFFSET;
/* -CAP_2335_001*/      
    return value;
  }
...
unsigned char set_ear_and_digital_path_power( enum ear_and_digital_path_power param )
  {
    ...
    old_value = SPIRead(DIGITAL_OUTPUT_ENABLE_REG);
    ...
    SPIWrite(DIGITAL_OUTPUT_ENABLE_REG, value);
...
unsigned char get_ear_and_digital_path_power()
  {
     ...
     * 1: EAR DAC and digital dedicated path are powered up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & EAR_AND_DIGITAL_PATH_POWER_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_headset_left_path_power()
  {
     ...
     * 1: HSL DAC and digital dedicated path are powered up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & HEADSET_LEFT_PATH_POWER_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_headset_right_path_power()
  {
     ...
     * 1: HSR DAC and digital dedicated path are powered up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & HEADSET_RIGHT_PATH_POWER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_hf_class_d_left_path_power()
  {
     ...
     * up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & HF_CLASS_D_LEFT_PATH_POWER_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_hf_class_d_rigth_path_power()
  {
     ...
     * up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & HF_CLASS_D_RIGTH_PATH_POWER_PARAM_MASK) >> 2;
    return value;
  }
 ...
 * RET  : Return the value of register DigitalOutputEnable
 *
 * Notes : From register 0x0D09, bits 0:0 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vibrator2_class_d_path_power()
  {
     ...
     * up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & VIBRATOR_2_CLASS_D_PATH_POWER_PARAM_MASK) >> 1;
    return value;
  }
 ...
 * RET  : Return the value of register DigitalOutputEnable
 *
 * Notes : From register 0x0D09, bits 1:1 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vibrator1_class_d_path_power()
  {
     ...
     * up 
     */ 
    value = (SPIRead(DIGITAL_OUTPUT_ENABLE_REG) & VIBRATOR_1_CLASS_D_PATH_POWER_PARAM_MASK);
    return value;
  }
...
unsigned char set_ear_class_ab_mute( enum ear_class_ab_mute param )
  {
    ...
    old_value = SPIRead(ANALOG_OUTPUT_MUTE_REG);
    ...
    SPIWrite(ANALOG_OUTPUT_MUTE_REG, value);
...
unsigned char get_ear_class_ab_mute()
  {
     ...
     * 1: The EAR Class-AB driver is muted 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_MUTE_REG) & EAR_CLASS_AB_MUTE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_headset_left_mute()
  {
     ...
     * 1: The Headset Left is muted 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_MUTE_REG) & HEADSET_LEFT_MUTE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_headset_right_mute()
  {
     ...
     * 1: The Headset Right is muted 
     */ 
    value = (SPIRead(ANALOG_OUTPUT_MUTE_REG) & HEADSET_RIGHT_MUTE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_ear_auto_switch_off_enable( enum switch_off_enable param )
  {
    ...
    old_value = SPIRead(SHORT_CIRCUIT_DETECTION_REG);
...
/*-CAP_2335_001*/
    ...
    SPIWrite(SHORT_CIRCUIT_DETECTION_REG, value);
...
unsigned char get_ear_auto_switch_off_enable()
  {
     ...
     * enabled 
     */ 
    value = (SPIRead(SHORT_CIRCUIT_DETECTION_REG) & SWITCH_OFF_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_ear_detection_enable()
  {
     ...
     * 1: Short circuit detected on EAR driver enabled 
     */ 
    value = (SPIRead(SHORT_CIRCUIT_DETECTION_REG) & EAR_DETECTION_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_headset_detection_enable()
  {
     ...
     * enabled 
     */ 
    value = (SPIRead(SHORT_CIRCUIT_DETECTION_REG) & HEADSET_DETECTION_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_headset_pull_down_enable()
  {
     ...
     * 0: HSL and HSR outputs are in high impedance 
     */ 
    value = (SPIRead(SHORT_CIRCUIT_DETECTION_REG) & HEADSET_PULL_DOWN_ENABLE_PARAM_MASK) >> 4;
    return value;
  }

/* +CAP_2335_001 */
/* removed functions
 * Function : set_hf_rigth_detection_enable
 * Function : get_hf_rigth_detection_enable
 * Function : set_vibrator2_detection_enable
 * Function : get_vibrator2_detection_enable
 * Function : set_vibrator1_detection_enable
 * Function : get_vibrator1_detection_enable
*/
/* -CAP_2335_001 */
...
unsigned char set_charge_pump_enable( enum charge_pump_enable param )
  {
    ...
    old_value = SPIRead(POWER_UP_HEAD_SET_REG);
    ...
    SPIWrite(POWER_UP_HEAD_SET_REG, value);
...
unsigned char get_charge_pump_enable()
  {
     ...
     * 1: Charge Pump enabled. 
     */ 
    value = (SPIRead(POWER_UP_HEAD_SET_REG) & CHARGE_PUMP_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_auto_headset_power_up_enable()
  {
     ...
     * enabled or disabled together or after ENCPHS. 
     */ 
    value = (SPIRead(POWER_UP_HEAD_SET_REG) & AUTO_HEADSET_POWER_PARAM_MASK);
    return value;
  }
...
unsigned char set_high_threshold( enum threshold param )
  {
    ...
    old_value = SPIRead(ENVELOPE_CONTROL_REG);

    /* 
     * High thresold for Charge Pump Low Voltage selection 
     */ 
  
    value =  old_value & ~THRESHOLD_PARAM_MASK;


     value |= ( param << 0x4);  
    SPIWrite(ENVELOPE_CONTROL_REG, value);
...
unsigned char get_high_threshold()
  {
     ...
     * High thresold for Charge Pump Low Voltage selection 
     */ 
    value = (SPIRead(ENVELOPE_CONTROL_REG) & THRESHOLD_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_low_threshold()
  {
     ...
     * Low thresold for Charge Pump Low Voltage selection 
     */ 
    value = (SPIRead(ENVELOPE_CONTROL_REG) & THRESHOLD_PARAM_MASK);
    return value;
  }
...
unsigned char set_input_voltage_control( enum input_voltage_control param )
  {
    ...
    old_value = SPIRead(ENVELOPE_THRESHOLD_REG);
    ...
    SPIWrite(ENVELOPE_THRESHOLD_REG, value);
...
unsigned char get_input_voltage_control()
  {
     ...
     * 1: SmpsVcphs ball supplies negative charge Pump. 
     */ 
    value = (SPIRead(ENVELOPE_THRESHOLD_REG) & INPUT_VOLTAGE_CONTROL_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_envelope_detection_c_p_enable()
  {
     ...
     * Envelope detection for charge pump 
     */ 
    value = (SPIRead(ENVELOPE_THRESHOLD_REG) & ENVELOPE_DETECTION_CP_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_envelope_decay_time()
  {
     ...
     * Low thresold for Charge Pump Low Voltage selection 
     */ 
    value = (SPIRead(ENVELOPE_THRESHOLD_REG) & DECAY_TIME_PARAM_MASK);
    return value;
  }
...
unsigned char set_vib1_controlled_internal( enum vib1 param )
  {
    ...
    old_value = SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG);
    ...
    SPIWrite(CONFIGURATION_CLASS_D_DRIVERS_REG, value);
...
unsigned char get_vib1_controlled_internal()
  {
     ...
     * 1: VIB1 driver is controlled by internal PWM Generator 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & VIB_1_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vib2_controlled_internal()
  {
     ...
     * 1: VIB2 driver is controlled by internal PWM Generator 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & VIB_2_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_pwm1_generator_control()
  {
     ...
     * started together (used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_1_STARTED_TOGETHER_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_pwm2_generator_control()
  {
     ...
     * started together (used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_2_STARTED_TOGETHER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_pwm1_generator_neg_enable()
  {
     ...
     * separatetly from positive (not used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_1_GENERATOR_NEGATIVE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_pwm1_generator_pos_enable()
  {
     ...
     * separatetly from negative (used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_1_GENERATOR_POSITIVE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_pwm2_generator_neg_enable()
  {
     ...
     * separatetly from positive (used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_2_GENERATOR_NEGATIVE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_pwm2_generator_pos_enable()
  {
     ...
     * separatetly from negative (used in differential) 
     */ 
    value = (SPIRead(CONFIGURATION_CLASS_D_DRIVERS_REG) & PWM_2_GENERATOR_POSITIVE_PARAM_MASK);
    return value;
  }
 ...
 *
 * Notes : From register 0x0D11, bits 7:7 CAP_2335_001
 *
 **************************************************************************/
unsigned char set_vib1_negative_pin_forced( enum forced_to_voltage param )
  {
    ...
    old_value = SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_1_REG);
    ...
    SPIWrite(CONFIGURATION_NEGATIVE_OUTPUT_VIB_1_REG, value);
...
unsigned char get_vib1_negative_pin_forced()
  {
     ...
     * 1: Vib1n pin is forced to VinVib voltage 
     */ 
    value = (SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_1_REG) & FORCED_TO_VOLTAGE_PARAM_MASK) >> 7;
    return value;
  }
 ...
 * RET  : Return the value of register ConfigurationNegativeOutputVib1
 *
 * Notes : From register 0x0D11, bits 6:0 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vib1_negative_duty_cyle()
  {
     ...
     * PWMPLDUTYCYCLE(6:0) 
     */ 
    value = (SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_1_REG) & DUTY_CYCLE_PARAM_MASK);
    return value;
  }
 ...
 *
 * Notes : From register 0x0D10, bits 7:7 CAP_2335_001
 *
 **************************************************************************/
unsigned char set_vib1_positive_forced_to_voltage( enum forced_to_voltage param )
  {
    ...
    old_value = SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_1_REG);
    ...
    SPIWrite(CONFIGURATION_POSITIVE_OUTPUT_VIB_1_REG, value);
...
unsigned char get_vib1_positive_forced_to_voltage()
  {
     ...
     * 1: Vib1p pin is forced to VinVib voltage 
     */ 
    value = (SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_1_REG) & FORCED_TO_VOLTAGE_PARAM_MASK) >> 7;
    return value;
  }
 ...
 * RET  : Return the value of register ConfigurationPositiveOutputVib1
 *
 * Notes : From register 0x0D10, bits 6:0 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vib1_positive_duty_cyle()
  {
     ...
     * PWMPLDUTYCYCLE(6:0) 
     */ 
    value = (SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_1_REG) & DUTY_CYCLE_PARAM_MASK);
    return value;
  }
 ...
 *
 * Notes : From register 0x0D13, bits 7:7 CAP_2335_001
 *
 **************************************************************************/
unsigned char set_vib2_negative_forced_to_voltage( enum forced_to_voltage param )
  {
    ...
    old_value = SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_2_REG);
    ...
    SPIWrite(CONFIGURATION_NEGATIVE_OUTPUT_VIB_2_REG, value);
...
unsigned char get_vib2_negative_forced_to_voltage()
  {
     ...
     * 1: Vib2p pin is forced to VinVib voltage 
     */ 
    value = (SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_2_REG) & FORCED_TO_VOLTAGE_PARAM_MASK) >> 7;
    return value;
  }
 ...
 * RET  : Return the value of register ConfigurationNegativeOutputVib2
 *
 * Notes : From register 0x0D13, bits 6:0 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vib2_negative_duty_cyle()
  {
     ...
     * PWMNRDUTYCYCLE(6:0) 
     */ 
    value = (SPIRead(CONFIGURATION_NEGATIVE_OUTPUT_VIB_2_REG) & DUTY_CYCLE_PARAM_MASK);
    return value;
  }
 ...
 *
 * Notes : From register 0x0D12, bits 7:7 CAP_2335_001
 *
 **************************************************************************/
unsigned char set_vib2_positive_forced_to_voltage( enum forced_to_voltage param )
  {
    ...
    old_value = SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_2_REG);
    ...
    SPIWrite(CONFIGURATION_POSITIVE_OUTPUT_VIB_2_REG, value);
...
unsigned char get_vib2_positive_forced_to_voltage()
  {
     ...
     * 1: Vib2p pin is forced to VinVib voltage 
     */ 
    value = (SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_2_REG) & FORCED_TO_VOLTAGE_PARAM_MASK) >> 7;
    return value;
  }
 ...
 * RET  : Return the value of register ConfigurationPositiveOutputVib2
 *
 * Notes : From register 0x0D12, bits 6:0 CAP_2335_001
 *
 **************************************************************************/
...
unsigned char get_vib2_positive_duty_cyle()
  {
     ...
     * PWMNRDUTYCYCLE(6:0) 
     */ 
    value = (SPIRead(CONFIGURATION_POSITIVE_OUTPUT_VIB_2_REG) & DUTY_CYCLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_mic1_single_ended_conf( enum single_or_differential param )
  {
    ...
    old_value = SPIRead(ANALOG_MIC_1_GAIN_REG);
    ...
    SPIWrite(ANALOG_MIC_1_GAIN_REG, value);
...
unsigned char get_mic1_single_ended_conf()
  {
     ...
     * 1: Single ended microphone is connected to MIC1 inputs 
     */ 
    value = (SPIRead(ANALOG_MIC_1_GAIN_REG) & SINGLE_OR_DIFFERENTIAL_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_low_power_micro1_enable( enum low_power_micro1_enable param )
  {
    ...
    switch( param )
      {
        case LOW_POWER_MICRO_1_DISABLE_E: 
           value = old_value & ~ LOW_POWER_MICRO_1_ENABLE_PARAM_MASK;
           break;
        case LOW_POWER_MICRO_1_ENABLE_E: 
           value = old_value | LOW_POWER_MICRO_1_ENABLE_PARAM_MASK; 
           break;
      }
...
unsigned char get_low_power_micro1_enable()
  {
     ...
     * New in cut 1.0 Low Power for Micro 1 
     */ 
    value = (SPIRead(ANALOG_MIC_1_GAIN_REG) & LOW_POWER_MICRO_1_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_mic1_gain()
  {
     ...
     * Microphone 1 channel Analog Gain 
     */ 
    value = (SPIRead(ANALOG_MIC_1_GAIN_REG) & ANALOG_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_mic2_single_ended_conf( enum single_or_differential param )
  {
    ...
    old_value = SPIRead(ANALOG_MIC_2_GAIN_REG);
    ...
    SPIWrite(ANALOG_MIC_2_GAIN_REG, value);
...
unsigned char get_mic2_single_ended_conf()
  {
     ...
     * 1: Single ended microphone is connected to MIC2 inputs 
     */ 
    value = (SPIRead(ANALOG_MIC_2_GAIN_REG) & SINGLE_OR_DIFFERENTIAL_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_low_power_micro2_enable( enum low_power_micro2_enable param )
  {
    ...
    switch( param )
      {
        case LOW_POWER_MICRO_2_DISABLE_E: 
           value = old_value & ~ LOW_POWER_MICRO_2_ENABLE_PARAM_MASK;
           break;
        case LOW_POWER_MICRO_2_ENABLE_E: 
           value = old_value | LOW_POWER_MICRO_2_ENABLE_PARAM_MASK; 
           break;
      }
...
unsigned char get_low_power_micro2_enable()
  {
     ...
     * New in cut 1.0 Low Power for Micro 2 
     */ 
    value = (SPIRead(ANALOG_MIC_2_GAIN_REG) & LOW_POWER_MICRO_2_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_mic2_gain()
  {
     ...
     * Microphone 1 channel Analog Gain 
     */ 
    value = (SPIRead(ANALOG_MIC_2_GAIN_REG) & ANALOG_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_left_headset_analog_gain( enum headset_analog_gain param )
  {
    ...
    old_value = SPIRead(LEFT_LINE_IN_GAIN_REG);
    ...
    value =  old_value & ~LEFT_HEADSET_ANALOG_GAIN_PARAM_MASK;
     ...
     value |= ( param << 0x4);  
    SPIWrite(LEFT_LINE_IN_GAIN_REG, value);
...
unsigned char get_left_headset_analog_gain()
  {
     ...
     * Left headset analog gain 
     */ 
    value = (SPIRead(LEFT_LINE_IN_GAIN_REG) & LEFT_HEADSET_ANALOG_GAIN_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_right_headset_analog_gain()
  {
     ...
     * Right headset analog gain 
     */ 
    value = (SPIRead(LEFT_LINE_IN_GAIN_REG) & RIGHT_HEADSET_ANALOG_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_left_line_analog_gain( enum line_in_gain param )
  {
    ...
    old_value = SPIRead(RIGHT_LINE_IN_GAIN_REG);
    ...
    value =  old_value & ~LEFT_LINE_ANALOG_GAIN_PARAM_MASK;
     ...
     value |= ( param << 0x4);  
    SPIWrite(RIGHT_LINE_IN_GAIN_REG, value);
...
unsigned char get_left_line_analog_gain()
  {
     ...
     * Gain for Left Line-In 
     */ 
    value = (SPIRead(RIGHT_LINE_IN_GAIN_REG) & LEFT_LINE_ANALOG_GAIN_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_right_line_analog_gain()
  {
     ...
     * Gain for Right Line-In 
     */ 
    value = (SPIRead(RIGHT_LINE_IN_GAIN_REG) & RIGHT_LINE_ANALOG_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_left_line_in_to_headset_gain( enum line_in_to_head_set param )
  {
    ...
    old_value = SPIRead(LEFT_LINE_IN_TO_HEADSET_GAIN_REG);
    ...
    value =  old_value & ~LEFT_LINE_IN_TO_HEADSET_GAIN_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(LEFT_LINE_IN_TO_HEADSET_GAIN_REG, value);
...
unsigned char get_left_line_in_to_headset_gain()
  {
     ...
     * Gain for Line-In Left to Headset loop 
     */ 
    value = (SPIRead(LEFT_LINE_IN_TO_HEADSET_GAIN_REG) & LEFT_LINE_IN_TO_HEADSET_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_right_line_in_to_headset_gain( enum line_in_to_head_set param )
  {
    ...
    old_value = SPIRead(RIGHT_LINE_IN_TO_HEADSET_GAIN_REG);
    ...
    value =  old_value & ~RIGHT_LINE_IN_TO_HEADSET_GAIN_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(RIGHT_LINE_IN_TO_HEADSET_GAIN_REG, value);
...
unsigned char get_right_line_in_to_headset_gain()
  {
     ...
     * Gain for Line-In Right to Headset loop 
     */ 
    value = (SPIRead(RIGHT_LINE_IN_TO_HEADSET_GAIN_REG) & RIGHT_LINE_IN_TO_HEADSET_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad1_offset_cancel_enable( enum ad1_offset_cancel param )
  {
    ...
    old_value = SPIRead(AUDIO_VOICE_FILTERS_REG);

    /* 
     * 0: AD1 Path with audio Offset Cancellation filter 
     * enabled; 
    ...
    SPIWrite(AUDIO_VOICE_FILTERS_REG, value);
...
unsigned char get_ad1_offset_cancel_enable()
  {
     ...
     * disabled 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD1_OFFSET_CANCEL_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_ad2_offset_cancel_enable( enum ad2_offset_cancel param )
  {
    ...
    /* 
     * 0: AD2 Path with audio Offset Cancellation filter 
     * enabled; 
...
unsigned char get_ad2_offset_cancel_enable()
  {
     ...
     * disabled 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD2_OFFSET_CANCEL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char set_ad3_offset_cancel_enable( enum ad3_offset_cancel param )
  {
    ...
    /* 
     * 0: AD3 Path with audio Offset Cancellation filter 
     * enabled; 
...
unsigned char get_ad3_offset_cancel_enable()
  {
     ...
     * disabled 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD3_OFFSET_CANCEL_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char set_ad4_offset_cancel_enable( enum ad4_offset_cancel param )
  {
    ...
    /* 
     * 0: AD4 Path with audio Offset Cancellation filter 
     * enabled; 
...
unsigned char get_ad4_offset_cancel_enable()
  {
     ...
     * disabled 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD4_OFFSET_CANCEL_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_ad1_voice_filter_enable()
  {
     ...
     * Voice 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD_1_VOICE_FILTER_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_ad2_voice_filter_enable()
  {
     ...
     * Voice 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD_2_VOICE_FILTER_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_ad3_voice_filter_enable()
  {
     ...
     * Voice 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD_3_VOICE_FILTER_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_ad4_voice_filter_enable()
  {
     ...
     * Voice 
     */ 
    value = (SPIRead(AUDIO_VOICE_FILTERS_REG) & AD_4_VOICE_FILTER_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char set_master0_mode_enable( enum master0_mode_enable param )
  {
    ...
    old_value = SPIRead(TDM_INTERFACE_REG);
    ...
    SPIWrite(TDM_INTERFACE_REG, value);
...
unsigned char get_master0_mode_enable()
  {
     ...
     * 1: The Master Generator for AUD_IF1/0 is active 
     */ 
    value = (SPIRead(TDM_INTERFACE_REG) & MASTER_0_MODE_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_bit_clock1()
  {
     ...
     * 128; 11: N = 256 
     */ 
    value = (SPIRead(TDM_INTERFACE_REG) & TDM_BIT_CLOCK_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_bit_clock1_enable()
  {
     ...
     * 1: The FSync1 and BitClk1 bits are enabled 
     */ 
    value = (SPIRead(TDM_INTERFACE_REG) & BIT_CLOCK_1_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_bit_clock0()
  {
     ...
     * 128; 11: N = 256 
     */ 
    value = (SPIRead(TDM_INTERFACE_REG) & TDM_BIT_CLOCK_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_bit_clock0_enable()
  {
     ...
     * 1: The FSync0 and BitClk0 bits are enabled 
     */ 
    value = (SPIRead(TDM_INTERFACE_REG) & BIT_CLOCK_0_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_first_slot0_synchro( enum first_slot_synchro0 param )
  {
    ...
    old_value = SPIRead(TDM_CONFIGURATION_REG);
    ...
    SPIWrite(TDM_CONFIGURATION_REG, value);
...
unsigned char get_first_slot0_synchro()
  {
     ...
     * falling edge 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_REG) & FIRST_SLOT_SYNCHRO_0_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_input0_bit_sampled()
  {
     ...
     * falling edge 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_REG) & INPUT_0_BIT_SAMPLED_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_if0_delayed()
  {
     ...
     * 1: IF0 format is delayed 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_REG) & DELAYED_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_if0_mode()
  {
     ...
     * 1: IF0 format is TDM, 1x: IF0 format is I2S Left Aligned 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_REG) & FORMAT_MODE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_if0_word_length()
  {
     ...
     * 11: IF0 Word Length is 32 bit 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_REG) & WORD_LENGTH_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_data0_to_ad_data1_enable( enum da_data0_to_ad_data1_enable param )
  {
    ...
    old_value = SPIRead(TDM_LOOPBACK_CONTROL_REG);
    ...
    SPIWrite(TDM_LOOPBACK_CONTROL_REG, value);
...
unsigned char get_da_data0_to_ad_data1_enable()
  {
     ...
     * 1: Data on DA_DATA0 pin is sent to AD_DATA1 pin 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & DA_DATA_0_TO_AD_DATA_1_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_if0_on_if1_enable()
  {
     ...
     * FSYNC1 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & IF_0_ON_IF_1_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_master_clock_if1_enable()
  {
     ...
     * 1: Pins FSync1 and BitClk1 are set as output 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & MASTER_CLOCK_IF_1_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_da_data1_to_ad_data0_enable()
  {
     ...
     * 1: Data on DA_DATA1 pin is sent to AD_DATA0 pin 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & DA_DATA_1_TO_AD_DATA_0_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_if1_on_if0_enable()
  {
     ...
     * FSYNC0 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & IF_1_ON_IF_0_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_master_clock_if0_enable()
  {
     ...
     * 1: Pins FSync0 and BitClk0 are set as output 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & MASTER_CLOCK_IF_0_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_burst_mode_enable()
  {
     ...
     * 1: TDM Interface IF0 is configured in burst mode 
     */ 
    value = (SPIRead(TDM_LOOPBACK_CONTROL_REG) & BURST_MODE_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_first_slot1_synchro( enum first_slot_synchro0 param )
  {
    ...
    old_value = SPIRead(TDM_CONFIGURATION_1_REG);
    ...
    SPIWrite(TDM_CONFIGURATION_1_REG, value);
...
unsigned char get_first_slot1_synchro()
  {
     ...
     * falling edge 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_1_REG) & FIRST_SLOT_SYNCHRO_0_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_input1_bit_sampled()
  {
     ...
     * falling edge 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_1_REG) & INPUT_1_BIT_SAMPLED_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_if1_delayed()
  {
     ...
     * 1: IF1 format is delayed 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_1_REG) & DELAYED_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_if1_mode()
  {
     ...
     * 1: IF1 format is TDM, 1x: IF1 format is I2S Left Aligned 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_1_REG) & FORMAT_MODE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_if1_word_length()
  {
     ...
     * 11: IF1 Word Length is 32 bit 
     */ 
    value = (SPIRead(TDM_CONFIGURATION_1_REG) & WORD_LENGTH_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output0( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_0_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_0_REG, value);
...
unsigned char get_slot_output0()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_0_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output1( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_1_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_1_REG, value);
...
unsigned char get_slot_output1()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_1_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output2( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_2_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_2_REG, value);
...
unsigned char get_slot_output2()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_2_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output3( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_3_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_3_REG, value);
...
unsigned char get_slot_output3()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_3_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output4( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_4_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_4_REG, value);
...
unsigned char get_slot_output4()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_4_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output5( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_5_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_5_REG, value);
...
unsigned char get_slot_output5()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_5_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output6( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_6_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_6_REG, value);
...
unsigned char get_slot_output6()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_6_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output7( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_7_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_7_REG, value);
...
unsigned char get_slot_output7()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_7_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output8( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_8_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_8_REG, value);
...
unsigned char get_slot_output8()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_8_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output9( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_9_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_9_REG, value);
...
unsigned char get_slot_output9()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_9_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output10( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_10_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_10_REG, value);
...
unsigned char get_slot_output10()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_10_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output11( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_11_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_11_REG, value);
...
unsigned char get_slot_output11()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_11_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output12( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_12_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_12_REG, value);
...
unsigned char get_slot_output12()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_12_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output13( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_13_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_13_REG, value);
...
unsigned char get_slot_output13()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_13_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output14( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_14_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_14_REG, value);
...
unsigned char get_slot_output14()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_14_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output15( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_15_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_15_REG, value);
...
unsigned char get_slot_output15()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_15_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output16( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_16_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_16_REG, value);
...
unsigned char get_slot_output16()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_16_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output17( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_17_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_17_REG, value);
...
unsigned char get_slot_output17()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_17_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output18( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_18_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_18_REG, value);
...
unsigned char get_slot_output18()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_18_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output19( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_19_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_19_REG, value);
...
unsigned char get_slot_output19()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_19_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output20( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_20_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_20_REG, value);
...
unsigned char get_slot_output20()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_20_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output21( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_21_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_21_REG, value);
...
unsigned char get_slot_output21()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_21_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output22( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_22_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_22_REG, value);
...
unsigned char get_slot_output22()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_22_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output23( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_23_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_23_REG, value);
...
unsigned char get_slot_output23()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_23_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output24( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_24_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_24_REG, value);
...
unsigned char get_slot_output24()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_24_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output25( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_25_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_25_REG, value);
...
unsigned char get_slot_output25()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_25_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output26( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_26_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_26_REG, value);
...
unsigned char get_slot_output26()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_26_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output27( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_27_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_27_REG, value);
...
unsigned char get_slot_output27()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_27_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output28( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_28_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_28_REG, value);
...
unsigned char get_slot_output28()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_28_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output29( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_29_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_29_REG, value);
...
unsigned char get_slot_output29()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_29_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_output30( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_30_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_30_REG, value);
...
unsigned char get_slot_output30()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_30_REG) & SLOT_OUTPUT_PARAM_MASK);
    return value;
  }
...
unsigned char set_slot_output31( enum slot_output param )
  {
    ...
    old_value = SPIRead(SLOT_ALLOCATION_31_REG);
    ...
    SPIWrite(SLOT_ALLOCATION_31_REG, value);
...
unsigned char get_slot_output31()
  {
     ...
     * Slot Output State 
     */ 
    value = (SPIRead(SLOT_ALLOCATION_31_REG) & SLOT_OUTPUT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_slot_hiz0( enum slot_hiz param )
  {
    ...
    old_value = SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG);
    ...
    SPIWrite(A_DSLOT_TRISTATE_CONTROL_0_REG, value);
...
unsigned char get_slot_hiz0()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_0_PARAM_MASK);
    return value;
  }
...
unsigned char get_slot_hiz1()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_1_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_slot_hiz2()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_2_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_slot_hiz3()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_3_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_slot_hiz4()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_4_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_slot_hiz5()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_5_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_hiz6()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_6_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_slot_hiz7()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_0_REG) & SLOT_HIZ_7_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_slot_hiz8( enum slot_hiz param )
  {
    ...
    old_value = SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG);
    ...
    SPIWrite(A_DSLOT_TRISTATE_CONTROL_1_REG, value);
...
unsigned char get_slot_hiz8()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_8_PARAM_MASK);
    return value;
  }
...
unsigned char get_slot_hiz9()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_9_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_slot_hiz10()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_10_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_slot_hiz11()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_11_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_slot_hiz12()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_12_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_slot_hiz13()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_13_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_hiz14()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_14_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_slot_hiz15()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_1_REG) & SLOT_HIZ_15_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_slot_hiz16( enum slot_hiz param )
  {
    ...
    old_value = SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG);
    ...
    SPIWrite(A_DSLOT_TRISTATE_CONTROL_2_REG, value);
...
unsigned char get_slot_hiz16()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_16_PARAM_MASK);
    return value;
  }
...
unsigned char get_slot_hiz17()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_17_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_slot_hiz18()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_18_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_slot_hiz19()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_19_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_slot_hiz20()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_20_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_slot_hiz21()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_21_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_hiz22()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_22_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_slot_hiz23()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_2_REG) & SLOT_HIZ_23_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_slot_hiz24( enum slot_hiz param )
  {
    ...
    old_value = SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG);
    ...
    SPIWrite(A_DSLOT_TRISTATE_CONTROL_3_REG, value);
...
unsigned char get_slot_hiz24()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_24_PARAM_MASK);
    return value;
  }
...
unsigned char get_slot_hiz25()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_25_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_slot_hiz26()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_26_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_slot_hiz27()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_27_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_slot_hiz28()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_28_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_slot_hiz29()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_29_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_hiz30()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_30_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_slot_hiz31()
  {
     ...
     * Slot impedance after last half-lsb 
     */ 
    value = (SPIRead(A_DSLOT_TRISTATE_CONTROL_3_REG) & SLOT_HIZ_31_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_da12_voice_filter_enable( enum da12_voice_filter_enable param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_1_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_1_REG, value);
...
unsigned char get_da12_voice_filter_enable()
  {
     ...
     * Filters for Voice 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_1_REG) & DA_12_VOICE_FILTER_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_swap12_34()
  {
     ...
     * Swap chanel 1&2 with 3&4 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_1_REG) & SWAP_1234_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da_in7_to_adout1()
  {
     ...
     * 1: DA_IN7 is looped back to AD_OUT1 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_1_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp01()
  {
     ...
     * Data sent to DA1 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_1_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_in8_to_adout2( enum da_in_to_ad_out param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_2_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_2_REG, value);
...
unsigned char get_da_in8_to_adout2()
  {
     ...
     * 1: DA_IN8 is looped back to AD_OUT2 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_2_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp02()
  {
     ...
     * Data sent to DA2 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_2_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da34_voice_filter_enable( enum da34_voice_filter_enable param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_3_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_3_REG, value);
...
unsigned char get_da34_voice_filter_enable()
  {
     ...
     * Filters for Voice 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_3_REG) & DA_34_VOICE_FILTER_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_da_in7_to_adout3()
  {
     ...
     * 1: DA_IN7 is looped back to AD_OUT3 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_3_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp03()
  {
     ...
     * Data sent to DA3 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_3_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_in8_to_adout4( enum da_in_to_ad_out param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_4_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_4_REG, value);
...
unsigned char get_da_in8_to_adout4()
  {
     ...
     * 1: DA_IN8 is looped back to AD_OUT4 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_4_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp04()
  {
     ...
     * Data sent to DA4 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_4_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da56_voice_filter_enable( enum da56_voice_filter_enable param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_5_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_5_REG, value);
...
unsigned char get_da56_voice_filter_enable()
  {
     ...
     * Filters for Voice 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_5_REG) & DA_56_VOICE_FILTER_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_da_in7_to_adout5()
  {
     ...
     * 1: DA_IN7 is looped back to AD_OUT5 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_5_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp05()
  {
     ...
     * Data sent to DA5 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_5_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_in8_to_adout6( enum da_in_to_ad_out param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_6_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_6_REG, value);
...
unsigned char get_da_in8_to_adout6()
  {
     ...
     * 1: DA_IN8 is looped back to AD_OUT6 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_6_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp06()
  {
     ...
     * Data sent to DA6 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_6_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_in8_to_adout7( enum da_in_to_ad_out param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_7_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_7_REG, value);
...
unsigned char get_da_in8_to_adout7()
  {
     ...
     * 1: DA_IN8 is looped back to AD_OUT7 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_7_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp07()
  {
     ...
     * Data sent to DA7 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_7_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_da_in8_to_adout8( enum da_in_to_ad_out param )
  {
    ...
    old_value = SPIRead(SLOT_SELECTION_DA_PATH_8_REG);
    ...
    SPIWrite(SLOT_SELECTION_DA_PATH_8_REG, value);
...
unsigned char get_da_in8_to_adout8()
  {
     ...
     * 1: DA_IN8 is looped back to AD_OUT6 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_8_REG) & DA_IN_TO_AD_OUT_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_slot_dsp08()
  {
     ...
     * Data sent to DA8 input of DA filter (DSP) 
     */ 
    value = (SPIRead(SLOT_SELECTION_DA_PATH_8_REG) & SLOT_DSP_PARAM_MASK);
    return value;
  }
...
unsigned char set_hf_output_bridged_enable( enum hf_output_bridged_enable param )
  {
    ...
    old_value = SPIRead(CLASS_DEMI_CONTROL_REG);
    ...
    SPIWrite(CLASS_DEMI_CONTROL_REG, value);
...
unsigned char get_hf_output_bridged_enable()
  {
     ...
     * used for both 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & HF_OUTPUT_BRIDGED_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vrib_output_bridged_enable()
  {
     ...
     * used for both 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & VRIB_OUTPUT_BRIDGED_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_low_emi_mode_vib1_enable()
  {
     ...
     * 0: Low EMI mode for VIB1 enabled. 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & LOW_EMI_MODE_VIB_1_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_low_emi_mode_vib2_enable()
  {
     ...
     * 0: Low EMI mode for VIB2 enabled. 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & LOW_EMI_MODE_VIB_2_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_low_emi_mode_hf_left_enable()
  {
     ...
     * 0: Low EMI mode for HFL enabled. 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & LOW_EMI_MODE_HF_LEFT_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_low_emi_mode_hf_right_enable()
  {
     ...
     * 0: Low EMI mode for HFR enabled. 
     */ 
    value = (SPIRead(CLASS_DEMI_CONTROL_REG) & LOW_EMI_MODE_HF_RIGHT_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_class_d_fir_bypass( enum class__d__fir_bypass param )
  {
    ...
    old_value = SPIRead(CLASS_D_PATH_REG);
    ...
    SPIWrite(CLASS_D_PATH_REG, value);
...
unsigned char get_class_d_fir_bypass()
  {
     ...
     * 1xxx: Right Vibra PWM FIR filter is bypassed 
     */ 
    value = (SPIRead(CLASS_D_PATH_REG) & CLASS_D_FIR_BYPASS_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_high_volume()
  {
     ...
     * Vibra2 channel in high volume mode 
     */ 
    value = (SPIRead(CLASS_D_PATH_REG) & HIGH_VOLUME_PARAM_MASK);
    return value;
  }
...
unsigned char set_high_pass_component_dither( unsigned char param )
  {
    ...
    old_value = SPIRead(CLASS_D_CONTROL_GAIN_REG);
    ...
    SPIWrite(CLASS_D_CONTROL_GAIN_REG, value);
...
unsigned char get_high_pass_component_dither()
  {
     ...
     * Gain control for the high pass component of dither 
     */ 
    value = (SPIRead(CLASS_D_CONTROL_GAIN_REG) & HIGH_PASS_COMPONENT_DITHER_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char set_highwhite_component_dither( unsigned char param )
  {
    ...
    value =  old_value & ~HIGHWHITE_COMPONENT_DITHER_PARAM_MASK;
...
unsigned char get_highwhite_component_dither()
  {
     ...
     * Gain control for the white component of dither 
     */ 
    value = (SPIRead(CLASS_D_CONTROL_GAIN_REG) & HIGHWHITE_COMPONENT_DITHER_PARAM_MASK);
    return value;
  }
...
unsigned char set_anc_input( enum anc_input param )
  {
    ...
    old_value = SPIRead(DECIMATOR_FILTER_REG);
    ...
    SPIWrite(DECIMATOR_FILTER_REG, value);
...
unsigned char get_anc_input()
  {
     ...
     * 1: ANC input is AD5 
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & ANC_INPUT_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_decimator_mic1()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_1_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_decimator_mic2()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_2_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_decimator_mic3()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_3_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_decimator_mic4()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_4_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_decimator_mic5()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_5_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_decimator_mic6()
  {
     ...
     */ 
    value = (SPIRead(DECIMATOR_FILTER_REG) & DECIMATOR_MIC_6_PARAM_MASK);
    return value;
  }
...
unsigned char set_output_digital_in1( enum path_in1 param )
  {
    ...
    old_value = SPIRead(DIGITAL_MULTIPLEXERS_REG);
    ...
    SPIWrite(DIGITAL_MULTIPLEXERS_REG, value);
...
unsigned char get_output_digital_in1()
  {
     ...
     * 1: DA_IN1 path mixed together with sidetone FIR. 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & PATH_IN_1_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_output_digital_in2()
  {
     ...
     * 1: DA_IN2 path mixed together with sidetone FIR. 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & PATH_IN_2_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_dig_micro1_for_out1()
  {
     ...
     * output path 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & DIG_MICRO_1_FOR_OUT_1_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_dig_micro2_for_out2()
  {
     ...
     * output path 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & DIG_MICRO_2_FOR_OUT_2_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_dig_micro3_for_out3()
  {
     ...
     * output path 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & DIG_MICRO_3_FOR_OUT_3_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_dig_micro5_for_out5()
  {
     ...
     * output path 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & DIG_MICRO_5_FOR_OUT_5_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_dig_micro6_for_out6()
  {
     ...
     * output path 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & DIG_MICRO_6_FOR_OUT_6_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_anc_loop_mixed()
  {
     ...
     * 1: ANC loop mixed in earpiece driver. 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_REG) & ANC_LOOP_MIXED_PARAM_MASK);
    return value;
  }
...
unsigned char set_da4_or_anc_loop_path( enum da4_or_anc_mixing_enable param )
  {
    ...
    old_value = SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG);
    ...
    SPIWrite(DIGITAL_MULTIPLEXERS_MSB_REG, value);
...
unsigned char get_da4_or_anc_loop_path()
  {
     ...
     * 1: DA4 or ANC path to HfR is enabled 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & DA_4_OR_ANC_MIXING_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_da3_or_anc_loop_path()
  {
     ...
     * 1: DA3 or ANC path to HfL is enabled 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & DA_3_OR_ANC_MIXING_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da4_mixing_enable()
  {
     ...
     * 1: HFR data comes from ANC if DAToHfREn= 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & DA_4_MIXING_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_da3_mixing_enable()
  {
     ...
     * 1: HFL data comes from ANC if DAToHfLEn=1 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & DA_3_MIXING_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_fir1_selection()
  {
     ...
     * 11: FIR1 data comes from DA_IN1 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & SELECTION_FIR_1_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_fir2_selection()
  {
     ...
     * 11: FIR2 data comes from DA_IN2 
     */ 
    value = (SPIRead(DIGITAL_MULTIPLEXERS_MSB_REG) & SELECTION_FIR_2_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad1_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD1_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD1_REG, value);
...
unsigned char get_ad1_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD1 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD1_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad1_gain()
  {
     ...
     * AD1 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD1_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad2_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD2_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD2_REG, value);
...
unsigned char get_ad2_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD2 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD2_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad2_gain()
  {
     ...
     * AD2 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD2_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad3_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD3_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD3_REG, value);
...
unsigned char get_ad3_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD3 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD3_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad3_gain()
  {
     ...
     * AD3 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD3_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad4_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD4_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD4_REG, value);
...
unsigned char get_ad4_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD4 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD4_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad4_gain()
  {
     ...
     * AD4 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD4_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad5_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD5_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD5_REG, value);
...
unsigned char get_ad5_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD5 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD5_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad5_gain()
  {
     ...
     * AD5 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD5_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad6_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD6_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD6_REG, value);
...
unsigned char get_ad6_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD6 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD6_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad6_gain()
  {
     ...
     * AD6 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD6_REG) & DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da1_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA_1_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA_1_REG, value);
...
unsigned char get_da1_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA1 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_1_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da1_gain()
  {
     ...
     * DA1 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_1_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da2_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA_2_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA_2_REG, value);
...
unsigned char get_da2_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA2 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_2_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da2_gain()
  {
     ...
     * DA2 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_2_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da3_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA_3_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA_3_REG, value);
...
unsigned char get_da3_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA3 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_3_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da3_gain()
  {
     ...
     * DA3 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_3_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da4_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA_4_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA_4_REG, value);
...
unsigned char get_da4_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA4 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_4_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da4_gain()
  {
     ...
     * DA4 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_4_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da5_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA_5_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA_5_REG, value);
...
unsigned char get_da5_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA5 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_5_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da5_gain()
  {
     ...
     * DA5 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA_5_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_da6_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_DA6_REG);
    ...
    SPIWrite(DIGITAL_GAIN_DA6_REG, value);
...
unsigned char get_da6_anti_click()
  {
     ...
     * 1: Fading (anti-click) on DA6 path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA6_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_da6_gain()
  {
     ...
     * DA6 path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_DA6_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad1_hfl_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD1HFL_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD1HFL_REG, value);
...
unsigned char get_ad1_hfl_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD1_HFL path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD1HFL_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad1_hfl_gain()
  {
     ...
     * AD1_HFL path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD1HFL_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_ad2_hfr_r_anti_click( enum fading param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_AD2HFR_REG);
    ...
    SPIWrite(DIGITAL_GAIN_AD2HFR_REG, value);
...
unsigned char get_ad2_hfr_r_anti_click()
  {
     ...
     * 1: Fading (anti-click) on AD2_HFR path is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD2HFR_REG) & FADING_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ad2_hfr_gain()
  {
     ...
     * AD2_HFR path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_AD2HFR_REG) & DA_DIGITAL_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_sinc1_interpolator( enum sinc1_interpolator_enable param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_HEADSET_LEFT_REG);
    ...
    SPIWrite(DIGITAL_GAIN_HEADSET_LEFT_REG, value);
...
unsigned char get_sinc1_interpolator()
  {
     ...
     * driver. 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_LEFT_REG) & SINC_1_INTERPOLATOR_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_fading_headset_left()
  {
     ...
     * 1: Fading (anti-click) on HFL digital gain is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_LEFT_REG) & FADING_HEADSET_LEFT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_left_headset_gain()
  {
     ...
     * HSL or Earpiece path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_LEFT_REG) & HEADSET_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_headset_fade_speed( enum headset_fade_speed param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_HEADSET_RIGHT_REG);
    ...
    SPIWrite(DIGITAL_GAIN_HEADSET_RIGHT_REG, value);
...
unsigned char get_headset_fade_speed()
  {
     ...
     * digital gain controls 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_RIGHT_REG) & HEADSET_FADE_SPEED_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_fading_headset_right()
  {
     ...
     * 1: Fading (anti-click) on HFR digital gain is disabled 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_RIGHT_REG) & FADING_HEADSET_RIGHT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_right_headset_gain()
  {
     ...
     * Headset Rigth path digital gain 
     */ 
    value = (SPIRead(DIGITAL_GAIN_HEADSET_RIGHT_REG) & HEADSET_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_digital_gain_side_tone1( enum digital_gain_side_tone param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_SIDE_TONE_1_REG);
    ...
    value =  old_value & ~DIGITAL_GAIN_SIDE_TONE_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(DIGITAL_GAIN_SIDE_TONE_1_REG, value);
...
unsigned char get_digital_gain_side_tone1()
  {
     ...
     * Digital gain for side tone 1 path. 
     */ 
    value = (SPIRead(DIGITAL_GAIN_SIDE_TONE_1_REG) & DIGITAL_GAIN_SIDE_TONE_PARAM_MASK);
    return value;
  }
...
unsigned char set_digital_gain_side_tone2( enum digital_gain_side_tone param )
  {
    ...
    old_value = SPIRead(DIGITAL_GAIN_SIDE_TONE_2_REG);
    ...
    value =  old_value & ~DIGITAL_GAIN_SIDE_TONE_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(DIGITAL_GAIN_SIDE_TONE_2_REG, value);
...
unsigned char get_digital_gain_side_tone2()
  {
     ...
     * Digital gain for side tone 2 path. 
     */ 
    value = (SPIRead(DIGITAL_GAIN_SIDE_TONE_2_REG) & DIGITAL_GAIN_SIDE_TONE_PARAM_MASK);
    return value;
  }
...
unsigned char set_anc_operation_enable( enum anc_operation_enable param )
  {
    ...
    old_value = SPIRead(ANC_DIGITAL_GAIN_REG);

    /* 
     * 0: ANC operation are disabled.1: ANC operation are 
     * enabled 
     */ 
    switch( param )
      {
    ...
    SPIWrite(ANC_DIGITAL_GAIN_REG, value);
...
unsigned char get_anc_operation_enable()
  {
     ...
     * enabled 
     */ 
    value = (SPIRead(ANC_DIGITAL_GAIN_REG) & ANC_OPERATION_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_iir_status()
  {
     ...
     * 1: Indicate the start of IIR initialization 
     */ 
    value = (SPIRead(ANC_DIGITAL_GAIN_REG) & IIR_STATUS_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char set_fir_coefficient_pointer( enum fir_coefficient_pointer param )
  {
     ...
     * coefficient pointer is removed from reset. 
     */ 
    switch( param )
      {
...
unsigned char get_fir_coefficient_pointer()
  {
     ...
     * coefficient pointer is removed from reset. 
     */ 
    value = (SPIRead(ANC_DIGITAL_GAIN_REG) & FIR_COEFFICIENT_POINTER_PARAM_MASK);
    return value;
  }
...
unsigned char set_warped_shift_in( enum dig_anc_step_gain param )
  {
    ...
    old_value = SPIRead(WARPED_DELAY_LINE_REG);
    ...
    value =  old_value & ~DIG_ANC_STEP_GAIN_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(WARPED_DELAY_LINE_REG, value);
...
unsigned char get_warped_shift_in()
  {
     ...
     * Digital gain for Warped Delay Line input. 
     */ 
    value = (SPIRead(WARPED_DELAY_LINE_REG) & DIG_ANC_STEP_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_fir_shift_out( enum dig_anc_step_gain param )
  {
    ...
    old_value = SPIRead(GAIN_FOR_FIR_OUTPUT_REG);
    ...
    value =  old_value & ~DIG_ANC_STEP_GAIN_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(GAIN_FOR_FIR_OUTPUT_REG, value);
...
unsigned char get_fir_shift_out()
  {
     ...
     * Digital gain for FIR output filter. 
     */ 
    value = (SPIRead(GAIN_FOR_FIR_OUTPUT_REG) & DIG_ANC_STEP_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_iir_shift_out( enum dig_anc_step_gain param )
  {
    ...
    old_value = SPIRead(GAIN_FOR_IRR_OUTPUT_REG);
    ...
    value =  old_value & ~DIG_ANC_STEP_GAIN_PARAM_MASK;
     ...
     value |=  param ;  
    SPIWrite(GAIN_FOR_IRR_OUTPUT_REG, value);
...
unsigned char get_iir_shift_out()
  {
     ...
     * ANC digital gain for IIR output. 
     */ 
    value = (SPIRead(GAIN_FOR_IRR_OUTPUT_REG) & DIG_ANC_STEP_GAIN_PARAM_MASK);
    return value;
  }
...
unsigned char set_anc_fir_coeff_msb( unsigned char param )
  {
     ...
     */ 
    SPIWrite(ANC_FIR_COEFF_MSB_REG, param);
    return 0;
...
unsigned char get_anc_fir_coeff_msb()
  {
     ...
     * ANCFIRCoeffLSB[7:0] for details. 
     */ 
    value = SPIRead(ANC_FIR_COEFF_MSB_REG) ;
    return value;
  }
...
unsigned char set_anc_fir_coeff_lsb( unsigned char param )
  {
     ...
     * whole bank is applied when the last coefficient is 
     * written. The whole bank must be written with 
     * ANCFIRUpDATE=1, when it is set to zero the coefficient 
     * pointer is reset and the bank update can start again. 
     */ 
    SPIWrite(ANC_FIR_COEFF_LSB_REG, param);
    return 0;
...
unsigned char get_anc_fir_coeff_lsb()
  {
     ...
     * pointer is reset and the bank update can start again. 
     */ 
    value = SPIRead(ANC_FIR_COEFF_LSB_REG) ;
    return value;
  }
...
unsigned char set_anc_iir_coeff_msb( unsigned char param )
  {
     ...
     */ 
    SPIWrite(ANC_IIR_COEFF_MSB_REG, param);
    return 0;
...
unsigned char get_anc_iir_coeff_msb()
  {
     ...
     * just when the LSB part is written. 
     */ 
    value = SPIRead(ANC_IIR_COEFF_MSB_REG) ;
    return value;
  }
...
unsigned char set_anc_iir_coeff_lsb( unsigned char param )
  {
    ...
    /* 
     * ANC IIR filter coefficient LSB part. Sets the LSB of the 
     * ANC IIR coefficients, it updates the 16 bits coefficient 
     * and it increases the 
     */ 
    SPIWrite(ANC_IIR_COEFF_LSB_REG, param);
    return 0;
...
unsigned char get_anc_iir_coeff_lsb()
  {
     ...
     * and it increases the 
     */ 
    value = SPIRead(ANC_IIR_COEFF_LSB_REG) ;
    return value;
  }
...
unsigned char set_anc_warp_delay_msb( unsigned char param )
  {
    ...
    value = SPIRead(ANC_WARP_DELAY_MSB_REG);

    /* 
     * ANC Warp delay filter coefficient MSB part. Written of 
     * the LSB part will update the whole coefficient. 
     */ 
    SPIWrite(ANC_WARP_DELAY_MSB_REG, param);
    return value;
...
unsigned char set_anc_warp_delay_lsb( unsigned char param )
  {
    ...
    value = SPIRead(ANC_WARP_DELAY_LSB_REG);

    /* 
     * ANC Warp delay filter coefficient LSB part. Written of 
     * the LSB part will update the whole coefficient. 
     */ 
    SPIWrite(ANC_WARP_DELAY_LSB_REG, param);
    return value;
...
unsigned char get_anc_fir_peak_msb()
  {
    ...
    /* 
     * Monitor of ANC FIR output. MSB part. 
     */ 
    value = SPIRead(ANC_FIR_PEAK_MSB_REG) ;
    return value;
  }
...
unsigned char get_anc_fir_peak_lsb()
  {
    ...
    /* 
     * Monitor of ANC FIR output. LSB part. 
     */ 
    value = SPIRead(ANC_FIR_PEAK_LSB_REG) ;
    return value;
  }
...
unsigned char get_anc_iir_peak_msb()
  {
    ...
    /* 
     * The peak value of ANC IIR output. MSB part. 
     */ 
    value = SPIRead(ANC_IIR_PEAK_MSB_REG) ;
    return value;
  }
...
unsigned char get_anc_iir_peak_lsb()
  {
    ...
    /* 
     * The peak value of ANC IIR output. LSB part. 
     */ 
    value = SPIRead(ANC_IIR_PEAK_LSB_REG) ;
    return value;
  }
...
unsigned char get_side_tone_control()
  {
     ...
     */ 
    value = (SPIRead(SIDE_TONE_CONTROL_REG) & SIDE_TONE_CONTROL_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_address_coefficient()
  {
     ...
     * written 
     */ 
    value = (SPIRead(SIDE_TONE_CONTROL_REG) & ADDRESS_COEFFOCIENT_PARAM_MASK);
    return value;
  }
...
unsigned char set_side_tone_coff_msb( unsigned char param )
  {
    ...
    value = SPIRead(SIDE_TONE_COFF_MSB_REG);
     ...
     */ 
    SPIWrite(SIDE_TONE_COFF_MSB_REG, param);
    return value;
...
unsigned char set_side_tone_coff_lsb( unsigned char param )
  {
    ...
    value = SPIRead(SIDE_TONE_COFF_LSB_REG);
     ...
     * STFIR_SET bit is set 
     */ 
    SPIWrite(SIDE_TONE_COFF_LSB_REG, param);
    return value;
...
unsigned char set_fir_filters_enable( enum fir_filters_enable param )
  {
    ...
    old_value = SPIRead(FIR_FILTERS_CONTROL_REG);
    ...
    SPIWrite(FIR_FILTERS_CONTROL_REG, value);
...
unsigned char get_fir_filters_enable()
  {
     ...
     * 1: ST FIR Filters are enabled. 
     */ 
    value = (SPIRead(FIR_FILTERS_CONTROL_REG) & FIR_FILTERS_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_fir_data_rate()
  {
     ...
     * rate. 
     */ 
    value = (SPIRead(FIR_FILTERS_CONTROL_REG) & FIR_DATA_RATE_PARAM_MASK) >> 1;
    return value;
  }
 ...
 *
 * IN   : param, a value to write to the regiter FirFiltersStatus
 * OUT  : 
 *
 * RET  : Return the value of register FirFiltersStatus
 *
...
unsigned char set_fir_busy( enum fir_busy param )
  {
    ...
    old_value = SPIRead(FIR_FILTERS_STATUS_REG);
    ...
    SPIWrite(FIR_FILTERS_STATUS_REG, value);
...
unsigned char get_fir_busy()
  {
     ...
     * 1: The new ST FIR coefficients are not applied yet. 
     */ 
    value = (SPIRead(FIR_FILTERS_STATUS_REG) & FIR_BUSY_PARAM_MASK);
    return value;
  }
...
unsigned char set_interrupt_hs_offset_status_enable( unsigned char param )
  {
    ...
    old_value = SPIRead(INTERRUPT_ENABLE_0_REG);
    ...
    value =  old_value & ~HS_OFFSET_STATUS_PARAM_MASK;
     ...
     param |= (value << 0x7);  
    SPIWrite(INTERRUPT_ENABLE_0_REG, value);
...
unsigned char get_interrupt_hs_offset_status_enable()
  {
     ...
     * 1:Bit IT_HsOffSt can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & HS_OFFSET_STATUS_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_interrupt_buffer_full_enable()
  {
     ...
     * 1: Bit BFIFULL_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & BUFFER_FULL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_interrupt_buffer_empty_enable()
  {
     ...
     * 1: Bit BFIEMPT_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & BUFFER_EMPTY_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_interrupt_da_chan_enable()
  {
     ...
     * 1: Bit DACHAN_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & DA_CHAN_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_interrupt_gain_enable()
  {
     ...
     * 1: Bit GAIN_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & GAIN_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_interrupt_dsp_af_enable()
  {
     ...
     * 1: Bit DSPAD_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & DSP_AD_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_interrupt_dsp_dz_enable()
  {
     ...
     * 1: Bit DSPDA_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & DSP_DA_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_interrupt_fir_enable()
  {
     ...
     * 1: Bit FIR_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_0_REG) & FIR_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_interrupt_status0()
  {
     ...
     * InterruptStatus 
     */ 
    value = SPIRead(INTERRUPT_STATUS_0_REG) ;
    return value;
  }
...
unsigned char set_interrupt_hs_offset_status( unsigned char param )
  {
    ...
    old_value = SPIRead(INTERRUPT_STATUS_0_REG);
    ...
    value =  old_value & ~HS_OFFSET_STATUS_PARAM_MASK;
     ...
     param |= (value << 0x7);  
    SPIWrite(INTERRUPT_STATUS_0_REG, value);
...
unsigned char get_interrupt_hs_offset_status()
  {
     ...
     * 1:Bit IT_HsOffSt can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & HS_OFFSET_STATUS_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_status_buffer_full()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_BUFFER_FULL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_status_buffer_empty()
  {
     ...
     * occured. 
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_BUFFER_EMPTY_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_status_da_chan()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_DA_CHAN_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_status_gain()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_GAIN_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_status_dsp_ad()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_DSP_AD_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_status_dsp_da()
  {
     ...
     * 1: Bit DSPDA_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_DSP_DA_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_status_fir()
  {
     ...
     * 1: Bit FIR_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_STATUS_0_REG) & STATUS_FIR_PARAM_MASK);
    return value;
  }
...
unsigned char set_interrupt_vss_ready( enum interrupt_vss_ready_enable param )
  {
    ...
    old_value = SPIRead(INTERRUPT_ENABLE_1_REG);
    ...
    SPIWrite(INTERRUPT_ENABLE_1_REG, value);
...
unsigned char get_interrupt_vss_ready()
  {
     ...
     * 1: Bit BFIFULL_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_1_REG) & INTERRUPT_VSS_READY_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_interrupt_short_circuit_detected_hsl()
  {
     ...
     * 1: Bit SHRTHSL_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_1_REG) & INTERRUPT_SHORT_CIRCUIT_HSL_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_interrupt_short_circuit_detected_hsr()
  {
     ...
     * 1: Bit SHRTHSR_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_1_REG) & INTERRUPT_SHORT_CIRCUIT_HSR_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_interrupt_short_circuit_detected_ear()
  {
     ...
     * 1: Bit SHRTEAR_EV can generate an Interrupt Request 
     */ 
    value = (SPIRead(INTERRUPT_ENABLE_1_REG) & INTERRUPT_SHORT_CIRCUIT_DETECTED_EAR_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_status_vss_ready()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_1_REG) & STATUS_VSS_READY_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_status_short_circuit_detected_hsl()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_1_REG) & STATUS_SHORT_CIRCUIT_DETECTED_HSL_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_status_short_circuit_detected_hsr()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_1_REG) & STATUS_SHORT_CIRCUIT_DETECTED_HSR_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_status_short_circuit_detected_ear()
  {
     ...
     */ 
    value = (SPIRead(INTERRUPT_STATUS_1_REG) & STATUS_SHORT_CIRCUIT_DETECTED_EAR_PARAM_MASK);
    return value;
  }
...
unsigned char set_fifo_mask_enable( enum fifo_mask_enable param )
  {
    ...
    old_value = SPIRead(FIFO_INTERRUPT_CONTROL_REG);
    ...
    SPIWrite(FIFO_INTERRUPT_CONTROL_REG, value);
...
unsigned char get_fifo_mask_enable()
  {
     ...
     * the digital audio data source 
     */ 
    value = (SPIRead(FIFO_INTERRUPT_CONTROL_REG) & FIFO_MASK_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_wakeup_signal_level()
  {
     ...
     * Wakeup signal is generated when burst 
     */ 
    value = (SPIRead(FIFO_INTERRUPT_CONTROL_REG) & WAKEUP_SIGNAL_LEVEL_PARAM_MASK);
    return value;
  }
...
unsigned char set_fifo_burst_length( enum fifo_burst_length param )
  {
    ...
    old_value = SPIRead(FIFO_LENGTH_REG);
     ...
     */ 
     ...
     value =  old_value & ~FIFO_BURST_LENGTH_PARAM_MASK ;
    ...
    SPIWrite(FIFO_LENGTH_REG, value);
...
unsigned char get_fifo_burst_length()
  {
     ...
     * length in master mode. 
     */ 
    value = (SPIRead(FIFO_LENGTH_REG) & FIFO_BURST_LENGTH_PARAM_MASK);
    return value;
  }
...
unsigned char set_fifo_extra_clock( enum extra_clock param )
  {
    ...
    old_value = SPIRead(FIFO_CONTROL_REG);
    ...
    SPIWrite(FIFO_CONTROL_REG, value);
...
unsigned char get_fifo_extra_clock()
  {
     ...
     * frame 
     */ 
    value = (SPIRead(FIFO_CONTROL_REG) & EXTRA_CLOCK_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_number_extra_clocks()
  {
     ...
     * first Frame Sync on Aud_IF0 startup or Burst startup 
     */ 
    value = (SPIRead(FIFO_CONTROL_REG) & NUMBER_EXTRA_CLOCKS_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_master_fifo_mode_enable()
  {
     ...
     * 1: Burst FIFO interface is configured in master mode 
     */ 
    value = (SPIRead(FIFO_CONTROL_REG) & MASTER_FIFO_MODE_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_bust_mode_run()
  {
     ...
     * 1: Burst FIFO interface is running 
     */ 
    value = (SPIRead(FIFO_CONTROL_REG) & BUST_MODE_RUN_PARAM_MASK);
    return value;
  }
...
unsigned char set_fifo_switch_frame( unsigned char param )
  {
    ...
    value = SPIRead(FIFO_SWITCH_FRAME_REG);

    /* 
     * It indicates on which frame number the switch from normal 
     * to burst mode will happen. The frame number is 
     * BFIFOSAMPNR*8. The switch occurs when the register 
     * content matches an internal frame counter that is reset 
     * each time the interface starts or is switched to normal 
     * mode 
     */ 
    SPIWrite(FIFO_SWITCH_FRAME_REG, param);
    return value;
...
unsigned char set_fifo_wake_up_delay( unsigned char param )
  {
    ...
    value = SPIRead(FIFO_WAKE_UP_DELAY_REG);
     ...
     */ 
    SPIWrite(FIFO_WAKE_UP_DELAY_REG, param);
    return value;
...
unsigned char set_fifo_samples_number( unsigned char param )
  {
    ...
    value = SPIRead(FIFO_SAMPLES_NUMBER_REG);

    /* 
     * Number of samples currently present in burst FIFO is 
     * BFIFOSAMPLES*8. 
     */ 
    SPIWrite(FIFO_SAMPLES_NUMBER_REG, param);
    return value;
...
/***************************************************************************
 *
 * Function : get_stw4500_revision
 *
 * RET  : Return the value of register FadeSpeedRevision
 *
 * Notes : From register 0x0D6F, bits 6:2
 *
 **************************************************************************/
unsigned char get_stw4500_revision()
  {
     ...
     */ 
    value = (SPIRead(FADE_SPEED_REVISION_REG) & STW_4500_REVISON_PARAM_MASK) >> 2;
    return value;
  }
