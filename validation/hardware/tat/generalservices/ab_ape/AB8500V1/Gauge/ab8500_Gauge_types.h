...
//  Register CoulombDataManagement 0x0C11, Bits 0:0 , typedef data_transfert
//   
//  
#define COMLOMB_DATA_TRANSFERT_MASK 0x1  
#define COMLOMB_DATA_TRANSFERT_OFFSET 0
#define COMLOMB_DATA_TRANSFERT_STOP_BIT 0
#define COMLOMB_DATA_TRANSFERT_START_BIT 0
#define COMLOMB_DATA_TRANSFERT_WIDTH 0
...
/*-CAP_948_001*/
#define DATA_TRANSFERT_PARAM_MASK  0x1


//  
//  allows to reset the 21bits accumulator data.
//  Register CoulombDataManagement 0x0C11, Bits 1:1, typedef bit_data_reset
//   
//  
#define COMLOMB_RESET_BIT_DATA_MASK 0x2
#define COMLOMB_RESET_BIT_DATA_OFFSET 1
#define COMLOMB_RESET_BIT_DATA_STOP_BIT 1
#define COMLOMB_RESET_BIT_DATA_START_BIT
...
#define BIT_DATA_RESET_PARAM_MASK  0x2
/*-CAP_948_001*/
