/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_Charger/Linux/ab8500_Charger.c
 * 
 *
 ...
 *
 * Notes : From register 0x0B80, bits 4:4
 *
 **************************************************************************/
...
unsigned char get_vbat_overshoot_control()
  {
     ...
     * 1: disable Vbat overshoot control 
     */ 
    value = (I2CRead(MAIN_CHARGER_CONTROL_REG) & VBAT_OVERSHOOT_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
