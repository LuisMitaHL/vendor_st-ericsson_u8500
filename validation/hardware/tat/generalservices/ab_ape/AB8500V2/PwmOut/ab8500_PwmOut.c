/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_PwmOut/Linux/ab8500_PwmOut.c
 * 
 *
...
unsigned char get_pwm1_frequency()
  {
     ...
     * Frequency 1(from 293 Hz to 551 Hz) 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_2_REG) & FREQUENCY_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_pwm_out1_duty_high()
  {
     ...
     * Defined duty clycle out 1 [9:0] 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_2_REG) & DUTY_1_PARAM_MASK);
    return value;
  }
...
unsigned char set_pwm2_frequency( enum frequency param )
  {
    ...
    old_value = I2CRead(PWM_OUT_MANAGEMENT_3_REG);
    ...
    I2CWrite(PWM_OUT_MANAGEMENT_3_REG, value);
...
unsigned char get_pwm2_frequency()
  {
     ...
     * Frequency 1(from 293 Hz to 551 Hz) 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_3_REG) & FREQUENCY_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_pwm_out2_duty_high()
  {
     ...
     * Defined duty clycle out 2 [9:0] 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_3_REG) & DUTY_2_PARAM_MASK);
    return value;
  }
...
unsigned char set_pwm3_frequency( enum frequency param )
  {
    ...
    old_value = I2CRead(PWM_OUT_MANAGEMENT_5_REG);
    ...
    I2CWrite(PWM_OUT_MANAGEMENT_5_REG, value);
...
unsigned char get_pwm3_frequency()
  {
     ...
     * Frequency 1(from 293 Hz to 551 Hz) 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_5_REG) & FREQUENCY_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_pwm_out3_duty_high()
  {
     ...
     * Defined duty clycle out 2 [9:0] 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_5_REG) & DUTY_3_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register PwmOutManagement6
 *
...
unsigned char get_pwm_out3_enable()
  {
     ...
     * 1: Enable PWMOut3 generator 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_6_REG) & PWM_OUT_3_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_pwm_out2_enable()
  {
     ...
     * 1: Enable PWMOut2 generator 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_6_REG) & PWM_OUT_2_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_pwm_out1_enable()
  {
     ...
     * 1: Enable PWMOut1 generator 
     */ 
    value = (I2CRead(PWM_OUT_MANAGEMENT_6_REG) & PWM_OUT_1_ENABLE_PARAM_MASK);
    return value;
  }
