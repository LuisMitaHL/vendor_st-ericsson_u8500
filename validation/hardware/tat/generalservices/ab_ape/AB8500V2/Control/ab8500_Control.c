/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_Control/Linux/ab8500_Control.c
 * 
 *
...
unsigned char set_usb_id_detect( enum usb_detect_on param )
  {
    ...
    old_value = I2CRead(SYSTEM_CONTOL_STATUS_REG);
    ...
    I2CWrite(SYSTEM_CONTOL_STATUS_REG, value);
...
unsigned char get_usb_id_detect()
  {
     ...
     * 1: UsbIDDetect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & USB_DETECT_ON_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vbus_dectect()
  {
     ...
     * 1: VbusDetect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & VBUS_DETECT_ON_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_main_ch_detect()
  {
     ...
     * 1: MainChDetect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & MAIN_CH_DETECT_ON_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_rtc_alarm_detect()
  {
     ...
     * 1: RtcAlarmDetect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & RTC_ALARM_DETECT_ON_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_power_on_key2_detect()
  {
     ...
     * 1: PowerOnKey2Detect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & POWER_ON_KEY_2_DETECT_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_power_on_key1_detect()
  {
     ...
     * 1: PowerOnKey1Detect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & POWER_ON_KEY_1_DETECT_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_battery_detect()
  {
     ...
     * 1: PowerOnKey1Detect is a turn on event 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_REG) & BATTERY_DETECT_ON_PARAM_MASK);
    return value;
  }
...
unsigned char get_software_reset_flag()
  {
     ...
     */ 
    value = (I2CRead(RESET_STATUS_REG) & SOFTWARE_RESET_STATUS_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_reset4500()
  {
     ...
     * Reset 4500 status 
     */ 
    value = (I2CRead(RESET_STATUS_REG) & RESET_4500_STATUS_PARAM_MASK);
    return value;
  }
 ...
 *
 * IN   : param, a value to write to the regiter SystemContolStatus2
 * OUT  : 
 *
 * RET  : Return the value of register SystemContolStatus2
 *
...
unsigned char set_power_on_key1_press_time( unsigned char param )
  {
    ...
    old_value = I2CRead(SYSTEM_CONTOL_STATUS_2_REG);
    ...
    I2CWrite(SYSTEM_CONTOL_STATUS_2_REG, value);
...
unsigned char get_power_on_key1_press_time()
  {
     ...
     * indicates number of 125ms steps. 
     */ 
    value = (I2CRead(SYSTEM_CONTOL_STATUS_2_REG) & PRESS_TIME_PARAM_MASK);
    return value;
  }
...
unsigned char set_sys_clk_req( unsigned char param )
  {
     ...
     */ 
    I2CWrite(SYS_CLK_REQ_REG, param);
    return value;
...
unsigned char get_thermal_software_off()
  {
     ...
     * Thermal DB8500 Software Off 
     */ 
    value = (I2CRead(CONTROL_REG) & THERMAL_SOFTWARE_OFF_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_software_reset()
  {
     ...
     * 1: inactive 
     */ 
    value = (I2CRead(CONTROL_REG) & SOFTWARE_RESET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_software_off()
  {
     ...
     * 1: Turn off Ab8500 
     */ 
    value = (I2CRead(CONTROL_REG) & SOFTWARE_OFF_PARAM_MASK);
    return value;
  }
...
unsigned char get_reset_vsmps1_valid()
  {
     ...
     * when AB8500 is reset 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VSMPS_1_VALID_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_reset_vext_supply3_valid()
  {
     ...
     * 'ExtSupply13LP' bits when AB8500 is reset 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VEXT_SUPPLY_3_VALID_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_reset_vext_supply2_valid()
  {
     ...
     * 'ExtSupply12LP' bits when AB8500 is reset 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VEXT_SUPPLY_2_VALID_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_reset_vext_supply_valid()
  {
     ...
     * 'ExtSupply12LP' bits when AB8500 is reset 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VEXT_SUPPLY_VALID_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_reset_vmod_valid()
  {
     ...
     * to their default values when Ab8500 is resetted 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VMOD_VALID_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_reset_vaux3_valid()
  {
     ...
     * is reset 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VAUX_3_VALID_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_reset_vaux2_valid()
  {
     ...
     * reset to their default values when Ab8500 is resetted 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VAUX_2_VALID_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_reset_vaux1_valid()
  {
     ...
     * reset to their default values when Ab8500 is resetted 
     */ 
    value = (I2CRead(CONTROL_2_REG) & RESET_VAUX_1_VALID_PARAM_MASK);
    return value;
  }
...
unsigned char get_thermal_shutdown()
  {
     ...
     * 1: enable thermal shutdown 
     */ 
    value = (I2CRead(CONTROL_3_REG) & THERMAL_SHUTDOWN_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_video_denc_reset()
  {
     ...
     * 1: inactive 
     */ 
    value = (I2CRead(CONTROL_3_REG) & VIDEO_DENC_RESET_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_audio_reset()
  {
     ...
     * 1: inactive 
     */ 
    value = (I2CRead(CONTROL_3_REG) & AUDIO_RESET_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_clock32()
  {
     ...
     * 0: inactive 1: disable Clk32KOut2 output buffer 
     */ 
    value = (I2CRead(CONTROL_3_REG) & CLOCK_32_OUTPUT_BUFFER_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_turn_on_valid_on_expire()
  {
     ...
     * turned On running start up sequence. 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_CONTROL_REG) & MAIN_WATCH_DOG_WRITE_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_main_watchdog_kick()
  {
     ...
     * Kick Main watchdog. Auto-cleared 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_CONTROL_REG) & KICK_MAIN_WATCHDOG_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_main_watchdog_enable()
  {
     ...
     * Enable Main watchdog 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_CONTROL_REG) & MAIN_WATCHDOG_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_main_watchdog_timer()
  {
     ...
     * default value is 32s 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_TIMER_REG) & MAIN_WATCHDOG_TIMER_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register MainWatchDogTimer1
 *
...
unsigned char get_low_bat_threshold()
  {
     ...
     * Defined LowBat threshold from 2.3v to 3.85v 25mv steps 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_TIMER_1_REG) & LOW_BAT_THRESHOLD_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_low_battery_enable()
  {
     ...
     * 1: enable LowBat function 
     */ 
    value = (I2CRead(MAIN_WATCH_DOG_TIMER_1_REG) & LOW_BATTERY_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_battery_ok2_threshold()
  {
     ...
     * BattOk2 falling thresholds management 
     */ 
    value = (I2CRead(BATTERY_OK_THRESHOLD_REG) & BATTERY_OK_2_THRESHOLD_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_battery_ok1_threshold()
  {
     ...
     * BattOk1 falling thresholds management 
     */ 
    value = (I2CRead(BATTERY_OK_THRESHOLD_REG) & BATTERY_OK_1_THRESHOLD_PARAM_MASK);
    return value;
  }
...
unsigned char get_system_clock_timer_adjustement()
  {
     ...
     * of 32 Khz 
     */ 
    value = (I2CRead(SYSTEM_CLOCK_TIMER_REG) & TIMER_ADJUSTEMENT_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_system_clock_timer()
  {
     ...
     * System clock timer management. value multiple of 32 Khz 
     */ 
    value = (I2CRead(SYSTEM_CLOCK_TIMER_REG) & CLOCK_TIMER_PARAM_MASK);
    return value;
  }
...
unsigned char get_force_smps_clock()
  {
     ...
     * Force internal 3.2MHz oscillator ON 
     */ 
    value = (I2CRead(SMPS_CLOCK_CONTROL_REG) & FORCE_SMPS_CLOCK_ON_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_smps_clock_selection()
  {
     ...
     * oscillator 
     */ 
    value = (I2CRead(SMPS_CLOCK_CONTROL_REG) & SMPS_CLOCK_SELECTION_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SmpsClockPhase1
 *
...
unsigned char get_vape_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_1_REG) & VAPE_CLOCK_SEL_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_varm_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_1_REG) & VARM_CLOCK_SEL_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SmpsClockPhase2
 *
...
unsigned char get_vsmps1_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_2_REG) & VSMPS_1_CLOCK_SEL_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmod_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_2_REG) & VSMOD_CLOCK_SEL_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SmpsClockPhase3
 *
...
unsigned char get_vsmps3_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_3_REG) & VSMPS_3_CLOCK_SEL_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps2_clock_sel()
  {
     ...
     * Smps clock phase management versus IntClk clock 
     */ 
    value = (I2CRead(SMPS_CLOCK_PHASE_3_REG) & VSMPS_2_CLOCK_SEL_PARAM_MASK);
    return value;
  }
...
unsigned char get_clock27_ouput_buffer_d_p()
  {
     ...
     * enable output buffer pulldown 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & OUPUT_BUFFER_PD_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_clock27_ouput_buffer()
  {
     ...
     * enable output buffer 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & OUPUT_BUFFER_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_ulta_low_power_clock_strength()
  {
     ...
     * 40pF) 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & ULTA_LOW_POWER_CLOCK_STRENGTH_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_tvout_clock_inverted()
  {
     ...
     * delay 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & TVOUT_CLOCK_INVERTED_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_tvout_clock_input()
  {
     ...
     * internally delay to TVout clock 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & TVOUT_CLOCK_INPUT_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_clock27_strength()
  {
     ...
     * 40pF) 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & CLOCK_27_STRENGTH_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_ulta_low_power_pad()
  {
     ...
     * UlpClk pad configurations. ab8500 centric 
     */ 
    value = (I2CRead(SYSTEM_ULP_CLOCK_CONF_REG) & ULTA_LOW_POWER_PADONNF_PARAM_MASK);
    return value;
  }
...
unsigned char get_sys_clk_buf4_req()
  {
     ...
     * device 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & ACTIVATE_SYS_CLOCK_BUFFER_4_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_sys_clk_buf3_req()
  {
     ...
     * device 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & ACTIVATE_SYS_CLOCK_BUFFER_3_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_sys_clk_buf2_req()
  {
     ...
     * device 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & ACTIVATE_SYS_CLOCK_BUFFER_2_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_audio_clock()
  {
     ...
     * enable audio clock to audio block 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & AUDIO_CLOCK_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_system_clock_request()
  {
     ...
     * Ab8500 request system clock 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & SYSTEM_CLOCK_REQUEST_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_ulp_request()
  {
     ...
     * Ab8500 request ulp clock 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & ULP_REQUEST_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_ultra_low_power_selection()
  {
     ...
     * internal clock switching 
     */ 
    value = (I2CRead(CLOCK_MANAGEMENT_REG) & SYS_ULTRA_LOW_POWER_SELECTION_PARAM_MASK);
    return value;
  }
...
unsigned char get_usb_clock_enable()
  {
     ...
     * 1: enable SysClk path to USB block 
     */ 
    value = (I2CRead(CLOCK_VALID_REG) & USB_CLOCK_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_t_vout_clock_enable()
  {
     ...
     * 1: enable 27Mhz clock to TVout block 
     */ 
    value = (I2CRead(CLOCK_VALID_REG) & T_VOUT_CLK_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_tv_out_pll_enable()
  {
     ...
     * enable TVout pll (generate 27Mhz from SysClk) 
     */ 
    value = (I2CRead(CLOCK_VALID_REG) & TV_OUT_PLL_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_usb_sys_clockr_request1_valid( enum usb_sys_clockr_request1_enable param )
  {
    ...
    switch( param ){
        case USB_SYS_CLOCKR_REQUEST_1_ENABLE_E: 
           value = old_value | USB_SYS_CLOCKR_REQUEST_1_ENABLE_PARAM_MASK; 
           break;
...
unsigned char get_usb_sys_clockr_request1_valid()
  {
     ...
     * 1: valid Usb block to request System clock 
     */ 
    value = (I2CRead(CLOCK_VALID_2_REG) & USB_SYS_CLOCKR_REQUEST_1_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char set_ultra_low_power_request1_valid( enum ultra_low_power_request1_enable param )
  {
    ...
    switch( param ){
        case ULTRA_LOW_POWER_UP_E: 
           value = old_value | ULTRA_LOW_POWER_REQUEST_1_ENABLE_PARAM_MASK; 
           break;
...
unsigned char get_ultra_low_power_request1_valid()
  {
     ...
     * valid ulp clock request from SysClkReq1 input 
     */ 
    value = (I2CRead(CLOCK_VALID_2_REG) & ULTRA_LOW_POWER_REQUEST_1_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_sys_clock_request1_valid()
  {
     ...
     * Sys valid system clock request from SysClkReq1input 
     */ 
    value = (I2CRead(CLOCK_VALID_2_REG) & SYS_CLOCK_REQUEST_1_VALID_PARAM_MASK);
    return value;
  }
...
unsigned char get_interrupt8500_open_drain()
  {
     ...
     * 1: Int8500n is an OpenDrain output 
     */ 
    value = (I2CRead(CONTROL_BALL_REG) & BALL_CONFIGURATION_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_ext_sup3_l_pn_clk_sel()
  {
     ...
     * 10 or 11: select (ExtSupply3LPn AND ExtSupply3Clk) 
     */ 
    value = (I2CRead(CONTROL_BALL_REG) & CONFIGURATION_3_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_ext_sup12_l_pn_clk_sel()
  {
     ...
     * 10 or 11: select (ExtSupply12LPn AND ExtSupply12Clk) 
     */ 
    value = (I2CRead(CONTROL_BALL_REG) & CONFIGURATION_12_PARAM_MASK);
    return value;
  }
...
unsigned char get_sys_clock_buf4_req1()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_3_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req1()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_3_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req1()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_3_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req2()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_4_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req2()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_4_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req2()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_4_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req3()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_5_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req3()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_5_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req3()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_5_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req4()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_6_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req4()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_6_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req4()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_6_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req5()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_7_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req5()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_7_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req5()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_7_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req6()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_8_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req6()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_8_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req6()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_8_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req7()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_9_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req7()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_9_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req7()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_9_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clock_buf4_req8()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_10_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clock_buf3_req8()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_10_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clock_buf2_req8()
  {
     ...
     * Levi/Yllas RF I.C. 
     */ 
    value = (I2CRead(CLOCK_VALID_10_REG) & SYS_CLOCK_RESQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_dithering_delay()
  {
     ...
     * Dithering delay 2.5ns, 3ns 3.5ns 4ns 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & DITHERING_DELAY_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vape_dither()
  {
     ...
     * VapeDitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VAPE_DITHER_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vmod_dither()
  {
     ...
     * VmodDitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VMOD_DITHER_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vsmps2_dither()
  {
     ...
     * Vsmps2DitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VSMPS_2_DITHER_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps1_dither()
  {
     ...
     * Vsmps1DitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VSMPS_1_DITHER_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsmps3_dither()
  {
     ...
     * Vsmps3DitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VSMPS_3_DITHER_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_varm_dither()
  {
     ...
     * VarmDitherEna 
     */ 
    value = (I2CRead(DITHER_CLK_CTRL_REG) & VARM_DITHER_ENABLE_PARAM_MASK);
    return value;
  }
 ...
 *
 * Notes : From register 0x0230, bits 6:6
 *
 **************************************************************************/
...
unsigned char get_swat_bit5_set()
  {
     ...
     * Swat interface) 
     */ 
    value = (I2CRead(SWAT_CTRL_REG) & SWAT_BIT_5_SET_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_rf_off_timer()
  {
     ...
     * (RfOffTimer[2:0] +1) x periods of 32kHz 
     */ 
    value = (I2CRead(SWAT_CTRL_REG) & OFF_TIMER_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_swat_enable()
  {
     ...
     * 1: Enable Swat block 
     */ 
    value = (I2CRead(SWAT_CTRL_REG) & SWAT_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_levi_or_yllas()
  {
     ...
     * 1: RF I.C. is Yllas (allow to configure Swat message) 
     */ 
    value = (I2CRead(SWAT_CTRL_REG) & LEVI_OR_YLLAS_PARAM_MASK);
    return value;
  }
...
unsigned char get_sys_clk_req8_hiq_enable()
  {
     ...
     * 1: valid SysClkReq8 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_8_HIQ_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_sys_clk_req7_hiq_enable()
  {
     ...
     * 1: valid SysClkReq7 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_7_HIQ_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_sys_clk_req6_hiq_enable()
  {
     ...
     * 1: valid SysClkReq6 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_6_HIQ_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_sys_clk_req5_hiq_enable()
  {
     ...
     * 1: valid SysClkReq5 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_5_HIQ_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clk_req4_hiq_enable()
  {
     ...
     * 1: valid SysClkReq4 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_4_HIQ_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clk_req3_hiq_enable()
  {
     ...
     * 1: valid SysClkReq3 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_3_HIQ_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clk_req2_hiq_enable()
  {
     ...
     * 1: valid SysClkReq2 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_2_HIQ_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_sys_clk_req1_hiq_enable()
  {
     ...
     * 1: valid SysClkReq1 input to control HiqClkEna ball 
     */ 
    value = (I2CRead(HIQ_CLK_CTRL_REG) & SYS_CLK_REQ_1_HIQ_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_vsim_sys_clk_req8_hiq_enable()
  {
     ...
     * 1: valid SysClkReq8 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_8_HIQ_ENABLE_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req7_hiq_enable()
  {
     ...
     * 1: valid SysClkReq7 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_7_HIQ_ENABLE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req6_hiq_enable()
  {
     ...
     * 1: valid SysClkReq6 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_6_HIQ_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req5_hiq_enable()
  {
     ...
     * 1: valid SysClkReq5 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_5_HIQ_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req4_hiq_enable()
  {
     ...
     * 1: valid SysClkReq4 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_4_HIQ_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req3_hiq_enable()
  {
     ...
     * 1: valid SysClkReq2 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_3_HIQ_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req2_hiq_enable()
  {
     ...
     * 1: valid SysClkReq2 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_2_HIQ_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vsim_sys_clk_req1_hiq_enable()
  {
     ...
     * 1: valid SysClkReq1 inputs to request Vsim ldo 
     */ 
    value = (I2CRead(VSIM_SYS_CLK_CTRL_REG) & VSIM_SYS_CLK_REQ_1_HIQ_ENABLE_PARAM_MASK);
    return value;
  }
