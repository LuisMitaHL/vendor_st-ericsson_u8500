/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_Latch/Linux/ab8500_Latch.c
 * 
 *
...
unsigned char get_usb_charger_unplug_latch()
  {
    ...
    /* 
     * USB charger is compliant with charger specification 
     * (charging re-start) 
     */ 
    value = (I2CRead(LATCHED_INTERRUPT_22_REG) & USB_CHARGER_UNPLUG_LATCH_PARAM_MASK) >> 7;
    return value;
  }
