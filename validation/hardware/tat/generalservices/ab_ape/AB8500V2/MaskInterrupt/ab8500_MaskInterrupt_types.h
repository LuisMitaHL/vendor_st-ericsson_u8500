/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_MaskInterrupt/Linux/ab8500_MaskInterrupt_types.h
 * 
 *
...
#ifndef C__LISP_PRODUCTION_AB8500_V2_AB8500_MASKINTERRUPT_LINUX_AB8500_MASKINTERRUPT_TYPES_H
#define C__LISP_PRODUCTION_AB8500_V2_AB8500_MASKINTERRUPT_LINUX_AB8500_MASKINTERRUPT_TYPES_H
...
//  main_charger_over_current_mask_set
//   
//  
...
typedef enum main_charger_over_current_mask_set {
    MAIN_CHARGER_OVER_CURRENT_MASK_RESET_SET_E,
    MAIN_CHARGER_OVER_CURRENT_MASK_SET_E
} MAIN_CHARGER_OVER_CURRENT_MASK_SET_T ;

#define MAIN_CHARGER_OVER_CURRENT_MASK_SET_PARAM_MASK  0x80
...
//  
//  USB charger compliant with charging specification interrupt masked.
...
//  
//  USB charger is compliant with charger specifications(charging restart).
//  Register MaskedInterrupt22 0x0E55, Bits 6:6, typedef usb_charger_compiliant_mask_set
//   
//  
#define USB_CHARGER_COMPILIANT_MASK_MASK 0x40
#define USB_CHARGER_COMPILIANT_MASK_OFFSET 6
#define USB_CHARGER_COMPILIANT_MASK_STOP_BIT 6
#define USB_CHARGER_COMPILIANT_MASK_START_BIT 6
#define USB_CHARGER_COMPILIANT_MASK_WIDTH 1


typedef enum usb_charger_compiliant_mask_set {
    USB_CHARGER_COMPILIANT_MASK_RESET_SET_E,
    USB_CHARGER_COMPILIANT_MASK_SET_E
} USB_CHARGER_COMPILIANT_MASK_SET_T ;

#define USB_CHARGER_COMPILIANT_MASK_SET_PARAM_MASK  0x40
