/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_Regul/Linux/ab8500_Regul.c
 * 
 *
...
unsigned char get_serial_control_interface()
  {
     ...
     * Serial Control Interface (I2C or SPI) 
     */ 
    value = (I2CRead(PROTOCOL_CONTROL_REG) & SERIAL_CONTROL_BY_PARAM_MASK);
    return value;
  }
...
unsigned char set_vmod_sel_ctrl_sel( enum vmod_sel_ctrl_sel param )
  {
    ...
    switch( param ){
        case VMOD_SELECTED_BY_I2C_MODEM_E: 
           value = old_value | VMOD_SEL_CTRL_SEL_PARAM_MASK; 
           break;
...
unsigned char get_vmod_sel_ctrl_sel()
  {
     ...
     * voltage 
     */ 
    value = (I2CRead(PROTOCOL_CONTROL_REG) & VMOD_SEL_CTRL_SEL_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vsmps2_request_control()
  {
     ...
     * value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_REG) & REQUEST_CONTROL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vsmps1_request_control()
  {
     ...
     * value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_REG) & REQUEST_CONTROL_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vape_request_control()
  {
     ...
     * 1x: force Vape in HP whatever VapeRequest signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_REG) & REQUEST_CONTROL_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_varm_request_control()
  {
     ...
     * 1x: force Varm in HP whatever VarmRequest signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_REG) & REQUEST_CONTROL_PARAM_MASK);
    return value;
  }
...
unsigned char get_vext_supply1_request_control()
  {
     ...
     * signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_2_REG) & REQUEST_CONTROL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vana_request_control()
  {
     ...
     * 1x: force Vana in HP whatever VanaRequest signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_2_REG) & REQUEST_CONTROL_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vpll_request_control()
  {
     ...
     * 1x: force Vpll in HP whatever VpllRequest signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_2_REG) & REQUEST_CONTROL_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsmps3_request_control()
  {
     ...
     * value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_2_REG) & REQUEST_CONTROL_PARAM_MASK);
    return value;
  }
...
unsigned char get_vaux2_request_control()
  {
     ...
     * 1x: force Vaux2 in HP whatever Vaux2Request signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_3_REG) & REQUEST_CONTROL_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vaux1_request_control()
  {
     ...
     * 1x: force Vaux1 in HP whatever Vaux1Request signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_3_REG) & REQUEST_CONTROL_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vext_supply3_request_control()
  {
     ...
     * signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_3_REG) & REQUEST_CONTROL_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vext_supply2_request_control()
  {
     ...
     * signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_3_REG) & REQUEST_CONTROL_PARAM_MASK);
    return value;
  }
...
unsigned char get_software_supply_enable()
  {
     ...
     * 1: Sw request supply validated by 'VxSwHPReqValid' bits 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_4_REG) & SOFTWARE_SUPPLY_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vaux3_request_control()
  {
     ...
     * 1x: force Vaux3 in HP whatever Vaux3Request signal value 
     */ 
    value = (I2CRead(REGU_REQUEST_CONTROL_4_REG) & REQUEST_CONTROL_PARAM_MASK);
    return value;
  }
...
unsigned char get_vaux3_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vaux3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vaux2_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vaux2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vaux1_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vaux1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vppl_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vppl supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vana_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vana supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps3_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vsmps3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsmps2_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vsmps2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vsmps1_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vsmps1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_REG) & REQUEST_VALID_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SupplyControlValid1
 *
...
unsigned char get_vext_supply3_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request VextSupply3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vext_supply2_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request VextSupply2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vext_supply1_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request VextSupply1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vmod_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vmod supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vbb_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vbb supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_varm_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Varm supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vape_sys_clk_req1_h_p_valid()
  {
     ...
     * 1: valid SysClkReq1 input to request Vape supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_VALID_1_REG) & REQUEST_VALID_PARAM_MASK);
    return value;
  }
...
unsigned char get_vaux3_hw_h_p_req1_valid()
  {
     ...
     * request Vaux3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vaux2_hw_h_p_req1_valid()
  {
     ...
     * request Vaux2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vaux1_hw_h_p_req1_valid()
  {
     ...
     * request Vaux1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vpll_hw_h_p_req1_valid()
  {
     ...
     * request Vpll supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vana_hw_h_p_req1_valid()
  {
     ...
     * request Vana supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps3_hw_h_p_req1_valid()
  {
     ...
     * request Vsmps3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsmps2_hw_h_p_req1_valid()
  {
     ...
     * request Vsmps2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vsmps1_hw_h_p_req1_valid()
  {
     ...
     * request Vsmps1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_REG) & HARDWARE_VALIDATION_PARAM_MASK);
    return value;
  }
...
unsigned char get_vmod_hw_h_p_req1_valid()
  {
     ...
     * request Vmod supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_2_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vext_supply3_hw_h_p_req1_valid()
  {
     ...
     * request VextSupply3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_2_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vext_supply2_hw_h_p_req1_valid()
  {
     ...
     * request VextSupply2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_2_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vext_supply1_hw_h_p_req1_valid()
  {
     ...
     * request VextSupply1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_2_REG) & HARDWARE_VALIDATION_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SupplyControlHardwareValid3
 *
...
unsigned char get_vaux3_hw_h_p_req2_valid()
  {
     ...
     * request Vaux3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vaux2_hw_h_p_req2_valid()
  {
     ...
     * request Vaux2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vaux1_hw_h_p_req2_valid()
  {
     ...
     * request Vaux1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vpll_hw_h_p_req2_valid()
  {
     ...
     * request Vpll supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vana_hw_h_p_req2_valid()
  {
     ...
     * request Vana supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps3_hw_h_p_req2_valid()
  {
     ...
     * request Vsmps3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vsmps2_hw_h_p_req2_valid()
  {
     ...
     * request Vsmps2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vsmps1_hw_h_p_req2_valid()
  {
     ...
     * request Vsmps1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_3_REG) & HARDWARE_VALIDATION_PARAM_MASK);
    return value;
  }
 ...
 * OUT  : 
 *
 * RET  : Return the value of register SupplyControlHardwareValid4
 *
...
unsigned char get_vmod_hw_h_p_req2_valid()
  {
     ...
     * request Vmod supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_4_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vext_supply3_hw_h_p_req2_valid()
  {
     ...
     * request VextSupply3 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_4_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vext_supply2_hw_h_p_req2_valid()
  {
     ...
     * request VextSupply2 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_4_REG) & HARDWARE_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vext_supply1_hw_h_p_req2_valid()
  {
     ...
     * request VextSupply1 supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_HARDWARE_VALID_4_REG) & HARDWARE_VALIDATION_PARAM_MASK);
    return value;
  }
...
unsigned char get_vaux1_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vaux1 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_vpll_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vpll supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vana_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vana supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vsmps3_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vsmps3 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vsmps2_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vsmps2 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vsmps1_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vsmps1 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_varm_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Varm supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vape_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vape supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK);
    return value;
  }
...
unsigned char get_vmod_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vmod supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_vext_supply3_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request VextSupply3 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vext_supply2_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request VextSupply2 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vext_supply1_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request VextSupply1 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vaux3_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vaux3 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vaux2_sw_h_p_req_valid()
  {
     ...
     * 1: valid SW to request Vaux2 supply 
     */ 
    value = (I2CRead(SOFTWARE_SIGNAL_VALIDATION_2_REG) & SOFTWARE_SIGNAL_VALIDATION_PARAM_MASK);
    return value;
  }
...
unsigned char get_sys_clk_req8_valid1()
  {
     ...
     * 1: valid SysClkReq8 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_sys_clk_req7_valid1()
  {
     ...
     * 1: valid SysClkReq7 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_sys_clk_req6_valid1()
  {
     ...
     * 1: valid SysClkReq6 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_sys_clk_req5_valid1()
  {
     ...
     * 1: valid SysClkReq5 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clk_req4_valid1()
  {
     ...
     * 1: valid SysClkReq4 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clk_req3_valid1()
  {
     ...
     * 1: valid SysClkReq3 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clk_req2_valid1()
  {
     ...
     * 1: valid SysClkReq2 configuration 1 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_sys_clk_req8_valid2()
  {
     ...
     * 1: valid SysClkReq8 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_sys_clk_req7_valid2()
  {
     ...
     * 1: valid SysClkReq7 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_sys_clk_req6_valid2()
  {
     ...
     * 1: valid SysClkReq6 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_sys_clk_req5_valid2()
  {
     ...
     * 1: valid SysClkReq5 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_sys_clk_req4_valid2()
  {
     ...
     * 1: valid SysClkReq4 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_sys_clk_req3_valid2()
  {
     ...
     * 1: valid SysClkReq3 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_sys_clk_req2_valid2()
  {
     ...
     * 1: valid SysClkReq2 configuration 2 to request Vx supply 
     */ 
    value = (I2CRead(SUPPLY_CONTROL_SYS_CLK_REQ_2_REG) & SYS_CLOCK_REQUEST_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vt_vout_low_power()
  {
     ...
     * 1: enable LP mode 
     */ 
    value = (I2CRead(REGU_MISCELLANOUS_REG) & VT_VOUT_LOW_POWER_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_low_power_mode()
  {
     ...
     * 1: enable LP mode 
     */ 
    value = (I2CRead(REGU_MISCELLANOUS_REG) & LOW_POWER_MODE_PARAM_MASK) >> 6;
    return value;
  }
...
unsigned char get_vint_core12_sel()
  {
     ...
     * select output voltage 
     */ 
    value = (I2CRead(REGU_MISCELLANOUS_REG) & VINT_CORE_12_SEL_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_vint_core12_ena()
  {
     ...
     * 1: enable LP mode 
     */ 
    value = (I2CRead(REGU_MISCELLANOUS_REG) & VINT_CORE_12_ENA_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_vt_vout_enable()
  {
     ...
     * 1: enable VTVout supply 
     */ 
    value = (I2CRead(REGU_MISCELLANOUS_REG) & VT_VOUT_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vbus_bis_enable()
  {
     ...
     * 1: enable Vbusbis (5v stepup) supply 
     */ 
    value = (I2CRead(OTG_SUPPLY_CONTROL_REG) & VBUS_BIS_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_otg_supply_force_l_p()
  {
     ...
     * 1: disable Vbus pull-down 
     */ 
    value = (I2CRead(OTG_SUPPLY_CONTROL_REG) & OTG_SUPPLY_FORCE_LP_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_otg_supply_enable()
  {
     ...
     * 1: disable Vbus pull-down 
     */ 
    value = (I2CRead(OTG_SUPPLY_CONTROL_REG) & OTG_SUPPLY_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char set_v_usb_turn_off( enum v_usb_turn_off param )
  {
    ...
    switch( param ){
        case MASK_VBUS_OVER_VOLATGE_E: 
           value = old_value | V_USB_TURN_OFF_PARAM_MASK; 
           break;
...
unsigned char get_v_usb_turn_off()
  {
     ...
     * 1: Mask Vusb turn off when VbusOVV occurs 
     */ 
    value = (I2CRead(USB_SUPPLY_CONTROL_REG) & V_USB_TURN_OFF_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_vbus_low_power_mode()
  {
     ...
     * 1: Vusb regulator is set LP mode 
     */ 
    value = (I2CRead(USB_SUPPLY_CONTROL_REG) & VBUS_LOW_POWER_MODE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vusb_enable()
  {
     ...
     * 1: enable Vusb supply 
     */ 
    value = (I2CRead(USB_SUPPLY_CONTROL_REG) & USB_SUPPLY_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_vnegative_mic2_supply()
  {
     ...
     * 1: enable Vamic2 supply 
     */ 
    value = (I2CRead(AUDIO_SUPPLY_CONTROL_REG) & VNEGATIVE_MIC_2_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_analog_mic1_supply()
  {
     ...
     * 1: enable Vamic1 supply 
     */ 
    value = (I2CRead(AUDIO_SUPPLY_CONTROL_REG) & ANALOG_MIC_1_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_digital_mic_supply()
  {
     ...
     * 1: enable Vamic1 supply 
     */ 
    value = (I2CRead(AUDIO_SUPPLY_CONTROL_REG) & DIGITAL_MIC_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_audio_supply()
  {
     ...
     * 1: enable Vaudio supply 
     */ 
    value = (I2CRead(AUDIO_SUPPLY_CONTROL_REG) & AUDIO_1_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vamic2_polarity()
  {
     ...
     * 1: output is grounded when Vamic2 is disabled 
     */ 
    value = (I2CRead(REGULATOR_CONTROL_1_REG) & VAMIC_2_POLARITY_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_vamic1_polarity()
  {
     ...
     * 1: output is grounded when Vamic1 is disabled 
     */ 
    value = (I2CRead(REGULATOR_CONTROL_1_REG) & VAMIC_1_POLARITY_PARAM_MASK);
    return value;
  }
