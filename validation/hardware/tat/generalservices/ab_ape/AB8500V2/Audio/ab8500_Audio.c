/****************************************************************************
 * File : c:/Lisp/Production/ab8500_V2/ab8500_Audio/Linux/ab8500_Audio.c
 * 
 *
...
unsigned char set_wakeup_signal_level( enum wakeup_signal_level param )
  {
     ...
     */ 
     ...
     value =  (unsigned char) (old_value & ~WAKEUP_SIGNAL_LEVEL_PARAM_MASK) ;
...
unsigned char set_fifo_burst_length( enum fifo_burst_length param )
  {
     ...
     */ 
     ...
     value =  (unsigned char) (old_value & ~FIFO_BURST_LENGTH_PARAM_MASK) ;
