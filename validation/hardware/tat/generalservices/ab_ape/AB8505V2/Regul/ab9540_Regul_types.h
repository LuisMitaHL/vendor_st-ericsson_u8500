/****************************************************************************
 * File : c:/Lisp/Production/ab9540/ab9540_Regul/Linux/ab9540_Regul_types.h
 * 
 *
...
#ifndef C__LISP_PRODUCTION_AB9540_AB9540_REGUL_LINUX_AB9540_REGUL_TYPES_H
#define C__LISP_PRODUCTION_AB9540_AB9540_REGUL_LINUX_AB9540_REGUL_TYPES_H
...
//  1:allows 'VmodSelCtrlI2cModem' to select Vmod output voltage.
//  Register ProtocolControl 0x0300, Bits 4:4, typedef vmod_sel_ctrl_sel
//   
//  
#define VMOD_SEL_CTRL_SEL_MASK 0x10U
#define VMOD_SEL_CTRL_SEL_OFFSET 4
#define VMOD_SEL_CTRL_SEL_STOP_BIT 4
#define VMOD_SEL_CTRL_SEL_START_BIT 4
#define VMOD_SEL_CTRL_SEL_WIDTH 1

#define PROTOCOL_CONTROL_REG 0x300

typedef enum vmod_sel_ctrl_sel {
    VMOD_SLECTED_BY_VMOD_CONTROL_E,
    VMOD_SELECTED_BY_I2C_MODEM_E
} VMOD_SEL_CTRL_SEL_T ;
#define VMOD_SEL_CTRL_SEL_PARAM_MASK  0x10
...
//   
//  
#define SERIAL_CONTROL_INTERFACE_MASK 0xFU
...
#define SERIAL_CONTROL_INTERFACE_PARAM_MASK  0xF
...
//   
//  
#define VARM_REQUEST_CONTROL_MASK 0x3U
...
//   
//  
#define VAPE_REQUEST_CONTROL_MASK 0xCU
...
//   
//  
#define VSMPS_1_REQUEST_CONTROL_MASK 0x30U
...
//   
//  
#define VSMPS_2_REQUEST_CONTROL_MASK 0xC0U
...
//   
//  
#define VSMPS_3_REQUEST_CONTROL_MASK 0x3U
...
//   
//  
#define VPLL_REQUEST_CONTROL_MASK 0xCU
...
//   
//  
#define VANA_REQUEST_CONTROL_MASK 0x30U
...
//   
//  
#define VEXT_SUPPLY_1_REQUEST_CONTROL_MASK 0xC0U
...
//   
//  
#define VEXT_SUPPLY_2_REQUEST_CONTROL_MASK 0x3U
...
//   
//  
#define VEXT_SUPPLY_3_REQUEST_CONTROL_MASK 0xCU
...
//   
//  
#define VAUX_1_REQUEST_CONTROL_MASK 0x30U
...
//   
//  
#define VAUX_2_REQUEST_CONTROL_MASK 0xC0U
...
//   
//  
#define VAUX_3_REQUEST_CONTROL_MASK 0x3U
...
//   
//  
#define SOFTWARE_SUPPLY_MASK 0x4U
#define SOFTWARE_SUPPLY_OFFSET 2
#define SOFTWARE_SUPPLY_STOP_BIT 2
#define SOFTWARE_SUPPLY_START_BIT 2
#define SOFTWARE_SUPPLY_WIDTH 1
...
#define SOFTWARE_SUPPLY_PARAM_MASK  0x4
...
//   
//  
#define VSMPS_1_SYS_CLK_REQ_1HP_VALID_MASK 0x1U
...
//   
//  
#define VSMPS_2_SYS_CLK_REQ_1HP_VALID_MASK 0x2U
...
//   
//  
#define VSMPS_3_SYS_CLK_REQ_1HP_VALID_MASK 0x4U
...
//   
//  
#define VANA_SYS_CLK_REQ_1HP_VALID_MASK 0x8U
...
//   
//  
#define VPPL_SYS_CLK_REQ_1HP_VALID_MASK 0x10U
...
//   
//  
#define VAUX_1_SYS_CLK_REQ_1HP_VALID_MASK 0x20U
...
//   
//  
#define VAUX_2_SYS_CLK_REQ_1HP_VALID_MASK 0x40U
...
//   
//  
#define VAUX_3_SYS_CLK_REQ_1HP_VALID_MASK 0x80U
...
//  Register SupplyControlValid1 0x0308, Bits 0:0, typedef request_valid
//   
//  
#define VAPE_SYS_CLK_REQ_1HP_VALID_MASK 0x1U
...
#define SUPPLY_CONTROL_VALID_1_REG 0x308
...
//  Register SupplyControlValid1 0x0308, Bits 1:1, typedef request_valid
//   
//  
#define VARM_SYS_CLK_REQ_1HP_VALID_MASK 0x2U
...
//  Register SupplyControlValid1 0x0308, Bits 2:2, typedef request_valid
//   
//  
#define VBB_SYS_CLK_REQ_1HP_VALID_MASK 0x4U
...
//  Register SupplyControlValid1 0x0308, Bits 3:3, typedef request_valid
//   
//  
#define VMOD_SYS_CLK_REQ_1HP_VALID_MASK 0x8U
...
//  Register SupplyControlValid1 0x0308, Bits 4:4, typedef request_valid
//   
//  
#define VEXT_SUPPLY_1_SYS_CLK_REQ_1HP_VALID_MASK 0x10U
...
//  Register SupplyControlValid1 0x0308, Bits 5:5, typedef request_valid
//   
//  
#define VEXT_SUPPLY_2_SYS_CLK_REQ_1HP_VALID_MASK 0x20U
...
//  Register SupplyControlValid1 0x0308, Bits 6:6, typedef request_valid
//   
//  
#define VEXT_SUPPLY_3_SYS_CLK_REQ_1HP_VALID_MASK 0x40U
...
//  supply.
//  Register SupplyControlHardwareValid 0x0309, Bits 0:0, typedef hardware_validation
//   
//  
#define VSMPS_1_HW_HP_REQ_1_VALID_MASK 0x1U
#define VSMPS_1_HW_HP_REQ_1_VALID_OFFSET 0
#define VSMPS_1_HW_HP_REQ_1_VALID_STOP_BIT 0
#define VSMPS_1_HW_HP_REQ_1_VALID_START_BIT 0
#define VSMPS_1_HW_HP_REQ_1_VALID_WIDTH 1
...
#define VSMPS_1_HW_HP_REQ_1_VALID_PARAM_MASK  0x1
...
//   
//  
#define VSMPS_2_HW_HP_REQ_1_VALID_MASK 0x2U
...
//   
//  
#define VSMPS_3_HW_HP_REQ_1_VALID_MASK 0x4U
...
//   
//  
#define VANA_HW_HP_REQ_1_VALID_MASK 0x8U
...
//   
//  
#define VPLL_HW_HP_REQ_1_VALID_MASK 0x10U
...
//   
//  
#define VAUX_1_HW_HP_REQ_1_VALID_MASK 0x20U
...
//   
//  
#define VAUX_2_HW_HP_REQ_1_VALID_MASK 0x40U
...
//   
//  
#define VAUX_3_HW_HP_REQ_1_VALID_MASK 0x80U
...
//  supply.
//  Register SupplyControlHardwareValid2 0x030A, Bits 0:0, typedef hardware_validation
//   
//  
#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_MASK 0x1U
#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_OFFSET 0
#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_STOP_BIT 0
#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_START_BIT 0
#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_WIDTH 1

#define SUPPLY_CONTROL_HARDWARE_VALID_2_REG 0x30A

#define VEXT_SUPPLY_1_HW_HP_REQ_1_VALID_PARAM_MASK  0x1
...
//   
//  
#define VEXT_SUPPLY_2_HW_HP_REQ_1_VALID_MASK 0x2U
...
//   
//  
#define VEXT_SUPPLY_3_HW_HP_REQ_1_VALID_MASK 0x4U
...
//   
//  
#define VMOD_HW_HP_REQ_1_VALID_MASK 0x8U
...
//  supply.
//  Register SupplyControlHardwareValid3 0x030B, Bits 0:0, typedef hardware_validation
//   
//  
#define VSMPS_1_HW_HP_REQ_2_VALID_MASK 0x1U
#define VSMPS_1_HW_HP_REQ_2_VALID_OFFSET 0
#define VSMPS_1_HW_HP_REQ_2_VALID_STOP_BIT 0
#define VSMPS_1_HW_HP_REQ_2_VALID_START_BIT 0
#define VSMPS_1_HW_HP_REQ_2_VALID_WIDTH 1

#define SUPPLY_CONTROL_HARDWARE_VALID_3_REG 0x30B

#define VSMPS_1_HW_HP_REQ_2_VALID_PARAM_MASK  0x1
...
//  supply.
//  Register SupplyControlHardwareValid3 0x030B, Bits 1:1, typedef hardware_validation
//   
//  
#define VSMPS_2_HW_HP_REQ_2_VALID_MASK 0x2U
...
//  supply.
//  Register SupplyControlHardwareValid3 0x030B, Bits 2:2, typedef hardware_validation
//   
//  
#define VSMPS_3_HW_HP_REQ_2_VALID_MASK 0x4U
...
//  Register SupplyControlHardwareValid3 0x030B, Bits 3:3, typedef hardware_validation
//   
//  
#define VANA_HW_HP_REQ_2_VALID_MASK 0x8U
...
//  Register SupplyControlHardwareValid3 0x030B, Bits 4:4, typedef hardware_validation
//   
//  
#define VPLL_HW_HP_REQ_2_VALID_MASK 0x10U
...
//  Register SupplyControlHardwareValid3 0x030B, Bits 5:5, typedef hardware_validation
//   
//  
#define VAUX_1_HW_HP_REQ_2_VALID_MASK 0x20U
...
//  Register SupplyControlHardwareValid3 0x030B, Bits 6:6, typedef hardware_validation
//   
//  
#define VAUX_2_HW_HP_REQ_2_VALID_MASK 0x40U
...
//  Register SupplyControlHardwareValid3 0x030B, Bits 7:7, typedef hardware_validation
//   
//  
#define VAUX_3_HW_HP_REQ_2_VALID_MASK 0x80U
...
//  supply.
//  Register SupplyControlHardwareValid4 0x030C, Bits 0:0, typedef hardware_validation
//   
//  
#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_MASK 0x1U
#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_OFFSET 0
#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_STOP_BIT 0
#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_START_BIT 0
#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_WIDTH 1

#define SUPPLY_CONTROL_HARDWARE_VALID_4_REG 0x30C

#define VEXT_SUPPLY_1_HW_HP_REQ_2_VALID_PARAM_MASK  0x1
...
//  supply.
//  Register SupplyControlHardwareValid4 0x030C, Bits 1:1, typedef hardware_validation
//   
//  
#define VEXT_SUPPLY_2_HW_HP_REQ_2_VALID_MASK 0x2U
...
//  supply.
//  Register SupplyControlHardwareValid4 0x030C, Bits 2:2, typedef hardware_validation
//   
//  
#define VEXT_SUPPLY_3_HW_HP_REQ_2_VALID_MASK 0x4U
...
//  Register SupplyControlHardwareValid4 0x030C, Bits 3:3, typedef hardware_validation
//   
//  
#define VMOD_HW_HP_REQ_2_VALID_MASK 0x8U
...
//   
//  
#define VAPE_SW_HP_REQ_VALID_MASK 0x1U
...
//   
//  
#define VARM_SW_HP_REQ_VALID_MASK 0x2U
...
//   
//  
#define VSMPS_1_SW_HP_REQ_VALID_MASK 0x4U
...
//   
//  
#define VSMPS_2_SW_HP_REQ_VALID_MASK 0x8U
...
//   
//  
#define VSMPS_3_SW_HP_REQ_VALID_MASK 0x10U
...
//   
//  
#define VANA_SW_HP_REQ_VALID_MASK 0x20U
...
//   
//  
#define VPLL_SW_HP_REQ_VALID_MASK 0x40U
...
//   
//  
#define VAUX_1_SW_HP_REQ_VALID_MASK 0x80U
...
//   
//  
#define VAUX_2_SW_HP_REQ_VALID_MASK 0x1U
...
//   
//  
#define VAUX_3_SW_HP_REQ_VALID_MASK 0x2U
...
//   
//  
#define VEXT_SUPPLY_1_SW_HP_REQ_VALID_MASK 0x4U
...
//   
//  
#define VEXT_SUPPLY_2_SW_HP_REQ_VALID_MASK 0x8U
...
//   
//  
#define VEXT_SUPPLY_3_SW_HP_REQ_VALID_MASK 0x10U
...
//   
//  
#define VMOD_SW_HP_REQ_VALID_MASK 0x20U
...
//   
//  
#define SYS_CLK_REQ_2_VALID_1_MASK 0x2U
...
//   
//  
#define SYS_CLK_REQ_3_VALID_1_MASK 0x4U
...
//   
//  
#define SYS_CLK_REQ_4_VALID_1_MASK 0x8U
...
//   
//  
#define SYS_CLK_REQ_5_VALID_1_MASK 0x10U
...
//   
//  
#define SYS_CLK_REQ_6_VALID_1_MASK 0x20U
...
//   
//  
#define SYS_CLK_REQ_7_VALID_1_MASK 0x40U
...
//   
//  
#define SYS_CLK_REQ_8_VALID_1_MASK 0x80U
...
//   
//  
#define SYS_CLK_REQ_2_VALID_2_MASK 0x2U
...
//   
//  
#define SYS_CLK_REQ_3_VALID_2_MASK 0x4U
...
//   
//  
#define SYS_CLK_REQ_4_VALID_2_MASK 0x8U
...
//   
//  
#define SYS_CLK_REQ_5_VALID_2_MASK 0x10U
...
//   
//  
#define SYS_CLK_REQ_6_VALID_2_MASK 0x20U
...
//   
//  
#define SYS_CLK_REQ_7_VALID_2_MASK 0x40U
...
//   
//  
#define SYS_CLK_REQ_8_VALID_2_MASK 0x80U
...
//  0: doesn't valid SW to request Vape supply 
//  1: valid SW to request Vape supply.
//  Register ReguVaux4ReqValid 0x0311, Bits 0:0, typedef sys_clock_request
//   
//  
#define VAUX_4_SW_HP_REQ_VALID_MASK 0x1U
#define VAUX_4_SW_HP_REQ_VALID_OFFSET 0
#define VAUX_4_SW_HP_REQ_VALID_STOP_BIT 0
#define VAUX_4_SW_HP_REQ_VALID_START_BIT 0
#define VAUX_4_SW_HP_REQ_VALID_WIDTH 1

#define REGU_VAUX_4_REQ_VALID_REG 0x311

#define VAUX_4_SW_HP_REQ_VALID_PARAM_MASK  0x1
...
//  Register ReguVaux4ReqValid 0x0311, Bits 1:1, typedef sys_clock_request
//   
//  
#define VAUX_4_HW_HP_REQ_2_VALID_MASK 0x2U
#define VAUX_4_HW_HP_REQ_2_VALID_OFFSET 1
#define VAUX_4_HW_HP_REQ_2_VALID_STOP_BIT 1
#define VAUX_4_HW_HP_REQ_2_VALID_START_BIT 1
#define VAUX_4_HW_HP_REQ_2_VALID_WIDTH 1


#define VAUX_4_HW_HP_REQ_2_VALID_PARAM_MASK  0x2
...
//  Register ReguVaux4ReqValid 0x0311, Bits 2:2, typedef sys_clock_request
//   
//  
#define VAUX_4_HW_HP_REQ_1_VALID_MASK 0x4U
#define VAUX_4_HW_HP_REQ_1_VALID_OFFSET 2
#define VAUX_4_HW_HP_REQ_1_VALID_STOP_BIT 2
#define VAUX_4_HW_HP_REQ_1_VALID_START_BIT 2
#define VAUX_4_HW_HP_REQ_1_VALID_WIDTH 1


#define VAUX_4_HW_HP_REQ_1_VALID_PARAM_MASK  0x4
...
//  Register ReguVaux4ReqValid 0x0311, Bits 3:3, typedef sys_clock_request
//   
//  
#define VAUX_4_SYS_CLK_REQ_1HP_VALID_MASK 0x8U
#define VAUX_4_SYS_CLK_REQ_1HP_VALID_OFFSET 3
#define VAUX_4_SYS_CLK_REQ_1HP_VALID_STOP_BIT 3
#define VAUX_4_SYS_CLK_REQ_1HP_VALID_START_BIT 3
#define VAUX_4_SYS_CLK_REQ_1HP_VALID_WIDTH 1


#define VAUX_4_SYS_CLK_REQ_1HP_VALID_PARAM_MASK  0x8
...
//   
//  
#define VT_VOUT_MASK 0x2U
#define VT_VOUT_OFFSET 1
#define VT_VOUT_STOP_BIT 1
#define VT_VOUT_START_BIT 1
#define VT_VOUT_WIDTH 1
...
//   
//  
#define VINT_CORE_12_ENA_MASK 0x4U
...
#define VINT_CORE_12_SEL_MASK 0x38U
...
//   
//  
#define LOW_POWER_MODE_MASK 0x40U
...
//   
//  
#define VT_VOUT_LOW_POWER_MASK 0x80U
...
//   
//  
#define OTG_SUPPLY_MASK 0x1U
#define OTG_SUPPLY_OFFSET 0
#define OTG_SUPPLY_STOP_BIT 0
#define OTG_SUPPLY_START_BIT 0
#define OTG_SUPPLY_WIDTH 1
...
#define OTG_SUPPLY_PARAM_MASK  0x1
...
//   
//  
#define OTG_SUPPLY_FORCE_LP_MASK 0x2U
...
#define OTG_SUPPLY_FORCE_LP_PARAM_MASK  0x2
...
//   
//  
#define VBUS_BIS_MASK 0x8U
#define VBUS_BIS_OFFSET 3
#define VBUS_BIS_STOP_BIT 3
#define VBUS_BIS_START_BIT 3
#define VBUS_BIS_WIDTH 1
...
#define VBUS_BIS_PARAM_MASK  0x8
...
//   
//  
#define VUSB_MASK 0x1U
#define VUSB_OFFSET 0
#define VUSB_STOP_BIT 0
#define VUSB_START_BIT 0
#define VUSB_WIDTH 1
...
//   
//  
#define VBUS_LOW_POWER_MODE_MASK 0x2U
...
//  Register UsbSupplyControl 0x0382, Bits 4:4, typedef v_usb_turn_off
//   
//  
#define V_USB_TURN_OFF_MASK 0x10U
#define V_USB_TURN_OFF_OFFSET 4
#define V_USB_TURN_OFF_STOP_BIT 4
#define V_USB_TURN_OFF_START_BIT 4
#define V_USB_TURN_OFF_WIDTH 1


typedef enum v_usb_turn_off {
    UNMASK_VBUS_OVER_VOLATGE_E,
    MASK_VBUS_OVER_VOLATGE_E
} V_USB_TURN_OFF_T ;
#define V_USB_TURN_OFF_PARAM_MASK  0x10
...
#define AUDIO_SUPPLY_PARAM_MASK  0x2
...
//   
//  
#define DIGITAL_MIC_SUPPLY_MASK 0x4U
...
#define DIGITAL_MIC_SUPPLY_PARAM_MASK  0x4
...
//   
//  
#define ANALOG_MIC_1_SUPPLY_MASK 0x8U
...
#define ANALOG_MIC_1_SUPPLY_PARAM_MASK  0x8
...
//   
//  
#define VNEGATIVE_MIC_2_SUPPLY_MASK 0x10U
...
#define VNEGATIVE_MIC_2_SUPPLY_PARAM_MASK  0x10
...
//  Register RegulatorControl1 0x0384, Bits 0:0, typedef impedance
//   
//  
#define VAMIC_1_POLARITY_MASK 0x1U
...
#define  OUPPUT_GROUNDED 0
#define  OUTPUT_HIGH_IMPEDANCE 1

typedef enum impedance {
    OUPPUT_GROUNDED_E,
...
//  Register RegulatorControl1 0x0384, Bits 1:1, typedef impedance
//   
//  
#define VAMIC_2_POLARITY_MASK 0x2U
...
//  0: output in high impedance when Vamic1 is disabled 
//  1: output is grounded when Vamic1 is disabled.
//  Register RegulatorControl2 0x0385, Bits 0:0, typedef impedance
//   
//  
#define VAMIC_2_IMPEDANCE_MASK 0x1U
#define VAMIC_2_IMPEDANCE_OFFSET 0
#define VAMIC_2_IMPEDANCE_STOP_BIT 0
#define VAMIC_2_IMPEDANCE_START_BIT 0
#define VAMIC_2_IMPEDANCE_WIDTH 1

#define REGULATOR_CONTROL_2_REG 0x385
#define  OUPPUT_GROUNDED 0
#define  OUTPUT_HIGH_IMPEDANCE 1

#define VAMIC_2_IMPEDANCE_PARAM_MASK  0x1



//  
//  0: disable 
//  1: allow to active the command setting the output of the VsimLDO on a High Impedance 
//  state..
//  Register RegulatorControl3 0x0386, Bits 0:0, typedef impedance
//   
//  
#define VSIM_LDO_POLARITY_MASK 0x1U
#define VSIM_LDO_POLARITY_OFFSET 0
#define VSIM_LDO_POLARITY_STOP_BIT 0
#define VSIM_LDO_POLARITY_START_BIT 0
#define VSIM_LDO_POLARITY_WIDTH 1

#define REGULATOR_CONTROL_3_REG 0x386
#define  OUPPUT_GROUNDED 0
#define  OUTPUT_HIGH_IMPEDANCE 1

#define VSIM_LDO_POLARITY_PARAM_MASK  0x1
