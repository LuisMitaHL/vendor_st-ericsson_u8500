/****************************************************************************
 * File : c:/Lisp/Production/ab9540/ab9540_ADC/Linux/ab9540_ADC_types.h
 * 
 *
...
#ifndef C__LISP_PRODUCTION_AB9540_AB9540_ADC_LINUX_AB9540_ADC_TYPES_H
#define C__LISP_PRODUCTION_AB9540_AB9540_ADC_LINUX_AB9540_ADC_TYPES_H
...
//   
//  
#define ADC_MASK 0x1U
#define ADC_OFFSET 0
#define ADC_STOP_BIT 0
#define ADC_START_BIT 0
#define ADC_WIDTH 1
...
#define ADC_TRIGGER_PARAM_MASK  0x2



//  
//  0: inactive 
//  1: Launch an ADC conversion(this bit is auto-cleared, once the conversion is 
//  launched).
//  Register AdcControl 0x0A00, Bits 2:2, typedef adc_man_convert_enable
//   
//  
#define ADC_MAN_CONVERT_MASK 0x4U
...
#define ADC_MAN_CONVERT_PARAM_MASK  0x4
...
#define ADC_AUTO_REQ_PARAM_MASK  0x8
...
//   
//  
#define ADC_TRIG_EDGE_MASK 0x10U
...
#define ADC_TRIG_EDGE_PARAM_MASK  0x10
...
//   
//  
#define PULL_UP_SUPPLY_MASK 0x20U
...
#define ADC_BUFFER_PARAM_MASK  0x40
...
//   
//  
#define CHARGING_CURRENT_SENSE_MASK 0x80U
...
#define CHARGING_CURRENT_SENSE_PARAM_MASK  0x80
...
//   
//  
#define ADC_SELECT_INPUT_MASK 0x1FU
...
//   
//  
#define SAMPLE_TO_AVERAGE_MASK 0x60U
...
//   
//  
#define ADC_SELECT_INPUT_TRIC_MASK 0x1FU
...
//   
//  
#define SAMPLE_TO_AVERAGE_TRIG_MASK 0x60U
...
//   
//  
#define ADC_TIME_DELAY_MASK 0xFFU
