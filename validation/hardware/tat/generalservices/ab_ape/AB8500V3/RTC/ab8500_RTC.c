 ...
 *
 * Notes : From register 0x0F00, bits 7:7
 *
 **************************************************************************/
unsigned char get_rtc_thermal_shutdown()
  {
     ...
     */ 
    value = (I2CRead(SWITCH_OFF_STATUS_REG) & THERMAL_SHUTDOWN_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char get_no_signal_c_lock32()
  {
     ...
     * Khz clock. 
     */ 
    value = (I2CRead(SWITCH_OFF_STATUS_REG) & NO_SIGNAL_C_LOCK_32_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_coulomb_counter_power_off()
  {
     ...
     * 1: enable Coulomb Counter 
     */ 
    value = (I2CRead(COULOMB_COUNTER_REG) & COULOMB_COUNTER_POWER_OFF_ENABLE_PARAM_MASK);
    return value;
  }
...
unsigned char get_rtc_write_request()
  {
     ...
     * Cleared upon data transfert in watchtim register is done 
     */ 
    value = (I2CRead(RTC_READ_REQUEST_REG) & RTC_WRITE_ENABLE_PARAM_MASK) >> 1;
    return value;
  }
...
unsigned char get_charge_backup_battery()
  {
     ...
     * OFF mode 
     */ 
    value = (I2CRead(RTC_STATUS_REG) & CHARGE_BACKUP_BATTERY_ENABLE_PARAM_MASK) >> 5;
    return value;
  }
...
unsigned char get_backup_charger_enable()
  {
     ...
     * Enable/Disable Backup charger 
     */ 
    value = (I2CRead(RTC_STATUS_REG) & BACKUP_CHARGER_ENABLE_PARAM_MASK) >> 4;
    return value;
  }
...
unsigned char get_backup_present_enable()
  {
     ...
     * Enable/Disable Backup Present 
     */ 
    value = (I2CRead(RTC_STATUS_REG) & BACKUP_PRESENT_ENABLE_PARAM_MASK) >> 3;
    return value;
  }
...
unsigned char get_rtc_alarm_enable()
  {
     ...
     * Enable/Disable RTC Alarm 
     */ 
    value = (I2CRead(RTC_STATUS_REG) & RTC_ALARM_ENABLE_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_rtc_status_data()
  {
     ...
     * Set at 1 by Software and then reset if RTC supply fail 
     */ 
    value = (I2CRead(RTC_STATUS_REG) & RTC_STATUS_DATA_PARAM_MASK);
    return value;
  }
 ...
 *
 **************************************************************************/
unsigned char set_backup_current_select( )
  {
    unsigned char value = 0;
    unsigned char old_value;
...
unsigned char get_backup_current_select()
  {
     ...
     * Backup charger current intensity selection 
     */ 
    value = (I2CRead(RTC_BACKUP_CHARGER_REG) & BACKUP_CURRENT_SELECT_PARAM_MASK) >> 2;
    return value;
  }
 ...
 *
 **************************************************************************/
unsigned char set_backup_voltage_select( )
  {
    unsigned char value = 0;
    unsigned char old_value;
...
unsigned char get_backup_voltage_select()
  {
     ...
     * Backup charger voltage selection 
     */ 
    value = (I2CRead(RTC_BACKUP_CHARGER_REG) & BACKUP_VOLTAGE_SELECT_PARAM_MASK);
    return value;
  }
...
unsigned char get_backup_force()
  {
     ...
     * Force backup battery as supply for RTC block 
     */ 
    value = (I2CRead(RTC_C_FORCE_BACKUP_REG) & BACKUP_FORCE_PARAM_MASK);
    return value;
  }
 ...
 *
 * RET  : Return the value of register RtcClockStatus
 *
...
unsigned char get_oscillator32k_status()
  {
     ...
     */ 
    value = (I2CRead(RTC_CLOCK_STATUS_REG) & OSCILLATOR_3_2K_STATUS_PARAM_MASK) >> 2;
    return value;
  }
...
unsigned char get_clock32_status()
  {
     ...
     */ 
    value = (I2CRead(RTC_CLOCK_STATUS_REG) & CLOCK_32_STATUS_PARAM_MASK);
    return value;
  }
