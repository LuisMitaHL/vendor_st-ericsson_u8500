...
unsigned char get_main_charger_over_current_mask()
  {
     ...
     * Icharge > Icharge max programmed detected 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_3_REG) & CAIN_CHARGER_OVER_CURRENT_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_xtal32_ok_mask( enum xtal32_ok_mask_set param )
  {
     ...
     */ 
    switch( param ){
        case XTAL_32_OK_MASK_SET_E: 
           value = old_value | XTAL_32_OK_MASK_SET_PARAM_MASK; 
           break;
        case XTAL_32_OK_MASK_RESET_SET_E: 
           value = old_value & ~ XTAL_32_OK_MASK_SET_PARAM_MASK;
           break;
    }
...
unsigned char get_xtal32_ok_mask()
  {
     ...
     * 1: XTAL startup time failure masked 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_22_REG) & XTAL_32_OK_MASK_SET_PARAM_MASK) >> 7;
    return value;
  }
...
unsigned char set_charging_current_limited_h_s_chirp_mask( enum charging_current_limited_h_s_chirp_mask_set param )
  {
     ...
     */ 
    switch( param ){
        case CHARGING_CURRENT_LIMITED_HS_CHIRP_MASK_SET_E: 
           value = old_value | CHARGING_CURRENT_LIMITED_HS_CHIRP_MASK_SET_PARAM_MASK; 
           break;
        case CHARGING_CURRENT_LIMITED_HS_CHIRP_MASK_RESET_SET_E: 
           value = old_value & ~ CHARGING_CURRENT_LIMITED_HS_CHIRP_MASK_SET_PARAM_MASK;
           break;
    }
...
unsigned char get_charging_current_limited_h_s_chirp_mask()
  {
     ...
     * 1: IT_ChargingCurrentLimitedHSChirp masked 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_22_REG) & CHARGING_CURRENT_LIMITED_HS_CHIRP_MASK_SET_PARAM_MASK) >> 6;
    return value;
  }
 ...
 * RET  : Return the value of register MaskedInterrupt22
 *
 * Notes : From register 0x0E55, bits 5:5
 *
 **************************************************************************/
unsigned char set_charging_current_no_more_limited_mask( enum charging_current_no_more_limited_mask_set param )
  {
     ...
     */ 
    switch( param ){
        case CHARGING_CURRENT_NO_MORE_LIMITED_MASK_SET_E: 
           value = old_value | CHARGING_CURRENT_NO_MORE_LIMITED_MASK_SET_PARAM_MASK; 
           break;
        case CHARGING_CURRENT_NO_MORE_LIMITED_MASK_RESET_SET_E: 
           value = old_value & ~ CHARGING_CURRENT_NO_MORE_LIMITED_MASK_SET_PARAM_MASK;
           break;
    }
...
unsigned char get_charging_current_no_more_limited_mask()
  {
     ...
     * 1: IT_ChargingCurrentNoMoreLimited masked 
     */ 
    value = (I2CRead(MASKED_INTERRUPT_22_REG) & CHARGING_CURRENT_NO_MORE_LIMITED_MASK_SET_PARAM_MASK) >> 5;
    return value;
  }
