...
amixer cset iface=MIXER,name='LineIn Master Gain Capture Volume' 0 0
amixer cset iface=MIXER,name='Mic Master Gain Capture Volume' 32 32
...
amixer cset iface=MIXER,name='Mic 1 Capture Volume' 15
amixer cset iface=MIXER,name='Mic 2 Capture Volume' 15
...
amixer cset iface=MIXER,name='Earpiece Playback Switch' off
amixer cset iface=MIXER,name='Earpiece Source Playback Route' 'Headset Left'
amixer cset iface=MIXER,name='Headset Right Playback Switch' on
amixer cset iface=MIXER,name='Headset Left Playback Switch' on
