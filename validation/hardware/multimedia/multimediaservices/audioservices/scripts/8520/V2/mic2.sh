...
amixer cset iface=MIXER,name='Mic 2' Enabled
...
amixer cset iface=MIXER,name='AD 5 Select Capture Route' 'Mic 2'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 0 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 1 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 2 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 3 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 4 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 5 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 6 Map' 'AD_OUT5'
amixer cset iface=MIXER,name='Digital Interface AD To Slot 7 Map' 'AD_OUT5'
