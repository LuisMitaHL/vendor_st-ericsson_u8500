...
export LOGFILE=/var/log/Video_640-480_Primary_Camera.log
...
echo " " | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
echo "****************** Take Video 640*480 Primary camera tests ******************" | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
...
# Verdict result
echo " "
echo "Take Video from primary sensor 640*480:......................... $TakeVidPrim" | tee -a $LOGFILE
