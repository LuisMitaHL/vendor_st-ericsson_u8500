...
export LOGFILE=/var/log/BB_registerMMCI.log
if [ -f $LOGFILE ]; then
  rm $LOGFILE
fi
...
echo " " | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
echo "***************************** BB Registers MMCI *****************************" | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
...
while [ "$INC" != 6 ]
 ...
 then
  ...
  while [ "$NBline" != 0 ]
   ...
   case "$Reg" in
    MMCI-0  )    echo "Read MMCI-0 BB registers:............. $verdict" | tee -a $LOGFILE;;
    MMCI-1  )    echo "Read MMCI-1 BB registers:............. $verdict" | tee -a $LOGFILE;;
    MMCI-2  )    echo "Read MMCI-2 BB registers:............. $verdict" | tee -a $LOGFILE;;
    MMCI-3  )    echo "Read MMCI-3 BB registers:............. $verdict" | tee -a $LOGFILE;;
    MMCI-4  )    echo "Read MMCI-4 BB registers:............. $verdict" | tee -a $LOGFILE;;
    MMCI-5  )    echo "Read MMCI-5 BB registers:............. $verdict" | tee -a $LOGFILE;;
    * ) exit;;
  esac
  fi
