...
export LOGFILE=/var/log/BB_registerCLK.log
if [ -f $LOGFILE ]; then
  rm $LOGFILE
fi
...
echo " " | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
echo "***************************** BB Registers CLK ******************************" | tee -a $LOGFILE
echo "*****************************************************************************" | tee -a $LOGFILE
...
while [ "$INC" != 5 ]
 ...
 case "$Reg" in
  CLK_RST1  )   echo "Read CLK_RST1 BB registers:........... $verdict" | tee -a $LOGFILE;;
  CLK_RST2  )   echo "Read CLK_RST2 BB registers:........... $verdict" | tee -a $LOGFILE;;
  CLK_RST3  )   echo "Read CLK_RST3 BB registers:........... $verdict" | tee -a $LOGFILE;;
  CLK_RST5  )   echo "Read CLK_RST5 BB registers:........... $verdict" | tee -a $LOGFILE;;
  CLK_RST6  )   echo "Read CLK_RST6 BB registers:........... $verdict" | tee -a $LOGFILE;;
  * ) exit;;
  esac
  fi
