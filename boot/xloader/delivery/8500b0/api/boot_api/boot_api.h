 ...
 * 
 * \note This module provides Boot API reuse definition for ISSW/X_Loader.c file 
 *       implementation.\n
 *
 * @{
 */
...
/** \mainpage STN8500 BOOT ROM code documentation 
 *  \n\n\n
 ...
 *  is the jump table BOOT_Reuse[] address.
 *  \n
 ...
 *\n
 * \subsection flash_api FLASH BOOT API REUSE MACROS 
 * - ROM_SHARED_FLASH_DETECT(a,b,c,jmp_table) Macro to call FLASH_DetectAndInit() function. \n
 * - ROM_SHARED_FLASH_TOC_SEARCH(a,b,c,jmp_table) Macro to call FLASH_TocSearch() function. \n
 * - ROM_SHARED_FLASH_READ(a,b,c,d,jmp_table) Macro to call FLASH_Read() function. \n
 *\n
...
/* FLASH BOOT API REUSE DEFINE */
#define BOOT_API_FLASH_DETECT					4
#define BOOT_API_FLASH_TOC_SEARCH				5
#define BOOT_API_FLASH_READ						6

/* MMC API function */
#define BOOT_API_MMC_DETECT_AND_INIT            7
#define BOOT_API_MMC_TOC_SEARCH                 8
#define BOOT_API_MMC_READ                       9   
...
#define BOOT_API_UART_INIT			        	24
#define BOOT_API_UART_SEND_DATA		    		25
#define BOOT_API_UART_GET_DATA		        	26
#define BOOT_API_UART_WAIT_FOR_DATA	    		27
#define BOOT_API_UART_GET_NB_BYTES_REC	    	28
#define BOOT_API_UART_STOP						29
#define BOOT_API_UART_TRANSMIT_TX_CHAR			30
#define BOOT_API_UART0_IT_PROCESS               31
#define BOOT_API_UART1_IT_PROCESS          		32
#define BOOT_API_UART2_IT_PROCESS               33  

/* SECURE API REUSE DEFINE */
#define BOOT_API_PUBLIC_DISPACHER	            34 

/* LOADER API REUSE DEFINE */
#define BOOT_API_PUB_LOAD_IMAGE 			    35

/* PUBLIC API REUSE DEFINE */
#define BOOT_API_WAKEUP_CPU1     			    36

/*additionnal USB API REUSE DEFINE*/
#define BOOT_API_USB_CUST_WRITE_DATA            37
#define BOOT_API_USB_GET_NB_BYTES_SENT          38
#define BOOT_API_USB_READ_LLI_CONF              39
#define BOOT_API_USB_CHANGE_LLI_CONF            40

/*additionnal MMC API REUSE DEFINE*/
#define BOOT_API_MMC_SET_WIDE_BUS               41

/*DMA API REUSE DEFINE*/
#define BOOT_API_DMA_INIT                       42
#define BOOT_API_DMA_IT_PROCESS                 43

/*additionnal USB API REUSE DEFINE*/
#define BOOT_API_USB_CUST_READ_DATA             44
#define BOOT_API_USB_CUST_SET_TRANS_MODE        45
#define BOOT_API_USB_CUST_SET_EXT_EVENT_HANDLER 46
...
/* FLASH BOOT API REUSE DEFINE */
#define ROM_SHARED_FLASH_DETECT(a,b,c,jmp_table) \
((t_boot_error (*)(t_FlashType*,t_flash_FSMC_bank,t_flash_detection_width)) jmp_table[BOOT_API_FLASH_DETECT])(a,b,c)

#define ROM_SHARED_FLASH_TOC_SEARCH(a,b,c,jmp_table) \
((t_boot_error (*)(t_FlashType*,t_flash_nand_block,t_address*))jmp_table[BOOT_API_FLASH_TOC_SEARCH])(a,b,c)

#define ROM_SHARED_FLASH_READ(a,b,c,d,jmp_table) \
((t_boot_error (*)(t_FlashType*,t_address,t_uint8*,t_size))jmp_table[BOOT_API_FLASH_READ])(a,b,c,d)
...
((void (*)(t_secure_rom_boot_info*,t_usb_descriptor_list*))jmp_table[BOOT_API_USB_INIT])(a,b)
...
((t_uint32 (*)(void))jmp_table[BOOT_API_USB_CUST_DISCONNECT])()
