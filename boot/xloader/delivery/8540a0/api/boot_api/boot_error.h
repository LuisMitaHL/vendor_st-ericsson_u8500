...
/** \file boot_error.h
 *  \author ST Ericsson
 *  \brief This header file provides error list for Boot ROM.
 */
/*---------------------------------------------------------------------------*/
...
#define	BOOT_ERROR_INVALID_MEMORY       	0xA001003A /**< Input memory not initialized. */
#define BOOT_ERROR_NO_FLASH					0xA001003B /**< No Flash Memory found */
#define BOOT_ERROR_ONFI_INVALID_PARAM		0xA001003C /**< ONFI parameter page not found */
#define BOOT_ERROR_PAGE_NOT_SUPPORTED       0xA001003D /**< Page size < 2K or > 8K */
#define BOOT_ERROR_FSMC_ECC_TIMEOUT			0xA001003E /* TImeout for waiting ECC ready in the fSMC */
/* Interface errors */
...
/** DMA Errors */ 
#define BOOT_ERROR_DMA_CHAN_IN_ERROR        0xA00100D1  /**<  DMA channel error                            */
#define BOOT_ERROR_DMA_NO_IT_ON_USB_CHAN    0xA00100D0  /**< DMA error. No DMA set for USB              */
#define BOOT_ERROR_DMA_CHAN_IS_EXTENDED     0xA00100D2  /**< \internal DMA error. DMA channel is extended */
#define BOOT_ERROR_DMA_CHAN_IS_SECURE       0xA00100D3  /**< \internal DMA error. DMA channel is secured */


/** CRKC Errors */ 
#define BOOT_ERROR_CRKC_TOC_READING         0xA00100E0  /* CRKC Error : TOC invalid         */
#define BOOT_ERROR_CRKC_IMPORT              0xA00100E1  /* CRKC Error : Import code failed  */
#define BOOT_ERROR_CRKC_MISSING             0xA00100E2  /* CRKC Error : CRKC missing        */
