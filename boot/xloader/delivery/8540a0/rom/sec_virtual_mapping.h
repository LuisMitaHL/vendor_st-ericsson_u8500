 ...
 *  \author     ST Ericsson
 *  \brief      This module contains the description of the logical of the secure-side.
 */
/*----------------------------------------------------------------------*/
...
//--------------------------------------------------------------------
    ...
    #define SEC_VIRT_AREA_TOP               0x40040FFF
    ...
    #define SEC_VIRT_INIT_STACK_TOP         0x40005FFF
