 ...
 * -----------------------------------------------------------------
 *
 *  GCC Link definitions for U8500
 *
 * -----------------------------------------------------------------
 */
...
.XLOADER_COPY_ADDRESS = 0x400227A8;
.XLOADER_STACK_ADDRESS = 0x40098000;

MEMORY
{
    XLOADER : ORIGIN = 0x400227A8, LENGTH = 0x40098000 - 0x400227A8
    STACK   : ORIGIN = 0x40098000, LENGTH = 0x2000
}
...
SECTIONS
{
   ...
   .xloader :
    ...
    /* Area reserved for PA section */
    .xloader_pa_section :
    {
        .xloader_pa_section_start = . ;
        . += 0xC800;
        .xloader_pa_section_end = . ;
    } > XLOADER
...
/*
  ...
  PROVIDE (linker_xloader_bss_size = (.xloader_bss_end - .xloader_bss_start) );
