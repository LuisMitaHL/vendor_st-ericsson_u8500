 ...
 * Restricted to only be called from Xloader or equivalent.
 *
 * @param [in]     hashtype     Inbuffer containing type of hash.
 * @param [in]     payload      Payload to calculate hash on
 * @param [in]     payload_size Payload size (bytes)
 * @param [in]     ehash        Expected hash
 * @param [in]     ehash_size   Size of expected hash (bytes)
 *
 * @return bass_return_code
 * @retval BASS_RC_SUCCESS      Successfully performed check
 * @retval BASS_RC_FAILURE      Check failed
 */
 ...
 * Restricted to only be called from Xloader or equivalent.
 *
 * @param [in]   bootp_data	Struct holding data to be sent
 *
 * @return bass_return_code
 * @retval BASS_RC_SUCCESS      Successfully handled data
 * @retval BASS_RC_FAILURE      Check failed
 */
bass_return_code bass_handle_bootp_magic(bass_handle_bootp_magic_t* bootp_data);
/*
 * @brief issw_api_reset
 *
 * The following function reset the system.
 *
 * @param void
 * @return bool
 * @retval true The result succeeded.
