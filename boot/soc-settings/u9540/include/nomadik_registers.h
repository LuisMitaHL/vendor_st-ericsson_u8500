...
//                   SOC  PLL Managment    
    ...
    t_uint32                    unused_10b[(0x3C0-0x344)>>2]; //0x344-3FC PMB
    t_thsens_registers          thsens_registers;         //0x3C0-0x3D4
    t_uint32                    prcm_pmb[(0x400-0x3D8)>>2]; //0x344-3FC PMB
...
typedef struct
{
    ...
    t_scr_spr_reg       ScratchPad[2];                  // 0x0090...0x0094
    ...
    t_uint32            Interlv;                        // 0x00B4
    t_uint32            C2CAddrOffset;                  // 0x00B8
    t_uint32            Reserved3[(0x0C0-0x0BC)>>2];    // 0x00BC
