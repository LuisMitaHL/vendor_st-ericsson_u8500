...
const uint32_t imad[] = {
    ...
    (uint32_t)IMAD_TYPE_WRITE_EMBEDDED,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->DDRShareHighAddrCheck)), /* reset modem/APE shared DDR configuration */
    (uint32_t)sizeof(uint32_t),
    /* data */
    (uint32_t)0xFFFFFFFF,
    /* No padding */
    ...
    (uint32_t)IMAD_TYPE_WRITE_BITMAP_EMBEDDED,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->Interlv)),/* interleaving */
    (uint32_t)2*sizeof(uint32_t),
    /* data */
    ...
    (uint32_t)IMAD_SEQUENCE_INTERLEAVING,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->Interlv)), /* set interleaving config */
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_INTERLEAVING,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->Interlv)), /* Re-enable if needed */
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */

    /* sequence C2C_INIT: Set C2C init data */
    (uint32_t)IMAD_SEQUENCE_C2C_INIT,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_SecMap *)TCDMsec)->C2cInitData)), /* C2C init data */
    (uint32_t)sizeof(sPrcmuApi_C2cInitData_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)((uint32_t*)(SEC_BACKUP_RAM_START_ADDR + 0x19F8)), /* Store DDRSECONLYLOW in Secure Backup Ram */
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)((uint32_t*)(SEC_BACKUP_RAM_START_ADDR + 0x19FC)), /* Store DDRSECONLYHIGH in Secure Backup Ram */
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->DDRModemLowAddrCheck)),
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->DDRModemHighAddrCheck)),
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->DDRShareHighAddrCheck)),
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->DDRMaxSpaceAddrCheck)),
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
    ...
    (uint32_t)IMAD_SEQUENCE_WRITE_LVL0_FIREWALL,
    (uint32_t)IMAD_TYPE_WRITE_EXTERNAL,
    (uint32_t)(&(((t_secure_registers *)SEC_REG_START_ADDR)->C2CAddrOffset)),
    (uint32_t)sizeof(uint32_t),
    /* data */
    /* No padding */
#endif
