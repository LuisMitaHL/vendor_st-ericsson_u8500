...
/*---------------------------------------------------------------------------*/
/** \internal
 *  \file nomadik_registers.h
 *  \author ST Ericsson
 *  \brief Use this module to declare the Nomadik Full registers.
 */
/*---------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------
 * Public RAM structures shared by public and secure sides
 *----------------------------------------------------------------------*/
typedef union {
  struct
	{   
		t_bitfield  prccMutex           :1;     // [0]
		const t_bitfield  unused1       :15;    // [15:1]
		
		t_bitfield  isRngRunningByPub   :1;     // [16]
		const t_bitfield  unused2       :2;     // [18:17]
		t_bitfield  isPkaRunningByPub   :1;     // [19]
		t_bitfield  isHash1RunningByPub :1;     // [20]
		t_bitfield  isCrRunningByPub    :1;     // [21]
		const t_bitfield  unused3       :1;     // [22]
		t_bitfield  isMtu1RunningByPub  :1;     // [23]
		
		t_bitfield  isRngRunningBySec   :1;     // [24]
		const t_bitfield  unused4       :2;     // [26:25]
		t_bitfield  isPkaRunningBySec   :1;     // [27]
		t_bitfield  isHash1RunningBySec :1;     // [28]
		t_bitfield  isCrRunningBySec    :1;     // [29]
		const t_bitfield  unused5       :1;     // [30]
		t_bitfield  isMtu1RunningBySec  :1;     // [31]
	} Bit;
	t_uint32  Reg;     
} t_shared_ip_status;
...
/** \internal PC-Card/NAND-Flash Control register */
typedef struct {
  ...
  t_bitfield fifoth:3;        /* FIFO threshold                           */ 
  t_bitfield unused:9;   
} t_fsmc_pcr_reg;

/** \internal FIFO status and interrupt register */
typedef struct {
  t_bitfield ItRisingEdge:1;  /* Interrupt rising edge status bit         */
  t_bitfield ItLevel:1;       /* Interrupt 'level 1' status bit           */
  t_bitfield ItFallingEdge:1; /* Interrupt falling edge status bit        */
  t_bitfield EnRisingEdge:1;  /* Enable IT rising edge detection bit      */
  t_bitfield EnLevel:1;       /* Enable IT level detection bit            */
  t_bitfield EnFallingEdge:1; /* Enable IT falling edge detection bit     */
  t_bitfield Fempt:1;         /* Fifo empty                               */
  t_bitfield ErrType:3;       /* Error type                               */
  t_bitfield ErrFound:4;      /* Error found                              */
  t_bitfield CodeType:1;
  t_bitfield CodeReady:1;
  t_bitfield BCH8:9;          /* 13th bytes for ECC BCH8 computation      */
  t_bitfield reserved:7;
} t_fsmc_sr_reg;

/** \internal Generic timing Register */
typedef struct {
  t_bitfield Set:8;           /* set up time            */
  t_bitfield Wait:8;          /* wait time              */
  t_bitfield Hold:8;          /* hold time              */  
  t_bitfield HiZ:8;           /* data bus HiZ time      */
} t_fsmc_timing_reg;

/** \internal SRAM/NOR-Flash chip-select Control Register */
typedef struct {
  ...
  t_bitfield extmod:1;        /* extended mode enable bit             */
  t_bitfield asyncwait:1;     /* wait signal during async transfer    */
  t_bitfield reserved:3;
  t_bitfield cburstrw:1;      /* write burst enable bit               */
  t_bitfield reserved_1:12;
} t_fsmc_bcr_reg;

/** \internal SRAM/NOR-Flash chip-select Timing Register */
typedef struct {
  ...
  t_bitfield accmod:2;        /* Access mode                          */
  t_bitfield unused:2;
} t_fsmc_btr_reg;

/** \internal Generic NAND control registers set */
typedef struct{
  /*Type   Name               Description                         Offset      */
  t_fsmc_pcr_reg PCR;         /* PCcard/NAND-Flash Ctrl Reg       0x040       */
  t_fsmc_sr_reg SR;           /* FIFO status and IT registers     0x044       */
  t_fsmc_timing_reg PMEM;     /* Common Memory Space Timing Reg   0x048       */
  t_fsmc_timing_reg PATT;     /* Attribute Memory Space Timing    0x04C       */
  t_fsmc_timing_reg PIO;      /* I/O Space Timing Reg             0x050       */
  t_uint32 ECC[3];            /* ECC result Regs                  0x054-0x5C  */
} t_fsmc_nand_reg;

/** \internal Generic NOR control registers set */
typedef struct{
  /*Type   Name               Description                         Offset      */
...
typedef struct {
  //Type   Name                       /* Description                      Offset      */
  t_fsmc_nor_reg NorReg[3];           /* SRAM/NOR-Flash Registers         0x000       */
  t_uint32 unused_1[(0x40-0x18)>>2];  /* Reserved                         0x018-0x03C */
  t_fsmc_nand_reg NandReg[4];         /* PCcard/NAND-Flash Registers      0x040-0x0bC */
...
typedef union {
  struct {       
    ...
    const t_bitfield unused      :8; // [8:15]
	t_bitfield boot_engi         :1; // [16]
	const t_bitfield unused1     :15; // [17:31]
  } Bit;
  t_uint32  Reg;     
...
typedef union {
  struct {       
    t_bitfield  unused0 :19;         // [0:18]
    t_bitfield  bit19   :1;          // [19]
	t_bitfield  bit20   :1;          // [20]
    t_bitfield  unused1 :11;         // [21:31]
  } Bit;
  t_uint32  Reg;     
}t_prcmu_gpiocr2_reg;
...
typedef struct {
  ...
  t_prcmu_clk_mgt_reg         prcm_svammdspclk_mgt;   // 0x0008
  ...
  t_prcmu_clk_mgt_reg         prcm_spare1clk_mgt;     // 0x0048
  ...
  t_uint32                    unused_8; 				// 0x02AC
  t_uint32                    prcm_ape2_resetn_set;     // 0x02B0
  t_uint32                    prcm_ape2_resetn_clr;     // 0x02B4
  t_uint32                    unused_9[(0x300-0x2B8)>>2]; // 0x02B8-0x2FC
  ...
  t_uint32                    unused_14[(0x500-0x4B8)>>2]; //0x4B8-4FC 
  ...
  t_uint32                    unused_15[(0x574-0x544)>>2];// 0x0544-0x570
  t_prcmu_gpiocr2_reg         prcm_gpiocr2;               // 0x0574
  t_uint32                    unused_16[(0x1000-0x578)>>2];// 0x0578-0xFFC
  t_uint32                    prcm_secnonsewm;           // 0x1000  
  t_uint32                    prcm_esram0_initn;         // 0x1004    
  t_uint32                    unused_17[(0x101C-0x1008)>>2];  // 0x1008-1018
  ...
  t_uint32                    unused_18[(0x10D8-0x1040)>>2];// 0x1040-0x10D4    
...
{       
  ...
  t_uint8 mb[2]; // CPU_MAX_NB+1
  const t_uint8 WasEsram0Off;
  const t_uint8 cmdDdr;
} t_prcmu_fw_mailbox;
...
typedef struct
{
  ...
  const t_bitfield  Reserved0 :4; // [11:8]
  t_bitfield  SensorDbgEn     :1; // 12
  const t_bitfield  Reserved1 :1; // 13
  t_bitfield  PrcmuDebugEn    :1;
  t_bitfield  TOPDebugEn      :1;
  t_bitfield  McSBagEn        :1;
  t_bitfield  APESTRCEn       :1;
  t_bitfield  APESTMEn        :1;
  t_bitfield  Limit0		  :1; // 19
  t_bitfield  Limit1	      :1; // 20
  t_bitfield  Limit2		  :1; // 21
  const t_bitfield Reserved2  :1; // 22
  t_bitfield  FTVLock         :1; // 23
  const t_bitfield  Reserved3 :1; // 24    
  t_bitfield  Limit3		  :1; // 25
  const t_bitfield  Reserved4 :1; // 26
  t_bitfield  SSKeyDis        :1; // 27  
  t_bitfield  SecWDClk        :1;
  t_bitfield  SPRstEn0        :1;
  t_bitfield  SPRstEn1        :1;          
  t_bitfield  CRRSTEn         :1; // 31	
} t_scr_cr_reg;
...
typedef struct
{
  ...
  t_bitfield  SWdTLock    :1;         // Secure watchdog timer control lock
  t_bitfield  SWdTRSTLDis :1;         // Secure watchdog timer reset load disable
  t_bitfield  Reserved    :28;
} t_scr_wcr_reg;
...
typedef union{
  struct{
    t_bitfield Protec:26;
    const t_bitfield unused:6; 
  } Bit;
  t_uint32 Reg;
}  t_scr_protec_reg;

// Sec Test report Register
typedef union{
  struct{
    t_bitfield crc5   :8;
    t_bitfield crc6   :8;
...
typedef union{
  struct{
    t_bitfield	CustOTP2		   : 11; //FVR[42:32]
    t_bitfield	PMB				   : 2;  //FVR[44:43]
    t_bitfield	MemoryRepair	   : 7;  //FVR[51:45]
    t_bitfield	DieValue		   : 3;  //FVR[54:52]
    t_bitfield	EngineeringState   : 1;  //FVR[55]
    t_bitfield	OtpRedundancy	   : 4;  //FVR[59:56]
    t_bitfield	PermRdLock		   : 4;  //FVR[63:60]
  } Bit;
  t_uint32 Reg;
}  t_fvr_high_descr;
...
typedef union{
  struct{
    t_bitfield	SSKey 			: 8; //FVR[7:0]
    t_bitfield	SecInitConfig   : 1; //FVR[8]
    t_bitfield	RomConfig_1L 	: 1; //FVR[9]
    t_bitfield	RomConfig_1H 	: 1; //FVR[910]
    t_bitfield	RomConfig_2 	: 1; //FVR[11]
    t_bitfield	RomConfig_3L 	: 1; //FVR[12]
    t_bitfield	RomConfig_3H 	: 1; //FVR[13]
    t_bitfield	RomConfig_4 	: 1; //FVR[14]
    t_bitfield	CopsConfig  	: 1; //FVR[15]
    t_bitfield	RootKeyHash		: 8; //FVR[23:16]
    t_bitfield	CustPubOTP  	: 1; //FVR[24]
    t_bitfield	CustOTP1		: 7; //FVR[31:25]
  } Bit;
  t_uint32 Reg;
} t_fvr_low_descr;
...
typedef union{
  struct{
    t_bitfield	lock0       : 2; // otp word0 write permanent lock + redundancy
    t_bitfield	lock1       : 2;
    t_bitfield	lock2       : 2;
    t_bitfield	lock3       : 2;
    t_bitfield	lock4       : 2;       
...
typedef union{
  struct{
    ...
    t_bitfield	valid8     : 1; 
    t_bitfield	valid9     : 1; 
    t_bitfield	valid10    : 1; 
    t_bitfield	valid11    : 1; 
    t_bitfield	valid12    : 1; 
    t_bitfield	valid13    : 1; 
    t_bitfield	valid14    : 1; 
    t_bitfield	valid15    : 1; 
    t_bitfield	valid16    : 1; 
    t_bitfield	valid17    : 1; 
    t_bitfield	valid18    : 1; 
    t_bitfield	valid19    : 1; 
    t_bitfield	valid20    : 1; 
    t_bitfield	valid21    : 1; 
    t_bitfield	valid22    : 1; 
    t_bitfield	valid23    : 1; 
    t_bitfield	valid24    : 1; 
    t_bitfield	valid25    : 1; 
    t_bitfield	valid26    : 1; 
    t_bitfield	valid27    : 1; 
    t_bitfield	valid28    : 1; 	
    t_bitfield	valid29    : 1; 
    t_bitfield	valid30    : 1; 
    t_bitfield	valid31    : 1; 
  } Bit;
  t_uint32 Reg;             
} t_scr_valid;        
...
typedef union{
  struct{
    t_bitfield	otp_add        : 8; //0:7
    t_bitfield	unused1        : 4; //8:11
    t_bitfield	otp_write      : 1; //12
    t_bitfield	otp_supadd     : 1; //13
    t_bitfield	otp_eccswitch  : 1; //14    
    t_bitfield	otp_progwidth  : 3; //15:17       
    t_bitfield	otp_disturbed  : 1; //18       
    t_bitfield	otp_errorflag  : 1; //19
    t_bitfield	otp_progfail   : 1; //20
    t_bitfield	otp_busy       : 1; //21
    t_bitfield	otp_forbidden  : 1; //22
    t_bitfield	otp_wordlock   : 1; //23
  	t_bitfield	otp_locked     : 1; //24
    t_bitfield	unused2        : 7; //25:31
  } Bit;
  t_uint32 Reg;             
} t_scr_otp_control_reg;  

typedef struct
{
  t_bitfield  EngiBootReq     :1;  // 0
  t_bitfield  FTVReq          :1;  // 1
  t_bitfield  Spare0          :1;  // 2
  t_bitfield  Spare1          :1;  // 3
  const t_bitfield  Reserved0 :12; // 15:4
  t_bitfield  Spare           :1;  // 16
  t_bitfield  PeriphBoot      :1;  // 17
  t_bitfield  BootRomEn       :1;  // 18
  t_bitfield  Limit0		  :1;  // 19
  t_bitfield  Limit1		  :1;  // 20
  t_bitfield  Limit2		  :1;  // 21
  t_bitfield  JtagEnDis       :1;  // 22
  t_bitfield  FuseFCTReadDis  :1;  // 23
  const t_bitfield  Reserved1 :1;  // 24
  t_bitfield  Limit3          :1;  // 25
  const t_bitfield  Reserved2 :1;  // 26
  t_bitfield  FTVEnable       :1;  // 27
  t_bitfield  SWDGClk         :1;  // 28
  t_bitfield  FTVDis          :1;  // 29 
  t_bitfield  FuseFCTDis      :1;  // 30
  t_bitfield  OpenDevn        :1;  // 31                                                 
} t_scr_sr_reg; 

typedef struct
{
  t_bitfield  SorensonSpark   :1;  // 0
  t_bitfield  VP6             :1;  // 1
  t_bitfield  VC1             :1;  // 2
  t_bitfield  RV              :1;  // 3
  t_bitfield  VP7             :1;  // 4
  t_bitfield  Directx         :1;  // 5
  const t_bitfield  Reserved0 :10; // 15:6
  t_bitfield  eSram0FirewallOn:1;  // 16
  t_bitfield  eSram0DispAllow :1;  // 17
  t_bitfield  eSram1FirewallOn:1;  // 18
  t_bitfield  eSram1DispAllow :1;  // 19
  t_bitfield  eSram2FirewallOn:1;  // 20
  t_bitfield  eSram2DispAllow :1;  // 21
  t_bitfield  eSram3FirewallOn:1;  // 22
  t_bitfield  eSram3DispAllow :1;  // 23
  t_bitfield  eSram4FirewallOn:1;  // 24
  t_bitfield  eSram4DispAllow :1;  // 25
  t_bitfield  eSram5FirewallOn:1;  // 26
  t_bitfield  eSram5DispAllow :1;  // 27
  const t_bitfield  Reserved1 :4;  // 31:28                                              
} t_spare_reg;    
...
{
  // Type             Name                            // Offset
  const t_scr_fvr_reg FuseValue[64];                  // 0x0000...0x00FC
  t_scr_perm_write_lck PermWriteLocks[4];             // 0x0100...0x010C 
  t_fvr_low_descr     StickyRdLockL;                  // 0x0110
  t_fvr_high_descr    StickyRdLockH;                  // 0x0114 
  t_fvr_low_descr     StickyRdLockExtL;               // 0x0118 
  t_fvr_high_descr    StickyRdLockExtH;               // 0x011C 
  t_fvr_low_descr     StickyWrLockL;                  // 0x0120 
  t_fvr_high_descr    StickyWrLockH;                  // 0x0124 
  t_fvr_low_descr     StickyWrLockExtL;               // 0x0128 
  t_fvr_high_descr    StickyWrLockExtH;               // 0x012C 
  t_uint32            StickyLockArea;                 // 0x0130          
  const t_scr_sr_reg  Status;                         // 0x0134
  t_scr_cr_reg        Control;                        // 0x0138
  t_uint32            Reserved0;                      // 0x013C
  t_uint32            OtpData;                        // 0x0140 
  t_uint32            OtpDataRed;                     // 0x0144 
  t_uint32            OtpReadData;                    // 0x0148 
  t_uint32            OtpReadDataRed;                 // 0x014C 
  t_scr_otp_control_reg  OtpControl;                  // 0x0150 
  t_uint32            OtpConfigReg;                   // 0x0154 
  t_uint32            FvrDisturbed[2];                // 0x0158...0x015C 
  t_scr_valid         FvrValid[2];                    // 0x0160...0x0164 
  t_uint32            FvrErrorFlag[2];                // 0x0168...0x016C 
  t_scr_wdr_reg       WatchdogData;                   // 0x0170
  t_scr_wlr_reg       WatchdogLoad;                   // 0x0174
  t_scr_wcr_reg       WatchdogControl;                // 0x0178
  t_uint32            Reserved1;                      // 0x017C
  t_scr_ramp_reg      ESRam0Protection;               // 0x0180
  t_scr_spr_reg       ScratchPad[2];                  // 0x0184...0x0188
  t_scr_sec_region_size_reg SecRegionSize;            // 0x018C
  t_scr_protec_reg    DecProtecReg;                   // 0x0190
  t_uint32            Reserved2;                      // 0x0194  
  t_spare_reg         SpareReg;                       // 0x0198  
  t_uint32            DDRModemAddrCheck;              // 0x019C
  t_scr_ramp_reg      ESRam1Protection;               // 0x01A0 
  t_uint32            Intlv;                          // 0x01A4     
  t_uint32            DDRSecOnlyAddrCheck;            // 0x01A8
  t_uint32            C2CAddrOffset;                  // 0x01AC  
  t_uint32            DDRA9OnlyAddrCheck;             // 0x01B0   
  t_uint32            DDRShareHighMaxSpaceAddrCheck;  // 0x01B4 
  t_scr_crc_fuse_reg  CRCFuseResult;                  // 0x01B8
  t_scr_report_reg    SecrTestReport;                 // 0x01BC 
  t_scr_scrc_reg      ScramblerControl;               // 0x01C0
  t_uint32            ScramblerKeyLow;                // 0x01C4
  t_uint32            ScramblerKeyHigh;               // 0x01C8
  t_uint32            Reserved4;                      // 0x01CC
  t_uint32            C2CSecAttrEn;                   // 0x01D0 
  t_uint32            C2CSecAttrFixed;                // 0x01D4 
  t_uint32            GpCtrl[4];                      // 0x01D8...0x01E4 
} t_secure_registers;
...
typedef struct
{
  ...
  t_bitfield ENS:1;        // bit 20
  t_bitfield unused_2:3;  
  t_bitfield LoadSskey:1;  // bit 24
  t_bitfield unused_3:6;   
  t_bitfield KeyLock:1;    // bit 31	
} t_cryp_control_reg;
...
//  Type                    Name               Offset Description
    ...
    t_uint32                TestControl;    // 0x01C: Integration Test Control register   
    t_uint32                TestInput;      // 0x020: Integration Test Input register
    t_uint32                TestOutput;     // 0x024: Integration Test Output register    
    const t_uint32          reserved_1[(0x10F8-0x028)>>2];   
} t_pka_registers;
...
//  Type                Name                                   Offset           Description
    ...
    t_uint32            reserved_0;                         // 0x004:           Reserved
    t_hash_start_reg    Start;                              // 0x008:           Computation start register
    t_uint32            Digest[8];                          // 0x00C...0x028:   Data output register
    const t_uint32      reserved_1[(0x40-0x2C)>>2];         // 0x02C...0x040:   Reserved
    t_uint32            DataIn;                             // 0x040:           Input data
    const t_uint32      reserved_2[(0x80-0x44)>>2];         // 0x04C...0x080:   Reserved
    t_uint32            TestControl;                        // 0x080:           Integration Test Control register
    t_uint32            TestInput;                          // 0x084:           Integration Test Input register
    t_uint32            TestOutput;                         // 0x088:           Integration Test Output register
    const t_uint32      reserved_3[(0xF8-0x8C)>>2];         // 0x08C...0x0F4:   Reserved
    t_uint32            ContextSwapReg[54];                 // 0x0F8...0x1CC:   Context Swap reg Xsters
    const t_uint32      reserved_4[(0xFE0-0x1D0)>>2];       // 0x1A0...0xFDC:   Reserved
    const t_uint32      PeriphID[4];                        // 0xFE0...0xFEC:   Peripheral id registers
...
typedef union {
  struct {                     
    ...
    t_bitfield ClkDiv:10;
    t_bitfield Div2:1;
    t_bitfield Reserved1:4;
  } Bit;
  t_uint32 Reg;
}t_mmc_clk_reg;
...
typedef struct {
  ...
  t_uint32 TRSCA;              /* TRSCA timer Reg      0xC4 */
  t_uint32 BURSTSIZE;          /* DMA BURST SIZE Reg   0xC8 */
  t_uint32 CLKDEL;             /* DELAY Reg            0xCC */
  t_uint32 TUNING_RISING_EDGE_VALUE;             /* TUNING RISING EDGE Reg    0xD0 */
  t_uint32 TUNING_FALLING_EDGE_VALUE;            /* TUNING FALLING EDGE Reg   0xD4 */
  t_uint32 reserved4[(0xFE0-0xD8)>>2]; 
...
// L2CC prefetch control
typedef struct {                    
  t_bitfield Offset:5;
  t_bitfield unused:16;
  t_bitfield NotSameID:1;
  t_bitfield unused1:1;
  t_bitfield IncrLinefill:1;
  t_bitfield PrefetchDropEn:1;            
  t_bitfield unused2:3;
  t_bitfield DataPrefetchEn:1;
  t_bitfield InstructionPrefetchEn:1;
  t_bitfield DoubleLinefillEn:1;
  t_bitfield unused3:1;                      
} t_l2cc_prefetch_cont_reg;

// L2CC power control
typedef struct {                    
  t_bitfield StandbyModeEn:1;
  t_bitfield DynClkGatingEn:1;
  t_bitfield unused:30;                      
} t_l2cc_power_cont_reg;
...
typedef struct {
  ...
  const t_uint32                  reserved_14[(0xF60-0xF44)>>2];
  t_l2cc_prefetch_cont_reg        PrefetchControl;            // 0xF60    Prefetch control
  const t_uint32                  reserved_15[(0xF80-0xF64)>>2];
  t_l2cc_power_cont_reg           PowerControl;               // 0xF80    Power control
  const t_uint32                  reserved_16[(0x1000-0xF84)>>2];
} t_l2cc_registers;
...
typedef struct
{
	const t_bitfield reserved:31;
	t_bitfield ddr_hold:1;
} t_dmc_ctl_73_reg;
...
typedef struct
{
  ...
  t_uint32                    Ctl_63;             // 0xFC    
	t_uint32                    Ctl_64;             // 0x100
	t_uint32                    Ctl_65;             // 0x104
	t_uint32                    Ctl_66;             // 0x108
	t_uint32                    Ctl_67;             // 0x10C
	t_uint32                    Ctl_68;             // 0x110
	t_uint32                    Ctl_69;             // 0x114
	t_uint32                    Ctl_70;             // 0x118
	t_uint32                    Ctl_71;             // 0x11C
	t_uint32                    Ctl_72;             // 0x120
	t_dmc_ctl_73_reg            Ctl_73;             // 0x124
} t_dmc_registers;
...
typedef struct
{
  ...
  t_uint32                    CrUsb;              // 0x2C
  t_uint32                    CrReg6;             // 0x30
  t_uint32                    CrSecCryp;          // 0x34
  t_uint32                    CrNSecCryp;         // 0x38
  t_uint32                    Reserved_3[0x1000-0x3C];
} t_cr_registers;
