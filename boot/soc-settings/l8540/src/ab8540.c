...
static u8 regulator_config(struct ab8540_data *reg_config)
{
  u8 abx500_value = 0;
  u8 ret = 0;
...
u8 AB8540_init_fct(u8 *ab8540_settings)
{
  struct ab8540_data *reg_data = (struct ab8540_data *)ab8540_settings;
  u8 ret = 0;
