 ...
 *  for ST-Ericsson.
 *
 * Update to fit ST-Ericsson's soc-settings' needs and coding style.
 */
	...
	volatile datum_t *address)
{
	...
	logdebug("memtest_databus() start. address=%x", address);
	...
	logdebug("memtest_databus() success.");
	return 0;
}
	...
	unsigned long nbytes)
{
	...
	logdebug("memtest_addressbus() start. address=%x nbytes=%x",
		address, nbytes);
	...
	logdebug("memtest_addressbus() success.");
	return NULL;
}
