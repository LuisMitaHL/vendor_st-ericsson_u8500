 ...
 *
 * Author: Markus Helgesson <markus.helgesson at stericsson.com>
 *  for ST-Ericsson.
 */

{
	.id_regs_and_mask = {
		...
		0x06,   0xff,   /* CS0 BC-1 : Manufacturer ID */
		0x06,   0xff,   /* CS1 BC-1 : Manufacturer ID */
