...

{
	.id_regs_and_mask = {
		...
		0xff,   0xff,   /* CS0 BC-1 : Manufacturer ID */
		0xff,   0xff,   /* CS1 BC-1 : Manufacturer ID */
		...
		0x14,   0xff,   /* CS0 BC-4 : I/O width + Density + Type */
		0x14,   0xff,   /* CS1 BC-4 : I/O width + Density + Type */
	...
	.settings = {
		...
		0x01900048, /* DENALI_CTL_83 zqcs change for ES */
		...
		0x00000fa0, /* DENALI_CTL_94 tinit5 =15us */
		0x00010100, /* DENALI_CTL_95 */
		0x01000001, /* DENALI_CTL_96 */
		0x0a020201, /* DENALI_CTL_97 */
		0x0009090a, /* DENALI_CTL_98 */
		0x0fff0000, /* DENALI_CTL_99 */
		0x00000fff, /* DENALI_CTL_100 */
		0x03021000, /* DENALI_CTL_101 */
		...
		0x00024012, /* DENALI_CTL_115 zqcs change for ES */
		0x00048024, /* DENALI_CTL_116 */
		0x00090048, /* DENALI_CTL_117 zqcs change for ES */
