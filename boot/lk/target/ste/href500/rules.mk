...
WITH_TINY_ENV := 1
KEYS_USE_UIB_KEYPAD := 1
USB_USE_MENTOR := 1
ifeq ($(ENABLE_FEATURE_BUILD_HBTS),true)
BOOTLOADER_START_MODEM := 0
else
BOOTLOADER_START_MODEM := 1
endif
ENABLE_FASTBOOT := 1
CONFIG_VIDEO_LOGO := 1
CONFIG_SYS_DISPLAY_DSI := 0
CONFIG_SYS_DISPLAY_DPI := 0
CONFIG_BOOTTIME := 1
ENABLE_ARB := 1
...
DEFINES += \
	...
	KEYS_USE_UIB_KEYPAD=$(KEYS_USE_UIB_KEYPAD) \
	USB_USE_MENTOR=$(USB_USE_MENTOR) \
	BOOTLOADER_START_MODEM=$(BOOTLOADER_START_MODEM) \
	ENABLE_FASTBOOT=$(ENABLE_FASTBOOT) \
	CONFIG_VIDEO_LOGO=$(CONFIG_VIDEO_LOGO) \
	CONFIG_SYS_DISPLAY_DSI=$(CONFIG_SYS_DISPLAY_DSI) \
	CONFIG_SYS_DISPLAY_DPI=$(CONFIG_SYS_DISPLAY_DPI) \
