...
*
*      Filename:    mpa_config.h
*
*      Created:     1/18/12 by Ekdahl Patrik
*
...
*
*      Description: Configuration file. Please adjust to your environment.
*
\*****************************************************************************/
...
/* comment out the line below if your system does not support "unsigned long long" */
//#define MPA_SUPPORT_DWORD_T

/* define if you want to use ARM assembler code for certain cruicial functions */
#define     USE_ARM_ASM


/* Include functionality for converting to and from strings; mpa_SetString and mpa_GetString */
