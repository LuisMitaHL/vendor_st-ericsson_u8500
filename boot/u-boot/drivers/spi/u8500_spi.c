...
#ifdef U8500_SSP0_BASE
#define SSP_0_BASE	U8500_SSP0_BASE
#endif

#ifdef U8500_SSP1_BASE
#define SSP_1_BASE	U8500_SSP1_BASE
#endif
...
#ifdef SSP_0_BASE
	case 4:
		base_addr = (u8 *) SSP_0_BASE;
		break;
#endif
#ifdef SSP_1_BASE
	case 5:
		base_addr = (u8 *) SSP_1_BASE;
		break;
#endif
	default:
...
int spi_claim_bus(struct spi_slave *slave)
{
	...
	case 3:
		...
		break;
#endif
#if defined(SSP_0_BASE) && defined(CONFIG_U8500)
	case 4:
		u8500_clock_enable(3, 1, 1);
		break;
#endif
#if defined(SSP_1_BASE) && defined(CONFIG_U8500)
	case 5:
		u8500_clock_enable(3, 2, 2);
		break;
#endif
	default:
