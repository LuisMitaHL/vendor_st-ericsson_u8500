...
T=1/fs;
checkdisto=0;
totalDelay = delay_34_37 + delay_4x;
...
fprintf(fid,'const YMEM Float out12_44[%d] = {\n',NRES);
for k = 1:NRES-1
     fprintf(fid,'\tFORMAT_FLOAT(%.15f,MAXVAL),  \t\t// %d\n',res1(k),k-1);
end
k = NRES;
