...
MMshort spl_pow2(MMshort z);

// X: 8.16
// result: 1.23 
void spl_pow10(MMshort X, MMshort *exp, MMshort *mant)
{
	MMshort z;
...
// result: Q21
Word24 spl_pow10_coef(Word24 Input)
{
	Word24 Base;
	Word24 tmp;
	int i;
	...
	tmp = waddsat(waddsat(Base, 2097152), wmsl(tmp, 1)); // Q21, 2097152=2^21
