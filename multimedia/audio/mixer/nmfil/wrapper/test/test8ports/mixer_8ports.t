...
my @NbChannel = (1);
my @InputName = ("casta_8m.pcm", "BassISO_8m.pcm", "frer07_1_8m.pcm", "gspi35_1_8m.pcm", "harp40_1_8m.pcm", "spff51_1_8m.pcm", "spfg53_1_8m.pcm", "spmf52_1_8m.pcm");
my $NbInputToMix = (8);
...
if ($compilation == 0){
     ...
     foreach my $NBCHAN (@NbChannel) {
         ...
         my $OutputLocalName = "mix8ports.outnmf";
         my $OutputRefLocalName = "mix8ports_mono_ref";
...
sub run_test
{
    ...
    mmtest::system("mmdspsim -c cmd > mixer_8ports_test.log",0, "simulation :configuration $blockSize $nbChan");
