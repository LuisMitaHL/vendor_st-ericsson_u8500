...
my @NbChannel = (1);
my @InputName = ("casta_8m.pcm", "BassISO_8m.pcm", "frer07_1_8m.pcm", "gspi35_1_8m.pcm");
my $NbInputToMix = (4);
...
if ($compilation == 0){
     ...
     foreach my $NBCHAN (@NbChannel) {
         ...
         my $OutputLocalName = "mix4ports.outnmf";
         my $OutputRefLocalName = "mix4ports_mono_ref";
...
sub run_test
{
    ...
    print CMDFILE "set args $blockSize $nbChan $nbInputToMix $nbSampleToMix ../../../../../streams/mixer/streams/$inputfilename1 ../../../../../streams/mixer/streams/$inputfilename2 ../../../../../streams/mixer/streams/$inputfilename3 ../../../../../streams/mixer/streams/$inputfilename4 $outputFileName\n";
    print CMDFILE "run\n";

    close (CMDFILE);
    my $suffix = MMVariables::getMMDSPPROCESSOR($ENV{"PLATFORM"});
    mmtest::system("mmdspsim -c cmd > mixer_4ports_test.log",0, "simulation :configuration $blockSize $nbChan");
