...
my @NbChannel = (1);
my @InputName = ("casta_8m.pcm", "BassISO_8m.pcm", "frer07_1_8m.pcm", "gspi35_1_8m.pcm", "harp40_1_8m.pcm", "spff51_1_8m.pcm", "spfg53_1_8m.pcm");
my $NbInputToMix = (7);
...
if ($compilation == 0){
     ...
     foreach my $NBCHAN (@NbChannel) {
         ...
         my $OutputLocalName = "mix7ports.outnmf";
         my $OutputRefLocalName = "mix7ports_mono_ref";
...
sub run_test
{
    ...
    mmtest::system("mmdspsim -c cmd > mixer_7ports_test.log",0, "simulation :configuration $blockSize $nbChan");
