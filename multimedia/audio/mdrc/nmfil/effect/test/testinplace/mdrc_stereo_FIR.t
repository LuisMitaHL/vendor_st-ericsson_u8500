...
my $outputFileName   = "output_FIR_stereo_48k.pcm.out";
my $referenceName   = "../../../../../streams/mdrc/streams/ref_op_FIR_stereo_48k_nmf.pcm";
my $config           = 0;
my $freq_in          = 48000;
my $nChannels        = 2;
my $paramFile        = "../../../../../streams/mdrc/streams/params_FIR_stereo_48k";
