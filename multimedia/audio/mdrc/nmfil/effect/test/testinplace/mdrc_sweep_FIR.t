...
my $blockSizeIn      = 480;
my $blockSizeOut     = 480;
my $inputFileName    = "../../../../../streams/mdrc/streams/freq_sweep_48k.pcm";
my $outputFileName   = "output_FIR_sweep_48k.pcm.out";
my $referenceName    = "../../../../../streams/mdrc/streams/ref_op_FIR_freq_sweep_48k_nmf.pcm";
my $config           = 0;
my $freq_in          = 48000;
my $nChannels        = 2;
my $paramFile        = "../../../../../streams/mdrc/streams/params_FIR_freq_sweep_48k";
