...
AMRDec_PcmPort::AMRDec_PcmPort(OMX_U32         nIndex,
               OMX_DIRTYPE     eDir,
               OMX_U32         nChannels,
               OMX_U32         nSampleRate,
...
OMX_ERRORTYPE   AMRDec_PcmPort::checkPcmSettings(const OMX_AUDIO_PARAM_PCMMODETYPE &pcmSettings) const 
{
...
void AMRDec_PcmPort::setProperties(bool isHost) {
