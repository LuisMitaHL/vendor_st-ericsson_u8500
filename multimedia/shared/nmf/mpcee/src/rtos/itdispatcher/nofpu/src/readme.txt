...
void itDispatcher(void)
{
    ...
    // set new this
    *(void**)0x1 = *(void**)&rtos_itdispatcher_nofpu_it[irqNb * 2];
    // set pointer function handler 
    pMyItHandler = *(void**)&rtos_itdispatcher_nofpu_it[irqNb * 2 + 1];
    // call it
    (*pMyItHandler)();
    // restore old pointer 
