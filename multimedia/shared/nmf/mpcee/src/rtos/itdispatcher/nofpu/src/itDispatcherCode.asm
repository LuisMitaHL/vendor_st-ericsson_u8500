...
;   Initialized to zero = true
    ...
    .extern _rtos_itdispatcher_nofpu_it
...
;      Symbol '_itDispatcher_savedreg_size' = 33
;      Symbol '_itDispatcher_spill_size' = 0
;      No Segment defined
.equ _itDispatcher_local_size , 1
.equ _itDispatcher_savedreg_size , 33
...
.begin_bundle
    ...
    xmvi    _rtos_itdispatcher_nofpu_it,ax2
.end_bundle
.begin_bundle
    xmv sp0,ax1
.end_bundle
