...
#else /* def __STN_8820 or __STN_8500 or __STN_9540 */
...
#endif /* __STN_8820 or __STN_8500 or __STN_9540 */
...
typedef volatile struct {
    ...
    t_uint16 cptr3h;
    t_uint16 cptrsel;
    t_uint16 flush_base_lsb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint16 flush_base_msb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint16 flush_top_lsb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint16 flush_top_msb; /* only on STn8820 and STn8500 and STn9540 */
...
typedef volatile struct {
    ...
    t_uint32 cptr3h;
    t_uint32 cptrsel;
    t_uint32 flush_base_lsb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint32 flush_base_msb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint32 flush_top_lsb; /* only on STn8820 and STn8500 and STn9540 */
    t_uint32 flush_top_msb; /* only on STn8820 and STn8500 and STn9540 */
...
/* Only for STn8820 and STn8500 and STn9540 */
...
typedef volatile struct {
    ...
    t_uint16    pwr;                 /*0x...6001c*/ /* only on STn8820 and STn8500 and STn9540 */
...
typedef volatile struct {
    ...
    t_uint32    pwr;                 /*0x...60038*/ /* only on STn8820 and STn8500 and STn9540 */
...
/* MMIO blocks */
#if defined(__STN_8820) || defined(__STN_8500) || defined(__STN_9540)
typedef volatile struct {
