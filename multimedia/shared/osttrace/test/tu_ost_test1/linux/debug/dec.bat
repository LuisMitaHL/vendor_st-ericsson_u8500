...
%PERLEXEC% -S ../../../../../osttools/ostdec/ostdec.pl --input=dico=../../../../../launcher/ostdico_list.txt --defines=rmdisplay=pp_ts --input=file=ost_trace.bin --input=type=combiprobe --output=ost_trace.txt
@IF NOT "%ERRORLEVEL%" == "0" (
