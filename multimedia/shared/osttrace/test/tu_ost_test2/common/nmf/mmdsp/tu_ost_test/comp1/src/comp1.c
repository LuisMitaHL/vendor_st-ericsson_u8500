...
#include <tu_ost_test/comp1.nmf>
#include <inc/type.h>
#include "traceinit.idt"

// Must be included before OpenSystemTrace_ste.h
#define MY_OSTTRACE_LOG_TAG "TU_OST_TEST_COMP1"
...
#include "osttrace_test_tu_ost_test2_common_nmf_mmdsp_tu_ost_test_comp1_src_comp1Traces.h"
#endif
...
t_uint16 big_arr_int16[MY_BIG_SIZE];
...
void METH(gentrace)(void)
{
  ...
  unsigned long wait_loop = 100000ul;
  ...
  OstTraceFiltStaticData( TRACE_DEBUG,  "Test OstTraceFiltStaticData 8-bit integers with size 211: %{hex8[]}", this, (unsigned char*)&big_arr_int8[0], 211);
  OstTraceArray( TRACE_DEBUG,  "Test OstTraceArray 16-bit integers with size 211: %{hex32[]}", (unsigned int*)&big_arr_int16[0], 211); 
  OstTraceFiltStaticData( TRACE_DEBUG,  "Test OstTraceFiltStaticData 16-bit integers with size 211: %{hex32[]}", this, (unsigned int*)&big_arr_int16[0], 211);
