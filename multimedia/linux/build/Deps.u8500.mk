...
audio/aacenc-deps := audio/afm audio/audiolibs audio/makefiles
...
audio/speech_proc_vcs-deps := audio/afm audio/speech_enhancement audio/tty audio/drc audio/comfortnoise audio/spl
...
audio/alsactrl-deps := audio/audio_chipset_apis
...
audio/audiocodec-deps := audio/makefiles audio/volctrl audio/afm audio/audio_chipset_apis linux/bellagio_ste_omxloader audio/alsactrl
audio/alsasink-deps := audio/makefiles audio/audiolibs audio/afm audio/alsactrl
audio/wmapro_v10-deps := audio/afm audio/audiolibs audio/makefiles
audio/alsasource-deps := audio/makefiles audio/audiolibs audio/afm audio/alsactrl
...
audio/ate_ext-deps := shared/mmte_api shared/cli shared/ste_shai shared/omxil shared/nmf/linux audio/afm audio/alsactrl
...
video/components/val_source_sink-deps := video/vfm shared/mmhwbuffer_api shared/mmhwbuffer_osi shared/omxilosalservices_api
...
imaging/sw3A-deps := shared/host_trace imaging/tuning imaging/tuningdatabase shared/mmhwbuffer_api imaging/mmio_api shared/omxil shared/nmf/linux imaging/ifm $(IMAGING_ISP_FIRMWARES) imaging/lightsensor_api imaging/ste3a imaging/flash_api
