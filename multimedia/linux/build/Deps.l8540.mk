...
linux/ste_omxloader_components-deps := linux/bellagio_ste_omxloader video/vfm video/components/exif_mixer video/components/jpegenc video/components/rotateresize video/components/val_source_sink
...
video/video_valid_multicomp-deps := video/video_valid_jpegenc video/video_valid_exifmixer
...
imaging/sw3A-deps := shared/host_trace imaging/tuning imaging/tuningdatabase shared/mmhwbuffer_api imaging/mmio_api shared/omxil shared/nmf/linux imaging/ifm $(IMAGING_ISP_FIRMWARES) imaging/lightsensor_api imaging/ste3a imaging/damper
...
define imaging_firmwares
   $(1)-deps := imaging/sia_hw_components_8500 imaging/ifm linux/bellagio_ste_omxloader
endef
...
define imaging_tunings
   $(1)-deps := imaging/ifm linux/bellagio_ste_omxloader
endef
