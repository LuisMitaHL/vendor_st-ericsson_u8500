...
#ifndef _SCF_API_H_
#define _SCF_API_H_
#include "ext_qevent.h" // rename_me as scf_events.h
#define PR_IMP // to be removed one day as there should not be any #ifndef PR_IMP anywhere in the code.

/* this file is not meant to go in 10.40 symbian delivery, the following check can be removed when merging this component back to
the trunk for next iteration*/
#ifdef __SYMBIAN32__
#error "this version 10.40.1 is not to be used in symbian W40, if a symbian fix is needed on this branch based on 10.40.0 please contact jmv/mag"
#endif
...
#else
#define SCF_MSG0(level,arg0)				(if(DEBUG_SCF>level) {DBGT_PTRACE(arg1);})
#define SCF_MSG1(level,arg0,arg1)			(if(DEBUG_SCF>level) {DBGT_PTRACE(arg1,arg2);})
#define SCF_MSG2(level,arg0,arg1,arg2)		(if(DEBUG_SCF>level) {DBGT_PTRACE(arg1,arg2,arg3);})
#define SCF_MSG3(level,arg0,arg1,arg2,arg3) (if(DEBUG_SCF>level) {DBGT_PTRACE(arg1,arg2,arg3,arg4);})
#define SCF_MSG4(level,arg0,arg1,arg2,arg3,arg4) (if(DEBUG_SCF>level) {DBGT_PTRACE(arg1,arg2,arg3,arg4);})
#define SCF_MSG5(level,arg0,arg1,arg2,arg3,arg4,arg5) (if(DEBUG_SCF>level) {DBGT_PTRACE(arg1,arg2,arg3,arg4);})
#endif
...
{	
	ScfOneState( ScfStatePtr ptr_of_func, ScfAllState *pS, char const *s, CScfStateMachine *b ) : Level(0),first_time(1),ptr( ptr_of_func ),base(b),cpStates(pS),prevT(0),nextT(0),prevB(0),nextB(0),
		pOSFather(0),pOSChildren(0),pOSNextChild(0) {
			if(ptr!=0) {SCF_MSG1(3,"NEW STATE CREATED %s\n",s);
#ifdef SCF_STRING
			DBC_ASSERT(strlen(s)<255);strcpy(StateName,s);
#endif
			LinkHierarchy();
			}
	};
...
public:
	...
	void ScfCallTopInit() {DBC_ASSERT(ScfTopInit!=0);
