...
#ifndef  __ITE_NMF_Duster_H__
#define  __ITE_NMF_Duster_H__
...
CMD_COMPLETION C_ite_dbg_ConfigureDuster_cmd( int     a_nb_args, char    **ap_args);
CMD_COMPLETION C_ite_dbg_VerityDuster_cmd( int     a_nb_args, char    **ap_args);
#endif        // __ITE_NMF_Duster_H__
