 ...
 **/
/****************************************************************************/
CSensorSecondary::CSensorSecondary(): CSensor(eSecondaryCamera)
{
   t_uint32 i = 0;
   t_uint32 nb_element = iSensorPreBootNbElement;

   MSG0("Sensor IMX072 as Sensor1 constructor called\n");
   ...
   iSensorPreBootPEs[nb_element].pe_addr   =  SystemSetup_e_InputImageSource_Byte0;
	iSensorPreBootPEs[nb_element++].pe_data =  InputImageSource_e_Sensor1;

   iSensorPreBootPEs[nb_element].pe_addr   =  SystemSetup_e_InputImageInterface_Byte0;
	iSensorPreBootPEs[nb_element++].pe_data =  InputImageInterface_CSI2_1;

   iSensorPreBootPEs[nb_element].pe_addr =    SystemSetup_u8_NumberOfCSI2DataLines_Byte0;
	iSensorPreBootPEs[nb_element++].pe_data  =  0x1; // 1 data lane
...
t_sint32 CSensorSecondary::GetSensorId(void)
{
	return LOW_LEVEL_API_SENSOR;
}

const char* CSensorSecondary::GetPeName(const t_uint32 aAddr)
{
    return secondary_KPeNamesList[aAddr];
}
 ...
 **/
/****************************************************************************/
CSensorSecondary::~CSensorSecondary()
{
    MSG0("Secondary sensor : Sensor IMX072 on CSI destructor called\n");
}
