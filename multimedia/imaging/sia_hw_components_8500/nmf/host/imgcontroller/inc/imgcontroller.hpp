 ...
 */
/*
* \brief   imgcontroller ARM-NMF component class header
*/
#ifndef __imgcontrollerhpp
#define __imgcontrollerhpp
...
#ifdef __SYMBIAN32__
NONSHARABLE_CLASS(imgcontroller);
#endif
class imgcontroller : public Controller, public imgcontrollerTemplate
{
public:
