...
*/
/*****************************************************************************/
#ifndef _IMG_ENS_BUFFER_REQ_H_
#define _IMG_ENS_BUFFER_REQ_H_
...
namespace ImgEns
{
	...
	buffer requirement */
	void updateBufferReq(OMX_PARAM_PORTDEFINITIONTYPE& portDef, const BufferReq& req);
	...
	*/
	...
	inline OMX_U32
		BufferReq::bufferCountMin() const { return m_nBufferCountMin; }

	inline OMX_U32
		BufferReq::bufferSizeMin() const { return m_nBufferSizeMin; }

	inline OMX_BOOL
		BufferReq::isBuffersContiguous() const { return m_bBuffersContiguous; }

	inline OMX_U32
		BufferReq::bufferAlignment() const  { return m_nBufferAlignment; }

#endif // _IMG_ENS_BUFFER_REQ_H_
