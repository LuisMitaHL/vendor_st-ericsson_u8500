...
#ifndef __INCLUDE_ALGO_EXPOSURE_PRESET_ROUTINES_H__
#define __INCLUDE_ALGO_EXPOSURE_PRESET_ROUTINES_H__
...
/**
 * Validation Metric for the ExposurePreset Effect.
 *
...
#endif	//__INCLUDE_ALGO_EXPOSURE_PRESET_ROUTINES_H__
