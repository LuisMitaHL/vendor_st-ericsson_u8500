...
#ifndef __INCLUDE_ALGO_SPATIALSIMILAR_EFFECTS_ROUTINES_H__
#define __INCLUDE_ALGO_SPATIALSIMILAR_EFFECTS_ROUTINES_H__

#define SPATIAL_SIMILAR_THRESHOLD    2.5
...
#endif	//__INCLUDE_ALGO_SPATIALSIMILAR_EFFECTS_ROUTINES_H__
