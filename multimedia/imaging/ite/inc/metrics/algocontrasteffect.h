...
#ifndef __INCLUDE_ALGO_CONTRAST_EFFECTS_ROUTINES_H__
#define __INCLUDE_ALGO_CONTRAST_EFFECTS_ROUTINES_H__

#define CONTRAST_THRESHOLD    4
...
#endif	//__INCLUDE_ALGO_CONTRAST_EFFECTS_ROUTINES_H__
