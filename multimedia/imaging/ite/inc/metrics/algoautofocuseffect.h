...
#ifndef __INCLUDE_ALGO_AUTOFOCUS_EFFECTS_ROUTINES_H__
#define __INCLUDE_ALGO_AUTOFOCUS_EFFECTS_ROUTINES_H__

#define AUTO_FOCUS_THRESHOLD    1.04
...
#endif	//__INCLUDE_ALGO_AUTOFOCUS_EFFECTS_ROUTINES_H__
