...
#ifndef __INCLUDE_ALGO_BRIGHTNESS_EFFECTS_ROUTINES_H__
#define __INCLUDE_ALGO_BRIGHTNESS_EFFECTS_ROUTINES_H__
...
#endif	//__INCLUDE_ALGO_BRIGHTNESS_EFFECTS_ROUTINES_H__
