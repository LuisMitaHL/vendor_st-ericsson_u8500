...
typedef struct sIext_grab_api_alert {
  void* THIS;
  t_cm_error (*info)(void* THIS, enum e_grabInfo info_id, t_uint16 buffer_id, t_uint32 timestamp);
...
typedef struct {
  void* THIS;
  void (*info)(void* THIS, enum e_grabInfo info_id, t_uint16 buffer_id, t_uint32 timestamp);
