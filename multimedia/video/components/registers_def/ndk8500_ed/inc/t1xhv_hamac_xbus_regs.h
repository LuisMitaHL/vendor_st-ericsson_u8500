...
/*
 ...
 date : Mon Aug 04 15:03:48 MEST 2008
*/
...
/*  01.10.2007 : 5.6.4 release */
/*  08.10.2007 : 5.6.5 release */
/*  23.10.2007 : JPA add moredata in BDU */
/*  29.10.2007 : MS add CUTB0 BPU registers */
/*  26.11.2007 : 5.6.6 release */
/*  28.11.2007 : 5.6.7 release restaore FW contrainte on H264 register mapping */
/*  29.11.2007 : 5.6.8 release integrate good BPU non regressed / 8820cutA */
/*  06.12.2007 : JPA addition of 1 error bit in JPG_GET_STATUS for RST marker */
/*  10.12.2007 : JPA GetTcoef and RevGetTcoef commands use now Start/GetStatus scheme */
/*  29.11.2007 : 5.6.9 release integrate good BDU, VLV, BPU,CUP */
/*  13.12.2007 : 5.7.0 align cup base on 1024 address */
/*  10.12.2007 : Registers for VBF unit for overlap smoothing function added and corrections */
/*  18.01.2008 : 5.7.5 BPU register integration */
/*  04.01.2008 : 5.7.6  */
/*  05.01.2008 : 5.7.7 Beta CUP integration */
/*  06.01.2008 : JPA addition of BDU_SCS_ANY command in replacment of BDU_SCS */
/*  07.03.2008 : AB 5.8.3 */
/*  13.03.2008 : EB PXP reset values updated */
/*  27.03.2008 : JPA addition of VC1 header, remove of MPEG4 MV */
/*  07.04.2008 : JPA addition of H264 UEG MVD and residual commands - merge with SVA_HW_5.8.4 */
/*  11.04.2008 : JCC 6.0.0 release CMOS 45 */
/*  06.05.2008 : JPA correction of BDU_VC1_HDR_TABLES register bitwidth to 6 */
/*  30.05.2008 : JPA correction of BDU_VC1_HDR_GET_STATUS register bitwidth to 12 */
/* ---------------------------------------------------------------------------- */
/* -------------------------------------------------------------------- */
...
#define CUP_BASE             0xD400U
#define VLC_BASE             0xD800U
#define BPU_BASE             0xDA00U
#define CABAC_BASE           0xDC00U
/*  CUP Context base-addresses - to be used to build context sub_address */
#define CUP_CTX_A            0x0100U
#define CUP_CTX_X            0x0180U
#define CUP_CTX_D            0x0200U
#define CUP_CTX_B            0x0280U
#define CUP_CTX_C            0x0300U
#define CUP_CTX_E            0x0380U
...
#define MECC_FIFO_BIAS_FACTOR 0x0017U
#define MECC_FIFO_PMPX       0x0018U
#define MECC_FIFO_PMPY       0x0019U
...
#define DMA_CDR_CMD          0x0034U
#define DMA_CDR_CBP_L        0x0035U
#define DMA_CDR_CBP_H        0x0036U
#define DMA_BDU_CBP_L        0x0037U
#define DMA_BDU_CBP_H        0x0038U
...
#define DMA_MAX_OPC_SZ7A     0x00A7U
#define DMA_MAX_OPC_SZ8      0x00A8U
#define DMA_MAX_OPC_SZ9      0x00A9U
#define DMA_MAX_OPC_SZ10     0x00AAU
#define DMA_MAX_OPC_SZ11     0x00ABU
#define DMA_MAX_OPC_SZ12     0x00ACU
#define DMA_MAX_OPC_SZ13     0x00ADU
#define DMA_MAX_OPC_SZ14     0x00AEU
#define DMA_MAX_OPC_SZ15     0x00AFU
...
#define DMA_PRIO_7A          0x00B7U
#define DMA_PRIO_8           0x00B8U
#define DMA_PRIO_9           0x00B9U
#define DMA_PRIO_10          0x00BAU
#define DMA_PRIO_11          0x00BBU
#define DMA_PRIO_12          0x00BCU
#define DMA_PRIO_13          0x00BDU
#define DMA_PRIO_14          0x00BEU
#define DMA_PRIO_15          0x00BFU
...
#define DMA_MAX_MSSG_SZ7A    0x00C7U
#define DMA_MAX_MSSG_SZ8     0x00C8U
#define DMA_MAX_MSSG_SZ9     0x00C9U
#define DMA_MAX_MSSG_SZ10    0x00CAU
#define DMA_MAX_MSSG_SZ11    0x00CBU
#define DMA_MAX_MSSG_SZ12    0x00CCU
#define DMA_MAX_MSSG_SZ13    0x00CDU
#define DMA_MAX_MSSG_SZ14    0x00CEU
#define DMA_MAX_MSSG_SZ15    0x00CFU
...
#define DMA_MAX_CHCK_SZ7A    0x00D7U
#define DMA_MAX_CHCK_SZ8     0x00D8U
#define DMA_MAX_CHCK_SZ9     0x00D9U
#define DMA_MAX_CHCK_SZ10    0x00DAU
#define DMA_MAX_CHCK_SZ11    0x00DBU
#define DMA_MAX_CHCK_SZ12    0x00DCU
#define DMA_MAX_CHCK_SZ13    0x00DDU
#define DMA_MAX_CHCK_SZ14    0x00DEU
#define DMA_MAX_CHCK_SZ15    0x00DFU
#define DMA_MAX_ATTR         0x00E0U
#define DMA_MAX_PRI          0x00E1U
#define DMA_MIN_OPC_SZ       0x00E2U
#define DMA_PAGE_SZ          0x00E3U
#define DMA_CUP0_W_SA_L      0x00F0U
#define DMA_CUP0_W_SA_H      0x00F1U
#define DMA_CUP1_W_SA_L      0x00F2U
#define DMA_CUP1_W_SA_H      0x00F3U
#define DMA_CUP0_R_SA_L      0x00F4U
#define DMA_CUP0_R_SA_H      0x00F5U
#define DMA_CUP0_W_EA_L      0x00F6U
#define DMA_CUP0_W_EA_H      0x00F7U
#define DMA_CUP1_W_EA_L      0x00F8U
#define DMA_CUP1_W_EA_H      0x00F9U
#define DMA_CUP0_R_EA_L      0x00FAU
#define DMA_CUP0_R_EA_H      0x00FBU
/* -------------------------------------------------------------------- */
...
/*  REG	BDU_SCS				BDU_BASE + 0x27U     4       0xfU     0x0000U  WO  */
...
/*  REG	BDU_INTER			BDU_BASE + 0x30U     3       0x7U     0x0000U  RO  */
/*  REG	BDU_INTRA			BDU_BASE + 0x31U     3       0x7U     0x0000U  RO */
/*  REG	BDU_INTRA64			BDU_BASE + 0x32U     3       0x7U     0x0000U  RO */
/*  REG	BDU_RINTER			BDU_BASE + 0x33U     4       0xfU     0x0000U  RO */
/*  REG	BDU_RINTRA			BDU_BASE + 0x34U     4       0xfU     0x0000U  RO */
/*  REG	BDU_RINTRA64		       	BDU_BASE + 0x35U     4       0xfU     0x0000U  RO */
...
#define BDU_H264_UEG_RES0    0x00F0U
#define BDU_H264_UEG_RES1    0x00F1U
/* -------------------------------------------------------------------- */
...
/*  CUP sub-addresses */
/* -------------------------------------------------------------------- */
#define CUP_REG_RST          0x0000U
#define CUP_REG_CFG          0x0001U
#define CUP_FIF_CMD          0x0002U
#define CUP_REG_STS          0x0003U
#define CUP_REG_TID          0x0004U
#define CUP_REG_LID          0x0005U
#define CUP_REG_SFW          0x0006U
#define CUP_REG_SFH          0x0007U
#define CUP_REG_MBX          0x0008U
#define CUP_REG_MBY          0x0009U
#define CUP_REG_COIP         0x000AU
#define CUP_REG_CHIP         0x000BU
#define CUP_REG_MBA          0x000CU
#define CUP_REG_EXC1         0x000DU
#define CUP_REG_VSTE         0x000EU
#define CUP_FIF_IPAM         0x0010U
#define CUP_FIF_PMPX         0x0020U
#define CUP_FIF_PMPY         0x0021U
#define CUP_FIF_PSIZ         0x0022U
#define CUP_FIF_PDST         0x0023U
#define CUP_FIF_PREF         0x0024U
...
/*  H264 context definition */
#define CUP_CTX_MBTYP        0x0000U
#define CUP_CTX_CBP          0x0001U
#define CUP_CTX_QPY          0x0002U
#define CUP_CTX_QPC          0x0003U
#define CUP_CTX_NSLIC        0x0004U
#define CUP_CTX_CCEAL        0x0006U
#define CUP_CTX_ERROR        0x0007U
#define CUP_CTX_SOA          0x0008U
#define CUP_CTX_SOB          0x0009U
#define CUP_CTX_DISF         0x000AU
#define CUP_CTX_FREE         0x000BU
/*  CUP_REG_CTX_A_RFPIC[i] = CUP_CTX_A+CUP_CTX_RFPIC + i (i=0..3) */
#define CUP_CTX_RFPIC        0x000CU
/*  CUP_REG_CTX_A_I4X4[i]  = CUP_CTX_A+CUP_CTX_I4X4 + i  (i=0..15) */
#define CUP_CTX_I4X4         0x0010U
/*  CUP_REG_CTX_A_RFIDX[i] = CUP_CTX_A+CUP_CTX_RFIDX + i (i=0..3) */
#define CUP_CTX_NZC          0x0020U
/*  CUP_REG_CTX_A_NZC[i]   = CUP_CTX_A+CUP_CTX_NZC + i   (i=0..23) */
#define CUP_CTX_SUB          0x0038U
/*  CUP_REG_CTX_A_SUB[i]   = CUP_CTX_A+CUP_CTX_SUB + i   (i=0..3) */
#define CUP_CTX_RFIDX        0x003CU
/*  CUP_REG_CTX_A_MVX[i]   = CUP_CTX_A+CUP_CTX_MVX + 4*i (i=0..15) */
#define CUP_CTX_MVX          0x0040U
/*  CUP_REG_CTX_A_MVY[i]   = CUP_CTX_A+CUP_CTX_MVY + 4*i (i=0..15) */
#define CUP_CTX_MVY          0x0042U
/* -------------------------------------------------------------------- */
/*  VLC sub-addresses */
/* -------------------------------------------------------------------- */
