...
/* Generated C++ stub for 'mpeg2dec.mpc.api.ddep'
   Generator:tools.generator.legacy.cpp.user.stub */
#include <host/mpeg2dec/mpc/api/ddep.hpp>

class mpeg2dec_mpc_api_ddep: public mpeg2dec_mpc_api_ddepDescriptor
{
  public:
    t_cm_bf_host2mpc_handle    host2mpcId;

  public:
    virtual void setConfig(t_uint16 channelId, t_uint8 outputPortBufferCountActual, t_uint8 errorMapFlag) {
      ...
      _xyuv_data[1] = (t_uint16)outputPortBufferCountActual;
      /* errorMapFlag <t_uint8> marshalling */
      _xyuv_data[2] = (t_uint16)errorMapFlag;
      /* Event sending */
      CM_INTERNAL_PushEventWithSize(host2mpcId, _xyuv_data, 3*2, 0);
    }
    virtual void setParameter(t_uint16 channelId, t_t1xhv_algo_id algoId, ts_ddep_buffer_descriptor ddep_vdc_mpeg2_param_desc) {
      ...
      _xyuv_data[3+0] = (t_uint16)ddep_vdc_mpeg2_param_desc.nSize;
      _xyuv_data[3+0+1] = (t_uint16)(ddep_vdc_mpeg2_param_desc.nSize >> 16);
      _xyuv_data[3+2] = (t_uint16)ddep_vdc_mpeg2_param_desc.nPhysicalAddress;
      _xyuv_data[3+2+1] = (t_uint16)(ddep_vdc_mpeg2_param_desc.nPhysicalAddress >> 16);
      _xyuv_data[3+4] = (t_uint16)ddep_vdc_mpeg2_param_desc.nLogicalAddress;
      _xyuv_data[3+4+1] = (t_uint16)(ddep_vdc_mpeg2_param_desc.nLogicalAddress >> 16);
      _xyuv_data[3+6] = (t_uint16)ddep_vdc_mpeg2_param_desc.nMpcAddress;
      _xyuv_data[3+6+1] = (t_uint16)(ddep_vdc_mpeg2_param_desc.nMpcAddress >> 16);
      /* Event sending */
    ...
    virtual void sendCommand_sequential(OMX_COMMANDTYPE cmd, t_uword param) {
...
static t_cm_bf_host2mpc_handle* INITstub_mpeg2dec_mpc_api_ddep(t_nmf_interface_desc* itf) {
  mpeg2dec_mpc_api_ddep *stub = new mpeg2dec_mpc_api_ddep();
  if(stub == 0x0)
    return 0x0;
...
/* Generated C++ stub for 'mpeg2dec.mpc.api.emptythisheader'
   Generator:tools.generator.legacy.cpp.user.stub */
#include <host/mpeg2dec/mpc/api/emptythisheader.hpp>

class mpeg2dec_mpc_api_emptythisheader: public mpeg2dec_mpc_api_emptythisheaderDescriptor
{
  public:
    t_cm_bf_host2mpc_handle    host2mpcId;
...
static t_cm_bf_host2mpc_handle* INITstub_mpeg2dec_mpc_api_emptythisheader(t_nmf_interface_desc* itf) {
  mpeg2dec_mpc_api_emptythisheader *stub = new mpeg2dec_mpc_api_emptythisheader();
  if(stub == 0x0)
    return 0x0;
  *(NMF::InterfaceReference*)itf = stub;
  return &stub->host2mpcId;
...
/* Generated C++ stub for 'mpeg2dec.mpc.api.fillthisheader'
   Generator:tools.generator.legacy.cpp.user.stub */
#include <host/mpeg2dec/mpc/api/fillthisheader.hpp>

class mpeg2dec_mpc_api_fillthisheader: public mpeg2dec_mpc_api_fillthisheaderDescriptor
{
  public:
    t_cm_bf_host2mpc_handle    host2mpcId;
...
static t_cm_bf_host2mpc_handle* INITstub_mpeg2dec_mpc_api_fillthisheader(t_nmf_interface_desc* itf) {
  mpeg2dec_mpc_api_fillthisheader *stub = new mpeg2dec_mpc_api_fillthisheader();
  if(stub == 0x0)
    return 0x0;
  *(NMF::InterfaceReference*)itf = stub;
  return &stub->host2mpcId;
...
static t_nmf_stub_function video_mpeg2dec_cpp_stub_functions[] = {
  {"mpeg2dec.mpc.api.ddep", &INITstub_mpeg2dec_mpc_api_ddep},
  {"mpeg2dec.mpc.api.emptythisheader", &INITstub_mpeg2dec_mpc_api_emptythisheader},
  {"mpeg2dec.mpc.api.fillthisheader", &INITstub_mpeg2dec_mpc_api_fillthisheader},
...
/*const */t_nmf_stub_register video_mpeg2dec_cpp_stub_register = {
    NMF_BC_IN_CPP,
    sizeof(video_mpeg2dec_cpp_stub_functions)/sizeof(t_nmf_stub_function),
    video_mpeg2dec_cpp_stub_functions
};
