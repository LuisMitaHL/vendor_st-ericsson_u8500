...
typedef struct t1xhv_vdc_mpeg4_param_inout {
  ...
  t_ushort_value future_reference_vop ;           /* =0 => future ref is =I => future ref is P */
    t_ulong_value forward_time ;           /* =0 => future ref is =I => future ref is P *///vidit changed from short to long
    t_ulong_value backward_time ;           /* =0 => future ref is =I => future ref is P *///vidit changed from short to long
