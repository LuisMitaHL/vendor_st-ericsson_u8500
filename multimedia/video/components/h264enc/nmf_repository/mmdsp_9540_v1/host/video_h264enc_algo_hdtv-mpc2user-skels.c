...
static t_nmf_skel_function video_h264enc_algo_hdtv_skel_functions[] = {
  {"h264enc.mpc.api.end_algo", JT_h264enc_mpc_api_end_algo},
};

/*const */t_nmf_skel_register video_h264enc_algo_hdtv_skel_register = {
    NMF_BC_IN_C,
    sizeof(video_h264enc_algo_hdtv_skel_functions)/sizeof(t_nmf_skel_function),
    video_h264enc_algo_hdtv_skel_functions
};
