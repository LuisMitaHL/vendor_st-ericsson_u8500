...
typedef struct
{
    t_uint16 vui_mvc_num_ops_minus1;
    t_uint16 vui_mvc_temporal_id[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_num_target_output_views_minus1[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_view_id[MAX_OPERATION_POINTS][MAX_NUM_VIEWS];
    t_uint16 vui_mvc_timing_info_present_flag[MAX_OPERATION_POINTS];
    t_uint32 vui_mvc_num_units_in_tick[MAX_OPERATION_POINTS];
    t_uint32 vui_mvc_time_scale[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_fixed_frame_rate_flag[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_nal_hrd_parameters_present_flag[MAX_OPERATION_POINTS];
    t_hrd_param vui_mvc_nal_hrd_parameters[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_vcl_hrd_parameters_present_flag[MAX_OPERATION_POINTS];
    t_hrd_param vui_mvc_vcl_hrd_parameters[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_low_delay_hrd_flag[MAX_OPERATION_POINTS];
    t_uint16 vui_mvc_pic_struct_present_flag[MAX_OPERATION_POINTS];
} t_mvc_vui_data;
