...
# Overrides
PRODUCT_BRAND := ste
PRODUCT_NAME := ste_u9540
PRODUCT_DEVICE := u9540
...
PRODUCT_PACKAGE_OVERLAYS := vendor/st-ericsson/u9540/overlay
...
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/cyttsp-spi.idc:system/usr/idc/cyttsp-spi.idc

PRODUCT_COPY_FILES += \
        vendor/st-ericsson/u9540/st-ftk.idc:system/usr/idc/st-ftk.idc

# Copy the ste_insmod.sh script to system/bin
PRODUCT_COPY_FILES += \
        vendor/st-ericsson/u9540/ste_insmod.sh:system/bin/ste_insmod.sh

# Copy the blue-up.sh script to system/bin
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/blue-up.sh:system/bin/blue-up.sh \
	vendor/st-ericsson/u9540/init.rc:root/init.rc \
	vendor/st-ericsson/u9540/init.st-ericsson.rc:root/init.st-ericsson.rc \
	vendor/st-ericsson/u9540/init.st-ericsson.usb.rc:root/init.st-ericsson.usb.rc \
	vendor/st-ericsson/u9540/init.project.rc:root/init.project.rc \
	vendor/st-ericsson/u9540/init.st-ericsson.modem.rc:root/init.st-ericsson.modem.rc \
	vendor/st-ericsson/u9540/init_bd_addr.sh:system/etc/init_bd_addr.sh \
	vendor/st-ericsson/u9540/media_profiles_u9540.xml:system/etc/media_profiles.xml \
	vendor/st-ericsson/u9540/media_codecs_u9540.xml:system/etc/media_codecs.xml

# CG2900 initialization script
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/cg2900-channel_init.sh:system/bin/cg2900-channel_init.sh

# USB Device ID initialization script
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/usbid_init.sh:system/bin/usbid_init.sh

# eMMC user storage partition mount script
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/check_mount_fs.sh:system/bin/check_mount_fs.sh

# copy AGPS configuration files for lbs_core module
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/LbsConfig.cfg:system/etc/LbsConfig.cfg \
	vendor/st-ericsson/u9540/LbsLogConfig.cfg:system/etc/LbsLogConfig.cfg \
	vendor/st-ericsson/u9540/LbsPgpsConfig.cfg:system/etc/LbsPgpsConfig.cfg \
	vendor/st-ericsson/u9540/cacert.txt:system/etc/cacert.txt \
	vendor/st-ericsson/u9540/LbsPltConfig.cfg:system/etc/LbsPltConfig.cfg
...
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/apns_u9540.xml:system/etc/apns-conf.xml
...
PRODUCT_COPY_FILES += \
        vendor/st-ericsson/u9540/splash_image.bmp:splash.bin

# Copy scripts for automatic startup logging
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/scripts/ste-reset_autolog.sh:system/bin/ste-reset_autolog.sh \
	vendor/st-ericsson/u9540/scripts/kernel_log.sh:system/bin/kernel_log.sh

# Copy scripts for automatic start/stop MID processes based on runtime mode and modem state
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/scripts/modem_state_booting.sh:system/bin/modem_state_booting.sh \
	vendor/st-ericsson/u9540/scripts/modem_state_dumping.sh:system/bin/modem_state_dumping.sh \
	vendor/st-ericsson/u9540/scripts/modem_state_off.sh:system/bin/modem_state_off.sh \
	vendor/st-ericsson/u9540/scripts/modem_state_on.sh:system/bin/modem_state_on.sh \
	vendor/st-ericsson/u9540/scripts/modem_state_prepare_off.sh:system/bin/modem_state_prepare_off.sh \
	vendor/st-ericsson/u9540/scripts/ste-lins_off.sh:system/bin/ste-lins_off.sh \
	vendor/st-ericsson/u9540/scripts/ste-lins_on.sh:system/bin/ste-lins_on.sh

# Copy scripts for telling the MID processes that the system is shutting down
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/scripts/ste-kill-mid.sh:system/bin/ste-kill-mid.sh

###### u9540 Specific ######

# keyboard layouts
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/STMPE-keypad.kl:system/usr/keylayout/STMPE-keypad.kl \
	vendor/st-ericsson/u9540/STMPE-keypad.kl:system/usr/keylayout/tc35893-kp.kl \
	vendor/st-ericsson/u9540/ux500-ske-keypad.kl:system/usr/keylayout/ux500-ske-keypad.kl \
	vendor/st-ericsson/u9540/ux500-ske-keypad-qwertz.kl:system/usr/keylayout/ux500-ske-keypad-qwertz.kl \
	vendor/st-ericsson/u9540/AB8500_Hs_Button.kl:system/usr/keylayout/AB8500_Hs_Button.kl

# product specific ueventd.rc
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/ueventd.st-ericsson.rc:root/ueventd.st-ericsson.rc

# RIL initialization script
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/ste_modem.sh:system/etc/ste_modem.sh

# Test if UIB present script
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/verifyfb.sh:system/etc/verifyfb.sh

# DBus config
PRODUCT_COPY_FILES += vendor/st-ericsson/u9540/dbus.conf:system/etc/dbus.conf

# Automount SD-Card
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/vold.fstab:system/etc/vold.fstab

# Modem Workaround - File permissions
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/set_modem_permission.sh:system/bin/set_modem_permission.sh

# Modem boot condition depending on the board
PRODUCT_COPY_FILES += \
        vendor/st-ericsson/u9540/scripts/ste-start-mid.sh:system/bin/ste-start-mid.sh

# Modem Workaround - to restore q store calibration during init of platform
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/restore_modem_calibration.sh:system/bin/restore_modem_calibration.sh


# Modem Workaround - for calibration
PRODUCT_COPY_FILES += \
	vendor/st-ericsson/u9540/backup_modem_calibration_in_CSPSA.sh:system/bin/backup_modem_calibration_in_CSPSA.sh
