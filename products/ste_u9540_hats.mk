...
ifeq ($(TARGET_PRODUCT), ste_u9540_hats)
...
UPDATE_KERNEL_DEFCONFIG_FILE:= $(shell test -f vendor/st-ericsson/u9540/patch_kernel_defconfig.sh && sh vendor/st-ericsson/u9540/patch_kernel_defconfig.sh)
endif
